...
main(int argc, char *argv[])
{
  ...
  34:	800a8a93          	add	s5,s5,-2048 # 830 <malloc+0x106>
  ...
  76:	7c658593          	add	a1,a1,1990 # 838 <malloc+0x10e>
  7a:	4505                	li	a0,1
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4ec:	00271793          	sll	a5,a4,0x2
 4f0:	00000717          	auipc	a4,0x0
 4f4:	35870713          	add	a4,a4,856 # 848 <malloc+0x11e>
 ...
 580:	324b8b93          	add	s7,s7,804 # 8a0 <digits>
 ...
 5d6:	26e90913          	add	s2,s2,622 # 840 <malloc+0x116>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 77a:	14290913          	add	s2,s2,322 # 8b8 <freep>
  if(p == (char*)-1)
 77e:	5afd                	li	s5,-1
 ...
 78e:	13678793          	add	a5,a5,310 # 8c0 <base>
