...
main(int argc, char *argv[])
{
  ...
  14:	7f058593          	add	a1,a1,2032 # 800 <malloc+0x102>
  18:	4509                	li	a0,2
  ...
  52:	7ca58593          	add	a1,a1,1994 # 818 <malloc+0x11a>
  56:	4509                	li	a0,2
...
putc(int fd, char c)
{
 ...
 384:	1000                	add	s0,sp,32
 386:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
 38a:	4605                	li	a2,1
 38c:	fef40593          	add	a1,s0,-17
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3c2:	4d250513          	add	a0,a0,1234 # 890 <digits>
 3c6:	883a                	mv	a6,a4
 ...
 40a:	fc040793          	add	a5,s0,-64
 40e:	00e78933          	add	s2,a5,a4
 412:	fff78993          	add	s3,a5,-1
 416:	99ba                	add	s3,s3,a4
 418:	377d                	addw	a4,a4,-1
 41a:	1702                	sll	a4,a4,0x20
 41c:	9301                	srl	a4,a4,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4c8:	37470713          	add	a4,a4,884 # 838 <malloc+0x13a>
 ...
 554:	340b8b93          	add	s7,s7,832 # 890 <digits>
 558:	03c9d793          	srl	a5,s3,0x3c
 ...
 56c:	0992                	sll	s3,s3,0x4
 56e:	397d                	addw	s2,s2,-1
 ...
 5aa:	28a90913          	add	s2,s2,650 # 830 <malloc+0x132>
        while(*s != 0){
 ...
 6b2:	00e6ea63          	bltu	a3,a4,6c6 <free+0x4a>
{
 ...
 6ca:	6390                	ld	a2,0(a5)
 6cc:	02059813          	sll	a6,a1,0x20
 6d0:	01c85713          	srl	a4,a6,0x1c
 ...
 6da:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
 6de:	4790                	lw	a2,8(a5)
 6e0:	02061593          	sll	a1,a2,0x20
 6e4:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
 ...
 74e:	15e90913          	add	s2,s2,350 # 8a8 <freep>
  if(p == (char*)-1)
 752:	5afd                	li	s5,-1
 ...
 762:	15278793          	add	a5,a5,338 # 8b0 <base>
