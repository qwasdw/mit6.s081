...
main(int argc, char **argv)
{
  ...
  50:	7bc58593          	add	a1,a1,1980 # 808 <malloc+0x104>
  54:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3c8:	4bc50513          	add	a0,a0,1212 # 880 <digits>
 3cc:	883a                	mv	a6,a4
 ...
 410:	fc040793          	add	a5,s0,-64
 414:	00e78933          	add	s2,a5,a4
 418:	fff78993          	add	s3,a5,-1
 41c:	99ba                	add	s3,s3,a4
 41e:	377d                	addw	a4,a4,-1
 420:	1702                	sll	a4,a4,0x20
 422:	9301                	srl	a4,a4,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4ce:	35e70713          	add	a4,a4,862 # 828 <malloc+0x124>
 ...
 55a:	32ab8b93          	add	s7,s7,810 # 880 <digits>
 55e:	03c9d793          	srl	a5,s3,0x3c
 ...
 572:	0992                	sll	s3,s3,0x4
 574:	397d                	addw	s2,s2,-1
 ...
 5b0:	27490913          	add	s2,s2,628 # 820 <malloc+0x11c>
        while(*s != 0){
...
free(void *ap)
{
 682:	1141                	add	sp,sp,-16
 684:	e422                	sd	s0,8(sp)
 686:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
 688:	ff050693          	add	a3,a0,-16
 ...
 6b8:	00e6ea63          	bltu	a3,a4,6cc <free+0x4a>
{
 ...
 6d0:	6390                	ld	a2,0(a5)
 6d2:	02059813          	sll	a6,a1,0x20
 6d6:	01c85713          	srl	a4,a6,0x1c
 ...
 6e0:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
 6e4:	4790                	lw	a2,8(a5)
 6e6:	02061593          	sll	a1,a2,0x20
 6ea:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
 ...
 754:	14890913          	add	s2,s2,328 # 898 <freep>
  if(p == (char*)-1)
 758:	5afd                	li	s5,-1
 ...
 768:	13c78793          	add	a5,a5,316 # 8a0 <base>
