...
printint(int fd, int xx, int base, int sgn)
{
 ...
 38a:	4a250513          	add	a0,a0,1186 # 828 <digits>
 38e:	883a                	mv	a6,a4
 390:	2705                	addw	a4,a4,1
 392:	02c5f7bb          	remuw	a5,a1,a2
 396:	1782                	sll	a5,a5,0x20
 398:	9381                	srl	a5,a5,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 488:	00271793          	sll	a5,a4,0x2
 48c:	00000717          	auipc	a4,0x0
 490:	34470713          	add	a4,a4,836 # 7d0 <malloc+0x10a>
 494:	97ba                	add	a5,a5,a4
 496:	439c                	lw	a5,0(a5)
 498:	97ba                	add	a5,a5,a4
 49a:	8782                	jr	a5
        printint(fd, va_arg(ap, int), 10, 1);
 49c:	008b8913          	add	s2,s7,8
 4a0:	4685                	li	a3,1
 4a2:	4629                	li	a2,10
 ...
 51c:	310b8b93          	add	s7,s7,784 # 828 <digits>
 ...
 572:	25a90913          	add	s2,s2,602 # 7c8 <malloc+0x102>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 716:	12e90913          	add	s2,s2,302 # 840 <freep>
  if(p == (char*)-1)
 71a:	5afd                	li	s5,-1
 ...
 72a:	12278793          	add	a5,a5,290 # 848 <base>
