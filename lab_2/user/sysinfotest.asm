...
sinfo(struct sysinfo *info) {
  ...
  20:	acc50513          	add	a0,a0,-1332 # ae8 <malloc+0x102>
...
countfree()
{
  ...
  aa:	a5a50513          	add	a0,a0,-1446 # b00 <malloc+0x11a>
...
testmem() {
 ...
 148:	9f450513          	add	a0,a0,-1548 # b38 <malloc+0x152>
 ...
 162:	a0a50513          	add	a0,a0,-1526 # b68 <malloc+0x182>
 ...
 17c:	9c050513          	add	a0,a0,-1600 # b38 <malloc+0x152>
 ...
 196:	9d650513          	add	a0,a0,-1578 # b68 <malloc+0x182>
 ...
 1b2:	98a50513          	add	a0,a0,-1654 # b38 <malloc+0x152>
...
testcall() {
 ...
 1e4:	b5b50513          	add	a0,a0,-1189 # ffffffffeaeb0b5b <__global_pointer$+0xffffffffeaeaf6aa>
 ...
 20c:	97050513          	add	a0,a0,-1680 # b78 <malloc+0x192>
 ...
 226:	96e50513          	add	a0,a0,-1682 # b90 <malloc+0x1aa>
...
void testproc() {
 ...
 280:	96450513          	add	a0,a0,-1692 # be0 <malloc+0x1fa>
 ...
 29a:	92a50513          	add	a0,a0,-1750 # bc0 <malloc+0x1da>
 ...
 2ea:	8fa50513          	add	a0,a0,-1798 # be0 <malloc+0x1fa>
...
main(int argc, char *argv[])
{
 ...
 30c:	90850513          	add	a0,a0,-1784 # c10 <malloc+0x22a>
 ...
 334:	8f850513          	add	a0,a0,-1800 # c28 <malloc+0x242>
...
strcpy(char *s, const char *t)
{
 ...
 34e:	0800                	add	s0,sp,16
  ...
  while((*s++ = *t++) != 0)
 350:	87aa                	mv	a5,a0
 352:	0585                	add	a1,a1,1 # fffffffffffff001 <__global_pointer$+0xffffffffffffdb50>
...
memset(void *dst, int c, uint n)
{
 ...
 3c4:	87aa                	mv	a5,a0
 3c6:	1602                	sll	a2,a2,0x20
 3c8:	9201                	srl	a2,a2,0x20
...
atoi(const char *s)
{
 ...
 4da:	0025179b          	sllw	a5,a0,0x2
 4de:	9fa9                	addw	a5,a5,a0
 4e0:	0017979b          	sllw	a5,a5,0x1
 4e4:	9fb5                	addw	a5,a5,a3
 4e6:	fd07851b          	addw	a0,a5,-48
  while('0' <= *s && *s <= '9')
 4ea:	00074683          	lbu	a3,0(a4)
 4ee:	fd06879b          	addw	a5,a3,-48
...
{
 504:	1141                	add	sp,sp,-16
 506:	e422                	sd	s0,8(sp)
 508:	0800                	add	s0,sp,16
  char *dst;
  const char *src;
...
memcmp(const void *s1, const void *s2, uint n)
{
 ...
 564:	fff6069b          	addw	a3,a2,-1
 568:	1682                	sll	a3,a3,0x20
 56a:	9281                	srl	a3,a3,0x20
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 6aa:	5fa50513          	add	a0,a0,1530 # ca0 <digits>
 6ae:	883a                	mv	a6,a4
 6b0:	2705                	addw	a4,a4,1
 6b2:	02c5f7bb          	remuw	a5,a1,a2
 6b6:	1782                	sll	a5,a5,0x20
 6b8:	9381                	srl	a5,a5,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 83c:	468b8b93          	add	s7,s7,1128 # ca0 <digits>
 ...
 892:	3b290913          	add	s2,s2,946 # c40 <malloc+0x25a>
        while(*s != 0){
...
free(void *ap)
{
 964:	1141                	add	sp,sp,-16
 966:	e422                	sd	s0,8(sp)
 968:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
 96a:	ff050693          	add	a3,a0,-16
 ...
 99a:	00e6ea63          	bltu	a3,a4,9ae <free+0x4a>
{
 ...
 9b2:	6390                	ld	a2,0(a5)
 9b4:	02059813          	sll	a6,a1,0x20
 9b8:	01c85713          	srl	a4,a6,0x1c
 ...
 9c2:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
 9c6:	4790                	lw	a2,8(a5)
 9c8:	02061593          	sll	a1,a2,0x20
 9cc:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
 ...
 a36:	28690913          	add	s2,s2,646 # cb8 <freep>
  if(p == (char*)-1)
 a3a:	5afd                	li	s5,-1
 ...
 a4a:	27a78793          	add	a5,a5,634 # cc0 <base>
 ...
 ab4:	c798                	sw	a4,8(a5)
        p += p->s.size;
 ab6:	02071693          	sll	a3,a4,0x20
 aba:	01c6d713          	srl	a4,a3,0x1c
