...
cat(int fd)
{
  ...
  14:	97890913          	add	s2,s2,-1672 # 988 <buf>
  ...
  44:	88058593          	add	a1,a1,-1920 # 8c0 <malloc+0x102>
  48:	4509                	li	a0,2
  ...
  72:	86a58593          	add	a1,a1,-1942 # 8d8 <malloc+0x11a>
  76:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
 ...
 10a:	7ea58593          	add	a1,a1,2026 # 8f0 <malloc+0x132>
 10e:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 482:	4ea50513          	add	a0,a0,1258 # 968 <digits>
 486:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 588:	38c70713          	add	a4,a4,908 # 910 <malloc+0x152>
 ...
 614:	358b8b93          	add	s7,s7,856 # 968 <digits>
 ...
 66a:	2a290913          	add	s2,s2,674 # 908 <malloc+0x14a>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 80e:	17690913          	add	s2,s2,374 # 980 <freep>
  if(p == (char*)-1)
 812:	5afd                	li	s5,-1
 ...
 822:	36a78793          	add	a5,a5,874 # b88 <base>
