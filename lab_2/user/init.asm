...
main(void)
{
  ...
  12:	88a50513          	add	a0,a0,-1910 # 898 <malloc+0x104>
  ...
  3a:	86a90913          	add	s2,s2,-1942 # 8a0 <malloc+0x10c>
  3e:	854a                	mv	a0,s2
  ...
  6e:	88650513          	add	a0,a0,-1914 # 8f0 <malloc+0x15c>
  ...
  8c:	81050513          	add	a0,a0,-2032 # 898 <malloc+0x104>
  90:	00000097          	auipc	ra,0x0
  94:	31c080e7          	jalr	796(ra) # 3ac <mknod>
    open("console", O_RDWR);
  98:	4589                	li	a1,2
  9a:	00000517          	auipc	a0,0x0
  9e:	7fe50513          	add	a0,a0,2046 # 898 <malloc+0x104>
  a2:	00000097          	auipc	ra,0x0
  a6:	302080e7          	jalr	770(ra) # 3a4 <open>
  aa:	bfa5                	j	22 <main+0x22>
      printf("init: fork failed\n");
  ac:	00001517          	auipc	a0,0x1
  b0:	80c50513          	add	a0,a0,-2036 # 8b8 <malloc+0x124>
  ...
  ca:	8c258593          	add	a1,a1,-1854 # 988 <argv>
  ce:	00001517          	auipc	a0,0x1
  d2:	80250513          	add	a0,a0,-2046 # 8d0 <malloc+0x13c>
  d6:	00000097          	auipc	ra,0x0
  da:	2c6080e7          	jalr	710(ra) # 39c <exec>
      printf("init: exec sh failed\n");
  de:	00000517          	auipc	a0,0x0
  e2:	7fa50513          	add	a0,a0,2042 # 8d8 <malloc+0x144>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 458:	51c50513          	add	a0,a0,1308 # 970 <digits>
 45c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 55e:	3be70713          	add	a4,a4,958 # 918 <malloc+0x184>
 ...
 5ea:	38ab8b93          	add	s7,s7,906 # 970 <digits>
 ...
 640:	2d490913          	add	s2,s2,724 # 910 <malloc+0x17c>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 7e4:	1b890913          	add	s2,s2,440 # 998 <freep>
  if(p == (char*)-1)
 7e8:	5afd                	li	s5,-1
 ...
 7f8:	1ac78793          	add	a5,a5,428 # 9a0 <base>
