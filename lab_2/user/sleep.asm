...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3a2:	4ba50513          	add	a0,a0,1210 # 858 <digits>
 3a6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4a8:	35c70713          	add	a4,a4,860 # 800 <malloc+0x122>
 ...
 534:	328b8b93          	add	s7,s7,808 # 858 <digits>
 ...
 58a:	27290913          	add	s2,s2,626 # 7f8 <malloc+0x11a>
        while(*s != 0){
...
free(void *ap)
{
 ...
 66a:	20a7b783          	ld	a5,522(a5) # 870 <freep>
 ...
 692:	00e6ea63          	bltu	a3,a4,6a6 <free+0x4a>
{
 ...
 6d4:	1af73023          	sd	a5,416(a4) # 870 <freep>
}
 6d8:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 6fe:	17653503          	ld	a0,374(a0) # 870 <freep>
 ...
 72e:	14690913          	add	s2,s2,326 # 870 <freep>
  if(p == (char*)-1)
 732:	5afd                	li	s5,-1
 ...
 742:	13a78793          	add	a5,a5,314 # 878 <base>
 746:	00000717          	auipc	a4,0x0
 74a:	12f73523          	sd	a5,298(a4) # 870 <freep>
 74e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
