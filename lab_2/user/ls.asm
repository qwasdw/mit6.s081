...
fmtname(char *path)
{
  ...
  66:	b0698993          	add	s3,s3,-1274 # b68 <buf.0>
...
ls(char *path)
{
 ...
 118:	99450513          	add	a0,a0,-1644 # aa8 <malloc+0x134>
 ...
 14a:	93258593          	add	a1,a1,-1742 # a78 <malloc+0x104>
 14e:	4509                	li	a0,2
 ...
 160:	93458593          	add	a1,a1,-1740 # a90 <malloc+0x11c>
 164:	4509                	li	a0,2
 ...
 196:	92650513          	add	a0,a0,-1754 # ab8 <malloc+0x144>
 ...
 1e6:	8eea0a13          	add	s4,s4,-1810 # ad0 <malloc+0x15c>
        printf("ls: cannot stat %s\n", buf);
 1ea:	00001a97          	auipc	s5,0x1
 1ee:	8a6a8a93          	add	s5,s5,-1882 # a90 <malloc+0x11c>
...
main(int argc, char *argv[])
{
 ...
 2c2:	82250513          	add	a0,a0,-2014 # ae0 <malloc+0x16c>
...
putc(int fd, char c)
{
 5f4:	1101                	add	sp,sp,-32
 5f6:	ec06                	sd	ra,24(sp)
 5f8:	e822                	sd	s0,16(sp)
 5fa:	1000                	add	s0,sp,32
 5fc:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
 600:	4605                	li	a2,1
 602:	fef40593          	add	a1,s0,-17
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 638:	51450513          	add	a0,a0,1300 # b48 <digits>
 63c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 736:	00271793          	sll	a5,a4,0x2
 73a:	00000717          	auipc	a4,0x0
 73e:	3b670713          	add	a4,a4,950 # af0 <malloc+0x17c>
 ...
 7ca:	382b8b93          	add	s7,s7,898 # b48 <digits>
 7ce:	03c9d793          	srl	a5,s3,0x3c
 ...
 7e2:	0992                	sll	s3,s3,0x4
 7e4:	397d                	addw	s2,s2,-1
 ...
 820:	2cc90913          	add	s2,s2,716 # ae8 <malloc+0x174>
        while(*s != 0){
...
free(void *ap)
{
 8f2:	1141                	add	sp,sp,-16
 8f4:	e422                	sd	s0,8(sp)
 8f6:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
 8f8:	ff050693          	add	a3,a0,-16
 ...
 928:	00e6ea63          	bltu	a3,a4,93c <free+0x4a>
{
 ...
 940:	6390                	ld	a2,0(a5)
 942:	02059813          	sll	a6,a1,0x20
 946:	01c85713          	srl	a4,a6,0x1c
 ...
 950:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
 954:	4790                	lw	a2,8(a5)
 956:	02061593          	sll	a1,a2,0x20
 95a:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
 974:	7139                	add	sp,sp,-64
 976:	fc06                	sd	ra,56(sp)
 978:	f822                	sd	s0,48(sp)
 97a:	f426                	sd	s1,40(sp)
 97c:	ec4e                	sd	s3,24(sp)
 97e:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 980:	02051493          	sll	s1,a0,0x20
 984:	9081                	srl	s1,s1,0x20
 986:	04bd                	add	s1,s1,15
 988:	8091                	srl	s1,s1,0x4
 98a:	0014899b          	addw	s3,s1,1
 98e:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
 ...
 9c4:	1a090913          	add	s2,s2,416 # b60 <freep>
  if(p == (char*)-1)
 9c8:	5afd                	li	s5,-1
 ...
 9d8:	1a478793          	add	a5,a5,420 # b78 <base>
