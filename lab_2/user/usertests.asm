...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	dca50513          	add	a0,a0,-566 # 5e08 <malloc+0x104>
...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
      ...
      5c:	71078793          	add	a5,a5,1808 # 9768 <uninit>
      60:	0000c697          	auipc	a3,0xc
      64:	e1868693          	add	a3,a3,-488 # be78 <buf>
    if(uninit[i] != '\0'){
      ...
      74:	8082                	ret
{
      ...
      84:	da850513          	add	a0,a0,-600 # 5e28 <malloc+0x124>
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	d9850513          	add	a0,a0,-616 # 5e40 <malloc+0x13c>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	d9a50513          	add	a0,a0,-614 # 5e60 <malloc+0x15c>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	d6250513          	add	a0,a0,-670 # 5e48 <malloc+0x144>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	d6e50513          	add	a0,a0,-658 # 5e70 <malloc+0x16c>
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	d6c50513          	add	a0,a0,-660 # 5e98 <malloc+0x194>
     134:	00005097          	auipc	ra,0x5
     138:	7f0080e7          	jalr	2032(ra) # 5924 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	d5850513          	add	a0,a0,-680 # 5e98 <malloc+0x194>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	d5458593          	add	a1,a1,-684 # 5ea8 <malloc+0x1a4>
     15c:	00005097          	auipc	ra,0x5
     160:	798080e7          	jalr	1944(ra) # 58f4 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	d3050513          	add	a0,a0,-720 # 5e98 <malloc+0x194>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	d3458593          	add	a1,a1,-716 # 5eb0 <malloc+0x1ac>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	d0450513          	add	a0,a0,-764 # 5e98 <malloc+0x194>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	cee50513          	add	a0,a0,-786 # 5eb8 <malloc+0x1b4>
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	c6450513          	add	a0,a0,-924 # 5ee0 <malloc+0x1dc>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	c50a8a93          	add	s5,s5,-944 # 5ee0 <malloc+0x1dc>
      int cc = write(fd, buf, sz);
     298:	0000ca17          	auipc	s4,0xc
     29c:	be0a0a13          	add	s4,s4,-1056 # be78 <buf>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     2a0:	6b0d                	lui	s6,0x3
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	bde50513          	add	a0,a0,-1058 # 5ef0 <malloc+0x1ec>
     ...
     338:	bdc50513          	add	a0,a0,-1060 # 5f10 <malloc+0x20c>
...
000000000000034e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     374:	bb8a0a13          	add	s4,s4,-1096 # 5f28 <malloc+0x224>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     420:	b1450513          	add	a0,a0,-1260 # 5f30 <malloc+0x22c>
     ...
     43e:	b0e50513          	add	a0,a0,-1266 # 5f48 <malloc+0x244>
     ...
     45c:	b2050513          	add	a0,a0,-1248 # 5f78 <malloc+0x274>
     ...
     476:	b3650513          	add	a0,a0,-1226 # 5fa8 <malloc+0x2a4>
     ...
     494:	b2850513          	add	a0,a0,-1240 # 5fb8 <malloc+0x2b4>
...
00000000000004aa <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4d2:	b1aa0a13          	add	s4,s4,-1254 # 5fe8 <malloc+0x2e4>
    n = write(fds[1], "x", 1);
     4d6:	00006a97          	auipc	s5,0x6
     4da:	9daa8a93          	add	s5,s5,-1574 # 5eb0 <malloc+0x1ac>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     580:	a7450513          	add	a0,a0,-1420 # 5ff0 <malloc+0x2ec>
     ...
     59e:	a6e50513          	add	a0,a0,-1426 # 6008 <malloc+0x304>
     ...
     5b8:	9f450513          	add	a0,a0,-1548 # 5fa8 <malloc+0x2a4>
     ...
     5d2:	a6a50513          	add	a0,a0,-1430 # 6038 <malloc+0x334>
     ...
     5f0:	a6450513          	add	a0,a0,-1436 # 6050 <malloc+0x34c>
...
0000000000000606 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     646:	86658593          	add	a1,a1,-1946 # 5ea8 <malloc+0x1a4>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     662:	83a50513          	add	a0,a0,-1990 # 5e98 <malloc+0x194>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     68e:	80e50513          	add	a0,a0,-2034 # 5e98 <malloc+0x194>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6a2:	7fa50513          	add	a0,a0,2042 # 5e98 <malloc+0x194>
  ...
  write(fd1, "abcdef", 6);
     ...
     6e0:	a0458593          	add	a1,a1,-1532 # 60e0 <malloc+0x3dc>
     6e4:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     722:	77a50513          	add	a0,a0,1914 # 5e98 <malloc+0x194>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     766:	91e50513          	add	a0,a0,-1762 # 6080 <malloc+0x37c>
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     782:	92250513          	add	a0,a0,-1758 # 60a0 <malloc+0x39c>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     796:	91e50513          	add	a0,a0,-1762 # 60b0 <malloc+0x3ac>
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7b2:	92250513          	add	a0,a0,-1758 # 60d0 <malloc+0x3cc>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     7c6:	8ee50513          	add	a0,a0,-1810 # 60b0 <malloc+0x3ac>
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     7e4:	90850513          	add	a0,a0,-1784 # 60e8 <malloc+0x3e4>
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     802:	90a50513          	add	a0,a0,-1782 # 6108 <malloc+0x404>
...
0000000000000818 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     836:	8f650513          	add	a0,a0,-1802 # 6128 <malloc+0x424>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     84e:	90698993          	add	s3,s3,-1786 # 6150 <malloc+0x44c>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     852:	00006a97          	auipc	s5,0x6
     856:	936a8a93          	add	s5,s5,-1738 # 6188 <malloc+0x484>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     89c:	89050513          	add	a0,a0,-1904 # 6128 <malloc+0x424>
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     8b6:	5c658593          	add	a1,a1,1478 # be78 <buf>
  ...
  if(unlink("small") < 0){
     ...
     8d8:	85450513          	add	a0,a0,-1964 # 6128 <malloc+0x424>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     902:	83250513          	add	a0,a0,-1998 # 6130 <malloc+0x42c>
    ...
    exit(1);
     ...
     920:	84450513          	add	a0,a0,-1980 # 6160 <malloc+0x45c>
     ...
     93e:	85e50513          	add	a0,a0,-1954 # 6198 <malloc+0x494>
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     95a:	86a50513          	add	a0,a0,-1942 # 61c0 <malloc+0x4bc>
    ...
    printf("%s: read failed\n", s);
     ...
     976:	86e50513          	add	a0,a0,-1938 # 61e0 <malloc+0x4dc>
    ...
    printf("%s: unlink small failed\n", s);
     ...
     992:	86a50513          	add	a0,a0,-1942 # 61f8 <malloc+0x4f4>
...
00000000000009a8 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9c4:	85850513          	add	a0,a0,-1960 # 6218 <malloc+0x514>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     ...
     9d8:	4a490913          	add	s2,s2,1188 # be78 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  fd = open("big", O_RDONLY);
     ...
     a16:	80650513          	add	a0,a0,-2042 # 6218 <malloc+0x514>
  ...
  n = 0;
    ...
    i = read(fd, buf, BSIZE);
     ...
     a2a:	45290913          	add	s2,s2,1106 # be78 <buf>
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a5e:	7c650513          	add	a0,a0,1990 # 6220 <malloc+0x51c>
    ...
    exit(1);
     ...
     a7c:	7c850513          	add	a0,a0,1992 # 6240 <malloc+0x53c>
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a98:	7d450513          	add	a0,a0,2004 # 6268 <malloc+0x564>
  ...
  if(unlink("big") < 0){
     ...
     ac4:	75850513          	add	a0,a0,1880 # 6218 <malloc+0x514>
     ...
     af0:	79c50513          	add	a0,a0,1948 # 6288 <malloc+0x584>
     ...
     b0e:	7a650513          	add	a0,a0,1958 # 62b0 <malloc+0x5ac>
     ...
     b2c:	7a050513          	add	a0,a0,1952 # 62c8 <malloc+0x5c4>
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b48:	7ac50513          	add	a0,a0,1964 # 62f0 <malloc+0x5ec>
...
0000000000000b5e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b76:	79650513          	add	a0,a0,1942 # 6308 <malloc+0x604>
  ...
  write(fd, "hello", SZ);
     ...
     b8e:	7ae58593          	add	a1,a1,1966 # 6338 <malloc+0x634>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     baa:	76250513          	add	a0,a0,1890 # 6308 <malloc+0x604>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bc0:	74c50513          	add	a0,a0,1868 # 6308 <malloc+0x604>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bd6:	73650513          	add	a0,a0,1846 # 6308 <malloc+0x604>
  ...
  write(fd1, "yyy", 3);
     ...
     bea:	79a58593          	add	a1,a1,1946 # 6380 <malloc+0x67c>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     c06:	27658593          	add	a1,a1,630 # be78 <buf>
     c0a:	8526                	mv	a0,s1
  ...
  if(write(fd, buf, 10) != 10){
     ...
     c30:	24c58593          	add	a1,a1,588 # be78 <buf>
     c34:	8526                	mv	a0,s1
  ...
  unlink("unlinkread");
     ...
     c52:	6ba50513          	add	a0,a0,1722 # 6308 <malloc+0x604>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c72:	6aa50513          	add	a0,a0,1706 # 6318 <malloc+0x614>
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c8e:	6b650513          	add	a0,a0,1718 # 6340 <malloc+0x63c>
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     caa:	6ba50513          	add	a0,a0,1722 # 6360 <malloc+0x65c>
    ...
    printf("%s: unlinkread read failed", s);
     ...
     cc6:	6c650513          	add	a0,a0,1734 # 6388 <malloc+0x684>
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ce2:	6ca50513          	add	a0,a0,1738 # 63a8 <malloc+0x6a4>
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     cfe:	6ce50513          	add	a0,a0,1742 # 63c8 <malloc+0x6c4>
...
0000000000000d14 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d62:	5da58593          	add	a1,a1,1498 # 6338 <malloc+0x634>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d82:	67258593          	add	a1,a1,1650 # 63f0 <malloc+0x6ec>
     d86:	00005517          	auipc	a0,0x5
     d8a:	66250513          	add	a0,a0,1634 # 63e8 <malloc+0x6e4>
  ...
  unlink("lf1");
     ...
     d9e:	64e50513          	add	a0,a0,1614 # 63e8 <malloc+0x6e4>
     da2:	00005097          	auipc	ra,0x5
     da6:	b82080e7          	jalr	-1150(ra) # 5924 <unlink>
  if(open("lf1", 0) >= 0){
     daa:	4581                	li	a1,0
     dac:	00005517          	auipc	a0,0x5
     db0:	63c50513          	add	a0,a0,1596 # 63e8 <malloc+0x6e4>
  ...
  fd = open("lf2", 0);
     ...
     dc6:	62e50513          	add	a0,a0,1582 # 63f0 <malloc+0x6ec>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     dde:	09e58593          	add	a1,a1,158 # be78 <buf>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     dfe:	5f658593          	add	a1,a1,1526 # 63f0 <malloc+0x6ec>
     e02:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e14:	5e050513          	add	a0,a0,1504 # 63f0 <malloc+0x6ec>
     e18:	00005097          	auipc	ra,0x5
     e1c:	b0c080e7          	jalr	-1268(ra) # 5924 <unlink>
  if(link("lf2", "lf1") >= 0){
     e20:	00005597          	auipc	a1,0x5
     e24:	5c858593          	add	a1,a1,1480 # 63e8 <malloc+0x6e4>
     e28:	00005517          	auipc	a0,0x5
     e2c:	5c850513          	add	a0,a0,1480 # 63f0 <malloc+0x6ec>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e40:	5ac58593          	add	a1,a1,1452 # 63e8 <malloc+0x6e4>
     e44:	00005517          	auipc	a0,0x5
     e48:	6b450513          	add	a0,a0,1716 # 64f8 <malloc+0x7f4>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e6a:	59250513          	add	a0,a0,1426 # 63f8 <malloc+0x6f4>
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     e86:	58e50513          	add	a0,a0,1422 # 6410 <malloc+0x70c>
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     ea2:	58a50513          	add	a0,a0,1418 # 6428 <malloc+0x724>
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     ebe:	58e50513          	add	a0,a0,1422 # 6448 <malloc+0x744>
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     eda:	5a250513          	add	a0,a0,1442 # 6478 <malloc+0x774>
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     ef6:	59e50513          	add	a0,a0,1438 # 6490 <malloc+0x78c>
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f12:	59a50513          	add	a0,a0,1434 # 64a8 <malloc+0x7a4>
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     f2e:	5a650513          	add	a0,a0,1446 # 64d0 <malloc+0x7cc>
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f4a:	5ba50513          	add	a0,a0,1466 # 6500 <malloc+0x7fc>
...
0000000000000f60 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fb0:	574a0a13          	add	s4,s4,1396 # 6520 <malloc+0x81c>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1002:	52250513          	add	a0,a0,1314 # 6520 <malloc+0x81c>
  ...
  for(i = 0; i < N; i++){
    ...
    1072:	4ba50513          	add	a0,a0,1210 # 6528 <malloc+0x824>
    ...
    1092:	4ba50513          	add	a0,a0,1210 # 6548 <malloc+0x844>
    ...
    10ae:	4be50513          	add	a0,a0,1214 # 6568 <malloc+0x864>
...
00000000000010c4 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10e0:	4ac98993          	add	s3,s3,1196 # 6588 <malloc+0x884>
    10e4:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    111c:	48050513          	add	a0,a0,1152 # 6598 <malloc+0x894>
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    1144:	b5b48493          	add	s1,s1,-1189 # ffffffffeaeb0b5b <__BSS_END__+0xffffffffeaea1cd3>
...
badarg(char *s)
{
    ...
    1184:	35048493          	add	s1,s1,848 # c350 <buf+0x4d8>
  for(int i = 0; i < 50000; i++){
    ...
    1192:	cb298993          	add	s3,s3,-846 # 5e40 <malloc+0x13c>
    argv[0] = (char*)0xffffffff;
...
00000000000011ba <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    121c:	57878793          	add	a5,a5,1400 # 7790 <malloc+0x1a8c>
  ...
  if(pid == 0){
    ...
    1252:	51278793          	add	a5,a5,1298 # 8760 <big.0>
    1256:	00008697          	auipc	a3,0x8
    125a:	50a68693          	add	a3,a3,1290 # 9760 <__global_pointer$+0x90f>
      big[i] = 'x';
    ...
    1278:	f6478793          	add	a5,a5,-156 # 81d8 <malloc+0x24d4>
    ...
    129c:	ba850513          	add	a0,a0,-1112 # 5e40 <malloc+0x13c>
    ...
    12b4:	39050513          	add	a0,a0,912 # 6640 <malloc+0x93c>
    ...
    12d4:	2e850513          	add	a0,a0,744 # 65b8 <malloc+0x8b4>
    ...
    12f4:	2e850513          	add	a0,a0,744 # 65d8 <malloc+0x8d4>
    ...
    1316:	2e650513          	add	a0,a0,742 # 65f8 <malloc+0x8f4>
    ...
    1336:	2ee50513          	add	a0,a0,750 # 6620 <malloc+0x91c>
    ...
    1350:	76c50513          	add	a0,a0,1900 # 6ab8 <malloc+0xdb4>
  ...
  if(st != 747){
    ...
    139a:	2d250513          	add	a0,a0,722 # 6668 <malloc+0x964>
...
00000000000013b0 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13c4:	ad850513          	add	a0,a0,-1320 # 5e98 <malloc+0x194>
  ...
  if(pid == 0){
    ...
    13f6:	aa6a0a13          	add	s4,s4,-1370 # 5e98 <malloc+0x194>
      int n = write(fd, "1234567890", 10);
    13fa:	00005a97          	auipc	s5,0x5
    13fe:	2cea8a93          	add	s5,s5,718 # 66c8 <malloc+0x9c4>
      int fd = open("truncfile", O_WRONLY);
    1402:	4585                	li	a1,1
    1404:	8552                	mv	a0,s4
    ...
    1476:	22650513          	add	a0,a0,550 # 6698 <malloc+0x994>
    ...
    1492:	22250513          	add	a0,a0,546 # 66b0 <malloc+0x9ac>
    ...
    14b0:	22c50513          	add	a0,a0,556 # 66d8 <malloc+0x9d4>
    ...
    14d6:	9c6a0a13          	add	s4,s4,-1594 # 5e98 <malloc+0x194>
    int n = write(fd, "xxx", 3);
    14da:	00005a97          	auipc	s5,0x5
    14de:	21ea8a93          	add	s5,s5,542 # 66f8 <malloc+0x9f4>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1528:	97450513          	add	a0,a0,-1676 # 5e98 <malloc+0x194>
  ...
  exit(xstatus);
    ...
    1546:	16e50513          	add	a0,a0,366 # 66b0 <malloc+0x9ac>
    ...
    1564:	1a050513          	add	a0,a0,416 # 6700 <malloc+0x9fc>
...
000000000000157a <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    158a:	8ba78793          	add	a5,a5,-1862 # 5e40 <malloc+0x13c>
    158e:	fcf43023          	sd	a5,-64(s0)
    1592:	00005797          	auipc	a5,0x5
    1596:	18e78793          	add	a5,a5,398 # 6720 <malloc+0xa1c>
    159a:	fcf43423          	sd	a5,-56(s0)
    159e:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    15a2:	00005517          	auipc	a0,0x5
    15a6:	18650513          	add	a0,a0,390 # 6728 <malloc+0xa24>
  ...
  if(pid == 0) {
    ...
    15d6:	15650513          	add	a0,a0,342 # 6728 <malloc+0xa24>
    ...
    15f2:	15a50513          	add	a0,a0,346 # 6748 <malloc+0xa44>
    ...
    1610:	08c50513          	add	a0,a0,140 # 6698 <malloc+0x994>
    ...
    162c:	10850513          	add	a0,a0,264 # 6730 <malloc+0xa2c>
    ...
    164a:	7fa50513          	add	a0,a0,2042 # 5e40 <malloc+0x13c>
  ...
  if(xstatus != 0)
    ...
    167e:	0de50513          	add	a0,a0,222 # 6758 <malloc+0xa54>
    ...
    169a:	0da50513          	add	a0,a0,218 # 6770 <malloc+0xa6c>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    16ae:	07e50513          	add	a0,a0,126 # 6728 <malloc+0xa24>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16d8:	b0c50513          	add	a0,a0,-1268 # 61e0 <malloc+0x4dc>
    ...
    16f4:	fc050513          	add	a0,a0,-64 # 66b0 <malloc+0x9ac>
  ...
  unlink("echo-ok");
    ...
    170e:	01e50513          	add	a0,a0,30 # 6728 <malloc+0xa24>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    1738:	05450513          	add	a0,a0,84 # 6788 <malloc+0xa84>
...
0000000000001758 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    17a0:	6dca8a93          	add	s5,s5,1756 # be78 <buf>
    17a4:	864a                	mv	a2,s2
    17a6:	85d6                	mv	a1,s5
    ...
    17bc:	6c070713          	add	a4,a4,1728 # be78 <buf>
    ...
    1800:	fa450513          	add	a0,a0,-92 # 67a0 <malloc+0xa9c>
    ...
    182e:	64eb0b13          	add	s6,s6,1614 # be78 <buf>
    ...
    1842:	42da8a93          	add	s5,s5,1069 # 142d <truncate3+0x7d>
{
    ...
    188e:	f2e50513          	add	a0,a0,-210 # 67b8 <malloc+0xab4>
    ...
    18aa:	f2a50513          	add	a0,a0,-214 # 67d0 <malloc+0xacc>
    ...
    18dc:	f1050513          	add	a0,a0,-240 # 67e8 <malloc+0xae4>
    ...
    1928:	ee450513          	add	a0,a0,-284 # 6808 <malloc+0xb04>
...
000000000000193e <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    199a:	d0250513          	add	a0,a0,-766 # 6698 <malloc+0x994>
    ...
    19b6:	e6e50513          	add	a0,a0,-402 # 6820 <malloc+0xb1c>
    ...
    19d2:	e6a50513          	add	a0,a0,-406 # 6838 <malloc+0xb34>
...
00000000000019f2 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a4a:	c5250513          	add	a0,a0,-942 # 6698 <malloc+0x994>
    ...
    1a6e:	c2e50513          	add	a0,a0,-978 # 6698 <malloc+0x994>
...
0000000000001a8c <forkfork>:
{
    ...
    1ae8:	d7450513          	add	a0,a0,-652 # 6858 <malloc+0xb54>
    ...
    1afa:	dde080e7          	jalr	-546(ra) # 58d4 <exit>
{
    ...
    1b40:	d2c50513          	add	a0,a0,-724 # 6868 <malloc+0xb64>
...
0000000000001b56 <reparent2>:
{
  ...
  exit(0);
    ...
    1b8e:	f2e50513          	add	a0,a0,-210 # 6ab8 <malloc+0xdb4>
...
0000000000001bbe <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1c2c:	e9050513          	add	a0,a0,-368 # 6ab8 <malloc+0xdb4>
    ...
    1c58:	adc50513          	add	a0,a0,-1316 # 6730 <malloc+0xa2c>
    ...
    1cca:	bc250513          	add	a0,a0,-1086 # 6888 <malloc+0xb84>
    ...
    1cfe:	ba650513          	add	a0,a0,-1114 # 68a0 <malloc+0xb9c>
    ...
    1d60:	b6c50513          	add	a0,a0,-1172 # 68c8 <malloc+0xbc4>
...
0000000000001de4 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1e04:	0b050513          	add	a0,a0,176 # 5eb0 <malloc+0x1ac>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1e2e:	e6da0a1b          	addw	s4,s4,-403 # 41c64e6d <__BSS_END__+0x41c55fe5>
    ...
    1e40:	074b0b13          	add	s6,s6,116 # 5eb0 <malloc+0x1ac>
      link("cat", "x");
    1e44:	00005c17          	auipc	s8,0x5
    1e48:	aacc0c13          	add	s8,s8,-1364 # 68f0 <malloc+0xbec>
    1e4c:	a825                	j	1e84 <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1e4e:	85a6                	mv	a1,s1
    1e50:	00005517          	auipc	a0,0x5
    1e54:	84850513          	add	a0,a0,-1976 # 6698 <malloc+0x994>
...
0000000000001ee8 <manywrites>:
{
  ...
  exit(0);
    ...
    1f4c:	b7050513          	add	a0,a0,-1168 # 6ab8 <malloc+0xdb4>
    ...
    1f8e:	eeeb0b13          	add	s6,s6,-274 # be78 <buf>
    ...
    2002:	8fa50513          	add	a0,a0,-1798 # 68f8 <malloc+0xbf4>
    ...
    2022:	ef250513          	add	a0,a0,-270 # 5f10 <malloc+0x20c>
...
0000000000002040 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    2070:	8ec50513          	add	a0,a0,-1812 # 6958 <malloc+0xc54>
    ...
    2094:	88050513          	add	a0,a0,-1920 # 6910 <malloc+0xc0c>
    ...
    20b0:	87c50513          	add	a0,a0,-1924 # 6928 <malloc+0xc24>
    ...
    20cc:	87850513          	add	a0,a0,-1928 # 6940 <malloc+0xc3c>
...
0000000000002118 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2134:	35098993          	add	s3,s3,848 # c350 <buf+0x4d8>
    2138:	1003d937          	lui	s2,0x1003d
    213c:	090e                	sll	s2,s2,0x3
    213e:	48090913          	add	s2,s2,1152 # 1003d480 <__BSS_END__+0x1002e5f8>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2182:	51a50513          	add	a0,a0,1306 # 6698 <malloc+0x994>
    ...
    21a4:	7e050513          	add	a0,a0,2016 # 6980 <malloc+0xc7c>
...
00000000000021c4 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    2226:	47650513          	add	a0,a0,1142 # 6698 <malloc+0x994>
    ...
    2252:	75250513          	add	a0,a0,1874 # 69a0 <malloc+0xc9c>
...
0000000000002272 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2282:	73a50513          	add	a0,a0,1850 # 69b8 <malloc+0xcb4>
  ...
  fd = open("bigarg-ok", 0);
    ...
    22b4:	70850513          	add	a0,a0,1800 # 69b8 <malloc+0xcb4>
  ...
  close(fd);
    ...
    22da:	38a78793          	add	a5,a5,906 # 8660 <args.1>
    22de:	00006697          	auipc	a3,0x6
    22e2:	47a68693          	add	a3,a3,1146 # 8758 <args.1+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    22e6:	00004717          	auipc	a4,0x4
    22ea:	6e270713          	add	a4,a4,1762 # 69c8 <malloc+0xcc4>
    ...
    233e:	76e50513          	add	a0,a0,1902 # 6aa8 <malloc+0xda4>
    ...
    2362:	76a50513          	add	a0,a0,1898 # 6ac8 <malloc+0xdc4>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    23c0:	72c50513          	add	a0,a0,1836 # 6ae8 <malloc+0xde4>
    ...
    23dc:	2c050513          	add	a0,a0,704 # 6698 <malloc+0x994>
...
00000000000023fc <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2476:	31e78793          	add	a5,a5,798 # 7790 <malloc+0x1a8c>
  ...
  if(ret != -1){
    ...
    24b8:	65c50513          	add	a0,a0,1628 # 6b10 <malloc+0xe0c>
    ...
    24d6:	0e650513          	add	a0,a0,230 # 65b8 <malloc+0x8b4>
    ...
    24f4:	0e850513          	add	a0,a0,232 # 65d8 <malloc+0x8d4>
    ...
    2514:	0e850513          	add	a0,a0,232 # 65f8 <malloc+0x8f4>
    ...
    2532:	0f250513          	add	a0,a0,242 # 6620 <malloc+0x91c>
...
0000000000002548 <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    257e:	5d650513          	add	a0,a0,1494 # 6b50 <malloc+0xe4c>
  ...
  if(n >= 0){
    ...
    25ae:	5c650513          	add	a0,a0,1478 # 6b70 <malloc+0xe6c>
    ...
    25cc:	55050513          	add	a0,a0,1360 # 6b18 <malloc+0xe14>
    ...
    25e8:	54c50513          	add	a0,a0,1356 # 6b30 <malloc+0xe2c>
    ...
    2602:	55a50513          	add	a0,a0,1370 # 6b58 <malloc+0xe54>
  ...
  if(n >= 0){
    ...
    2662:	54250513          	add	a0,a0,1346 # 6ba0 <malloc+0xe9c>
    ...
    267c:	4e050513          	add	a0,a0,1248 # 6b58 <malloc+0xe54>
...
00000000000026a6 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2702:	4ca50513          	add	a0,a0,1226 # 6bc8 <malloc+0xec4>
  ...
  for(i = 0; i < 5000; i++){
    ...
    2766:	48650513          	add	a0,a0,1158 # 6be8 <malloc+0xee4>
  ...
  if(c != a + 1){
    ...
    27ca:	48250513          	add	a0,a0,1154 # 6c48 <malloc+0xf44>
    ...
    27ec:	42050513          	add	a0,a0,1056 # 6c08 <malloc+0xf04>
    ...
    2808:	42450513          	add	a0,a0,1060 # 6c28 <malloc+0xf24>
...
0000000000002844 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    2952:	31a50513          	add	a0,a0,794 # 6c68 <malloc+0xf64>
    ...
    296e:	34650513          	add	a0,a0,838 # 6cb0 <malloc+0xfac>
    ...
    298e:	34650513          	add	a0,a0,838 # 6cd0 <malloc+0xfcc>
    ...
    29ae:	36650513          	add	a0,a0,870 # 6d10 <malloc+0x100c>
    ...
    29ca:	37a50513          	add	a0,a0,890 # 6d40 <malloc+0x103c>
    ...
    29ea:	39250513          	add	a0,a0,914 # 6d78 <malloc+0x1074>
...
0000000000002a00 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2a24:	38050513          	add	a0,a0,896 # 6da0 <malloc+0x109c>
    2a28:	00003097          	auipc	ra,0x3
    2a2c:	eec080e7          	jalr	-276(ra) # 5914 <open>
    2a30:	84aa                	mv	s1,a0
  unlink("sbrk");
    2a32:	00004517          	auipc	a0,0x4
    2a36:	36e50513          	add	a0,a0,878 # 6da0 <malloc+0x109c>
  ...
  if(pipe((int *) a) != 0){
    ...
    2a8a:	32250513          	add	a0,a0,802 # 6da8 <malloc+0x10a4>
    ...
    2aa6:	31e50513          	add	a0,a0,798 # 6dc0 <malloc+0x10bc>
    ...
    2ac2:	ce250513          	add	a0,a0,-798 # 67a0 <malloc+0xa9c>
...
0000000000002ad8 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2aec:	2f050513          	add	a0,a0,752 # 6dd8 <malloc+0x10d4>
  ...
  close(fd);
    ...
    2b34:	b8050513          	add	a0,a0,-1152 # 66b0 <malloc+0x9ac>
...
0000000000002b4a <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2b82:	f3a50513          	add	a0,a0,-198 # 6ab8 <malloc+0xdb4>
  ...
  if(pid == 0){
    ...
    2bd8:	ee450513          	add	a0,a0,-284 # 6ab8 <malloc+0xdb4>
  ...
  if(pid == 0){
    ...
    2c10:	8007879b          	addw	a5,a5,-2048 # a800 <uninit+0x1098>
    ...
    2c38:	e8450513          	add	a0,a0,-380 # 6ab8 <malloc+0xdb4>
...
0000000000002d34 <sbrk8000>:
{
  ...
  sbrk(0x80000004);
    ...
    2d40:	0511                	add	a0,a0,4 # ffffffff80000004 <__BSS_END__+0xffffffff7fff117c>
...
execout(char *s)
{
  ...
  exit(0);
    ...
    2dac:	d1050513          	add	a0,a0,-752 # 6ab8 <malloc+0xdb4>
    ...
    2e00:	04450513          	add	a0,a0,68 # 5e40 <malloc+0x13c>
    2e04:	faa43c23          	sd	a0,-72(s0)
    2e08:	00003797          	auipc	a5,0x3
    2e0c:	0a878793          	add	a5,a5,168 # 5eb0 <malloc+0x1ac>
...
0000000000002e2e <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2e3e:	17650513          	add	a0,a0,374 # 6fb0 <malloc+0x12ac>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2e50:	fbc50513          	add	a0,a0,-68 # 6e08 <malloc+0x1104>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2e66:	ffe50513          	add	a0,a0,-2 # 6e60 <malloc+0x115c>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2e84:	05850513          	add	a0,a0,88 # 6ed8 <malloc+0x11d4>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2ea0:	0ac50513          	add	a0,a0,172 # 6f48 <malloc+0x1244>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2eb2:	0f250513          	add	a0,a0,242 # 6fa0 <malloc+0x129c>
  ...
  unlink("12345678901234");
    ...
    2f30:	eb450513          	add	a0,a0,-332 # 6de0 <malloc+0x10dc>
    ...
    2f4c:	ee050513          	add	a0,a0,-288 # 6e28 <malloc+0x1124>
    ...
    2f68:	f2c50513          	add	a0,a0,-212 # 6e90 <malloc+0x118c>
    ...
    2f84:	f8850513          	add	a0,a0,-120 # 6f08 <malloc+0x1204>
    ...
    2fa0:	fcc50513          	add	a0,a0,-52 # 6f68 <malloc+0x1264>
    ...
    2fbc:	00850513          	add	a0,a0,8 # 6fc0 <malloc+0x12bc>
...
0000000000002fd2 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2fe2:	01a50513          	add	a0,a0,26 # 6ff8 <malloc+0x12f4>
  ...
  if(chdir("iputdir") < 0){
    ...
    2ff6:	00650513          	add	a0,a0,6 # 6ff8 <malloc+0x12f4>
  ...
  if(unlink("../iputdir") < 0){
    ...
    300a:	03250513          	add	a0,a0,50 # 7038 <malloc+0x1334>
  ...
  if(chdir("/") < 0){
    ...
    301e:	04e50513          	add	a0,a0,78 # 7068 <malloc+0x1364>
    ...
    303e:	fc650513          	add	a0,a0,-58 # 7000 <malloc+0x12fc>
    ...
    305a:	fc250513          	add	a0,a0,-62 # 7018 <malloc+0x1314>
    ...
    3076:	fd650513          	add	a0,a0,-42 # 7048 <malloc+0x1344>
    ...
    3092:	fe250513          	add	a0,a0,-30 # 7070 <malloc+0x136c>
...
00000000000030a8 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    30c6:	f3650513          	add	a0,a0,-202 # 6ff8 <malloc+0x12f4>
    ...
    30da:	f2250513          	add	a0,a0,-222 # 6ff8 <malloc+0x12f4>
    ...
    30ee:	f4e50513          	add	a0,a0,-178 # 7038 <malloc+0x1334>
    ...
    310e:	58e50513          	add	a0,a0,1422 # 6698 <malloc+0x994>
    ...
    312a:	eda50513          	add	a0,a0,-294 # 7000 <malloc+0x12fc>
    ...
    3146:	f4650513          	add	a0,a0,-186 # 7088 <malloc+0x1384>
    ...
    3162:	eea50513          	add	a0,a0,-278 # 7048 <malloc+0x1344>
...
0000000000003190 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    31a0:	f0450513          	add	a0,a0,-252 # 70a0 <malloc+0x139c>
  ...
  if(chdir("dir0") < 0){
    ...
    31b4:	ef050513          	add	a0,a0,-272 # 70a0 <malloc+0x139c>
  ...
  if(chdir("..") < 0){
    ...
    31c8:	efc50513          	add	a0,a0,-260 # 70c0 <malloc+0x13bc>
  ...
  if(unlink("dir0") < 0){
    ...
    31dc:	ec850513          	add	a0,a0,-312 # 70a0 <malloc+0x139c>
    ...
    31fc:	e0850513          	add	a0,a0,-504 # 7000 <malloc+0x12fc>
    ...
    3218:	e9450513          	add	a0,a0,-364 # 70a8 <malloc+0x13a4>
    ...
    3234:	e9850513          	add	a0,a0,-360 # 70c8 <malloc+0x13c4>
    ...
    3250:	e9450513          	add	a0,a0,-364 # 70e0 <malloc+0x13dc>
...
0000000000003266 <subdir>:
{
  ...
  unlink("ff");
    ...
    3278:	fb450513          	add	a0,a0,-76 # 7228 <malloc+0x1524>
    327c:	00002097          	auipc	ra,0x2
    3280:	6a8080e7          	jalr	1704(ra) # 5924 <unlink>
  if(mkdir("dd") != 0){
    3284:	00004517          	auipc	a0,0x4
    3288:	e7450513          	add	a0,a0,-396 # 70f8 <malloc+0x13f4>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    32a0:	e7c50513          	add	a0,a0,-388 # 7118 <malloc+0x1414>
  ...
  write(fd, "ff", 2);
    ...
    32b8:	f7458593          	add	a1,a1,-140 # 7228 <malloc+0x1524>
  ...
  if(unlink("dd") >= 0){
    ...
    32d2:	e2a50513          	add	a0,a0,-470 # 70f8 <malloc+0x13f4>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    32e6:	e8e50513          	add	a0,a0,-370 # 7170 <malloc+0x146c>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    32fe:	e9e50513          	add	a0,a0,-354 # 7198 <malloc+0x1494>
  ...
  write(fd, "FF", 2);
    ...
    3316:	eb658593          	add	a1,a1,-330 # 71c8 <malloc+0x14c4>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3332:	ea250513          	add	a0,a0,-350 # 71d0 <malloc+0x14cc>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    334a:	b3258593          	add	a1,a1,-1230 # be78 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    337a:	eaa58593          	add	a1,a1,-342 # 7220 <malloc+0x151c>
    337e:	00004517          	auipc	a0,0x4
    3382:	e1a50513          	add	a0,a0,-486 # 7198 <malloc+0x1494>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3396:	e0650513          	add	a0,a0,-506 # 7198 <malloc+0x1494>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    33ac:	df050513          	add	a0,a0,-528 # 7198 <malloc+0x1494>
  ...
  if(chdir("dd") != 0){
    ...
    33c0:	d3c50513          	add	a0,a0,-708 # 70f8 <malloc+0x13f4>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    33d4:	ee850513          	add	a0,a0,-280 # 72b8 <malloc+0x15b4>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    33e8:	f0450513          	add	a0,a0,-252 # 72e8 <malloc+0x15e4>
  ...
  if(chdir("./..") != 0){
    ...
    33fc:	f2050513          	add	a0,a0,-224 # 7318 <malloc+0x1614>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3412:	e1250513          	add	a0,a0,-494 # 7220 <malloc+0x151c>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    342a:	a5258593          	add	a1,a1,-1454 # be78 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    344c:	d5050513          	add	a0,a0,-688 # 7198 <malloc+0x1494>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3464:	f4850513          	add	a0,a0,-184 # 73a8 <malloc+0x16a4>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    347c:	f6050513          	add	a0,a0,-160 # 73d8 <malloc+0x16d4>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    3494:	c6850513          	add	a0,a0,-920 # 70f8 <malloc+0x13f4>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    34aa:	c5250513          	add	a0,a0,-942 # 70f8 <malloc+0x13f4>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    34c0:	c3c50513          	add	a0,a0,-964 # 70f8 <malloc+0x13f4>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    34d4:	f9858593          	add	a1,a1,-104 # 7468 <malloc+0x1764>
    34d8:	00004517          	auipc	a0,0x4
    34dc:	ed050513          	add	a0,a0,-304 # 73a8 <malloc+0x16a4>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    34f0:	f7c58593          	add	a1,a1,-132 # 7468 <malloc+0x1764>
    34f4:	00004517          	auipc	a0,0x4
    34f8:	ee450513          	add	a0,a0,-284 # 73d8 <malloc+0x16d4>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    350c:	d1858593          	add	a1,a1,-744 # 7220 <malloc+0x151c>
    3510:	00004517          	auipc	a0,0x4
    3514:	c0850513          	add	a0,a0,-1016 # 7118 <malloc+0x1414>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    3528:	e8450513          	add	a0,a0,-380 # 73a8 <malloc+0x16a4>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    353c:	ea050513          	add	a0,a0,-352 # 73d8 <malloc+0x16d4>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3550:	cd450513          	add	a0,a0,-812 # 7220 <malloc+0x151c>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3564:	e7850513          	add	a0,a0,-392 # 73d8 <malloc+0x16d4>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    3578:	e3450513          	add	a0,a0,-460 # 73a8 <malloc+0x16a4>
  ...
  if(chdir("dd/ff") == 0){
    ...
    358c:	b9050513          	add	a0,a0,-1136 # 7118 <malloc+0x1414>
  ...
  if(chdir("dd/xx") == 0){
    ...
    35a0:	01c50513          	add	a0,a0,28 # 75b8 <malloc+0x18b4>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    35b4:	c7050513          	add	a0,a0,-912 # 7220 <malloc+0x151c>
  ...
  if(unlink("dd/ff") != 0){
    ...
    35c8:	b5450513          	add	a0,a0,-1196 # 7118 <malloc+0x1414>
  ...
  if(unlink("dd") == 0){
    ...
    35dc:	b2050513          	add	a0,a0,-1248 # 70f8 <malloc+0x13f4>
  ...
  if(unlink("dd/dd") < 0){
    ...
    35f0:	03c50513          	add	a0,a0,60 # 7628 <malloc+0x1924>
  ...
  if(unlink("dd") < 0){
    ...
    3604:	af850513          	add	a0,a0,-1288 # 70f8 <malloc+0x13f4>
    ...
    3626:	ade50513          	add	a0,a0,-1314 # 7100 <malloc+0x13fc>
    ...
    3642:	ae250513          	add	a0,a0,-1310 # 7120 <malloc+0x141c>
    ...
    365e:	ae650513          	add	a0,a0,-1306 # 7140 <malloc+0x143c>
    ...
    367a:	b0250513          	add	a0,a0,-1278 # 7178 <malloc+0x1474>
    ...
    3696:	b1650513          	add	a0,a0,-1258 # 71a8 <malloc+0x14a4>
    ...
    36b2:	b3250513          	add	a0,a0,-1230 # 71e0 <malloc+0x14dc>
    ...
    36ce:	b3650513          	add	a0,a0,-1226 # 7200 <malloc+0x14fc>
    ...
    36ea:	b4a50513          	add	a0,a0,-1206 # 7230 <malloc+0x152c>
    ...
    3706:	b5650513          	add	a0,a0,-1194 # 7258 <malloc+0x1554>
    ...
    3722:	b5a50513          	add	a0,a0,-1190 # 7278 <malloc+0x1574>
    ...
    373e:	b6650513          	add	a0,a0,-1178 # 72a0 <malloc+0x159c>
    ...
    375a:	b7250513          	add	a0,a0,-1166 # 72c8 <malloc+0x15c4>
    ...
    3776:	b8650513          	add	a0,a0,-1146 # 72f8 <malloc+0x15f4>
    ...
    3792:	b9250513          	add	a0,a0,-1134 # 7320 <malloc+0x161c>
    ...
    37ae:	b8e50513          	add	a0,a0,-1138 # 7338 <malloc+0x1634>
    ...
    37ca:	b9250513          	add	a0,a0,-1134 # 7358 <malloc+0x1654>
    ...
    37e6:	b9650513          	add	a0,a0,-1130 # 7378 <malloc+0x1674>
    ...
    3802:	bba50513          	add	a0,a0,-1094 # 73b8 <malloc+0x16b4>
    ...
    381e:	bce50513          	add	a0,a0,-1074 # 73e8 <malloc+0x16e4>
    ...
    383a:	bd250513          	add	a0,a0,-1070 # 7408 <malloc+0x1704>
    ...
    3856:	bd650513          	add	a0,a0,-1066 # 7428 <malloc+0x1724>
    ...
    3872:	bda50513          	add	a0,a0,-1062 # 7448 <malloc+0x1744>
    ...
    388e:	bee50513          	add	a0,a0,-1042 # 7478 <malloc+0x1774>
    ...
    38aa:	bfa50513          	add	a0,a0,-1030 # 74a0 <malloc+0x179c>
    ...
    38c6:	c0650513          	add	a0,a0,-1018 # 74c8 <malloc+0x17c4>
    ...
    38e2:	c1250513          	add	a0,a0,-1006 # 74f0 <malloc+0x17ec>
    ...
    38fe:	c1650513          	add	a0,a0,-1002 # 7510 <malloc+0x180c>
    ...
    391a:	c1a50513          	add	a0,a0,-998 # 7530 <malloc+0x182c>
    ...
    3936:	c2650513          	add	a0,a0,-986 # 7558 <malloc+0x1854>
    ...
    3952:	c2a50513          	add	a0,a0,-982 # 7578 <malloc+0x1874>
    ...
    396e:	c2e50513          	add	a0,a0,-978 # 7598 <malloc+0x1894>
    ...
    398a:	c3a50513          	add	a0,a0,-966 # 75c0 <malloc+0x18bc>
    ...
    39a6:	8b650513          	add	a0,a0,-1866 # 7258 <malloc+0x1554>
    ...
    39c2:	c2250513          	add	a0,a0,-990 # 75e0 <malloc+0x18dc>
    ...
    39de:	c2650513          	add	a0,a0,-986 # 7600 <malloc+0x18fc>
    ...
    39fa:	c3a50513          	add	a0,a0,-966 # 7630 <malloc+0x192c>
    ...
    3a16:	c3e50513          	add	a0,a0,-962 # 7650 <malloc+0x194c>
...
0000000000003a2c <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3a3c:	c3050513          	add	a0,a0,-976 # 7668 <malloc+0x1964>
  ...
  if(chdir("dots") != 0){
    ...
    3a4e:	c1e50513          	add	a0,a0,-994 # 7668 <malloc+0x1964>
  ...
  if(unlink(".") == 0){
    ...
    3a60:	a9c50513          	add	a0,a0,-1380 # 64f8 <malloc+0x7f4>
  ...
  if(unlink("..") == 0){
    ...
    3a72:	65250513          	add	a0,a0,1618 # 70c0 <malloc+0x13bc>
  ...
  if(chdir("/") != 0){
    ...
    3a84:	5e850513          	add	a0,a0,1512 # 7068 <malloc+0x1364>
  ...
  if(unlink("dots/.") == 0){
    ...
    3a96:	c3e50513          	add	a0,a0,-962 # 76d0 <malloc+0x19cc>
  ...
  if(unlink("dots/..") == 0){
    ...
    3aa8:	c5450513          	add	a0,a0,-940 # 76f8 <malloc+0x19f4>
  ...
  if(unlink("dots") != 0){
    ...
    3aba:	bb250513          	add	a0,a0,-1102 # 7668 <malloc+0x1964>
    ...
    3ad8:	b9c50513          	add	a0,a0,-1124 # 7670 <malloc+0x196c>
    ...
    3af4:	b9850513          	add	a0,a0,-1128 # 7688 <malloc+0x1984>
    ...
    3b10:	b9450513          	add	a0,a0,-1132 # 76a0 <malloc+0x199c>
    ...
    3b2c:	b9050513          	add	a0,a0,-1136 # 76b8 <malloc+0x19b4>
    ...
    3b48:	52c50513          	add	a0,a0,1324 # 7070 <malloc+0x136c>
    ...
    3b64:	b7850513          	add	a0,a0,-1160 # 76d8 <malloc+0x19d4>
    ...
    3b80:	b8450513          	add	a0,a0,-1148 # 7700 <malloc+0x19fc>
    ...
    3b9c:	b8850513          	add	a0,a0,-1144 # 7720 <malloc+0x1a1c>
...
0000000000003bb2 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3bc8:	b7c50513          	add	a0,a0,-1156 # 7740 <malloc+0x1a3c>
  ...
  if(chdir("dirfile") == 0){
    ...
    3be4:	b6050513          	add	a0,a0,-1184 # 7740 <malloc+0x1a3c>
  ...
  fd = open("dirfile/xx", 0);
    ...
    3bf8:	b9450513          	add	a0,a0,-1132 # 7788 <malloc+0x1a84>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3c10:	b7c50513          	add	a0,a0,-1156 # 7788 <malloc+0x1a84>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3c24:	b6850513          	add	a0,a0,-1176 # 7788 <malloc+0x1a84>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3c38:	b5450513          	add	a0,a0,-1196 # 7788 <malloc+0x1a84>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3c4c:	b4058593          	add	a1,a1,-1216 # 7788 <malloc+0x1a84>
    3c50:	00002517          	auipc	a0,0x2
    3c54:	39850513          	add	a0,a0,920 # 5fe8 <malloc+0x2e4>
  ...
  if(unlink("dirfile") != 0){
    ...
    3c68:	adc50513          	add	a0,a0,-1316 # 7740 <malloc+0x1a3c>
  ...
  fd = open(".", O_RDWR);
    ...
    3c7e:	87e50513          	add	a0,a0,-1922 # 64f8 <malloc+0x7f4>
  ...
  fd = open(".", 0);
    ...
    3c94:	86850513          	add	a0,a0,-1944 # 64f8 <malloc+0x7f4>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3ca8:	20c58593          	add	a1,a1,524 # 5eb0 <malloc+0x1ac>
  ...
  close(fd);
    ...
    3cd4:	a7850513          	add	a0,a0,-1416 # 7748 <malloc+0x1a44>
    ...
    3cf0:	a7c50513          	add	a0,a0,-1412 # 7768 <malloc+0x1a64>
    ...
    3d0c:	a9050513          	add	a0,a0,-1392 # 7798 <malloc+0x1a94>
    ...
    3d28:	a7450513          	add	a0,a0,-1420 # 7798 <malloc+0x1a94>
    ...
    3d44:	a8050513          	add	a0,a0,-1408 # 77c0 <malloc+0x1abc>
    ...
    3d60:	a8c50513          	add	a0,a0,-1396 # 77e8 <malloc+0x1ae4>
    ...
    3d7c:	a9850513          	add	a0,a0,-1384 # 7810 <malloc+0x1b0c>
    ...
    3d98:	aa450513          	add	a0,a0,-1372 # 7838 <malloc+0x1b34>
    ...
    3db4:	aa850513          	add	a0,a0,-1368 # 7858 <malloc+0x1b54>
    ...
    3dd0:	ab450513          	add	a0,a0,-1356 # 7880 <malloc+0x1b7c>
...
0000000000003de6 <iref>:
{
    ...
    3e04:	a98a0a13          	add	s4,s4,-1384 # 7898 <malloc+0x1b94>
    mkdir("");
    3e08:	00003497          	auipc	s1,0x3
    3e0c:	59848493          	add	s1,s1,1432 # 73a0 <malloc+0x169c>
    link("README", "");
    3e10:	00002a97          	auipc	s5,0x2
    3e14:	1d8a8a93          	add	s5,s5,472 # 5fe8 <malloc+0x2e4>
    fd = open("xx", O_CREATE);
    3e18:	00004997          	auipc	s3,0x4
    3e1c:	97898993          	add	s3,s3,-1672 # 7790 <malloc+0x1a8c>
    3e20:	a891                	j	3e74 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    3e22:	85da                	mv	a1,s6
    3e24:	00004517          	auipc	a0,0x4
    3e28:	a7c50513          	add	a0,a0,-1412 # 78a0 <malloc+0x1b9c>
    ...
    3e44:	a7850513          	add	a0,a0,-1416 # 78b8 <malloc+0x1bb4>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3ed8:	1ec98993          	add	s3,s3,492 # 70c0 <malloc+0x13bc>
    unlink("irefd");
    3edc:	00004917          	auipc	s2,0x4
    3ee0:	9bc90913          	add	s2,s2,-1604 # 7898 <malloc+0x1b94>
    chdir("..");
    3ee4:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3f00:	16c50513          	add	a0,a0,364 # 7068 <malloc+0x1364>
...
0000000000003f20 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3f30:	9a450513          	add	a0,a0,-1628 # 78d0 <malloc+0x1bcc>
  ...
  if(pid == 0){
    ...
    3f54:	98050513          	add	a0,a0,-1664 # 78d0 <malloc+0x1bcc>
    ...
    3f6a:	98a50513          	add	a0,a0,-1654 # 78f0 <malloc+0x1bec>
    ...
    3f86:	95650513          	add	a0,a0,-1706 # 78d8 <malloc+0x1bd4>
    ...
    3fa2:	6fa50513          	add	a0,a0,1786 # 6698 <malloc+0x994>
  ...
  if(unlink("oidir") != 0){
    ...
    3fd0:	90450513          	add	a0,a0,-1788 # 78d0 <malloc+0x1bcc>
    ...
    3fe4:	8a850513          	add	a0,a0,-1880 # 6888 <malloc+0xb84>
...
0000000000004012 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    4022:	8fa50513          	add	a0,a0,-1798 # 7918 <malloc+0x1c14>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    404e:	8ce50513          	add	a0,a0,-1842 # 7918 <malloc+0x1c14>
  ...
  sleep(10); // one second
    ...
    4086:	7d650513          	add	a0,a0,2006 # 6858 <malloc+0xb54>
    ...
    40a0:	87c48493          	add	s1,s1,-1924 # 7918 <malloc+0x1c14>
    40a4:	4581                	li	a1,0
    40a6:	8526                	mv	a0,s1
    ...
    40c8:	85450513          	add	a0,a0,-1964 # 7918 <malloc+0x1c14>
...
00000000000040e8 <killstatus>:
{
  ...
  exit(0);
    ...
    414e:	54e50513          	add	a0,a0,1358 # 6698 <malloc+0x994>
    ...
    4174:	7b850513          	add	a0,a0,1976 # 7928 <malloc+0x1c24>
...
000000000000418a <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    41b4:	6a850513          	add	a0,a0,1704 # 6858 <malloc+0xb54>
  ...
  if(pid2 == 0)
    ...
    41e2:	4ba50513          	add	a0,a0,1210 # 6698 <malloc+0x994>
  ...
  if(pid3 == 0){
    ...
    4226:	c8e58593          	add	a1,a1,-882 # 5eb0 <malloc+0x1ac>
    ...
    4250:	44c50513          	add	a0,a0,1100 # 6698 <malloc+0x994>
    ...
    426c:	6e050513          	add	a0,a0,1760 # 7948 <malloc+0x1c44>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    428c:	bf058593          	add	a1,a1,-1040 # be78 <buf>
    ...
    42a8:	6bc50513          	add	a0,a0,1724 # 7960 <malloc+0x1c5c>
  ...
  printf("kill... ");
    ...
    42d4:	6a850513          	add	a0,a0,1704 # 7978 <malloc+0x1c74>
  ...
  printf("wait... ");
    ...
    4302:	68a50513          	add	a0,a0,1674 # 7988 <malloc+0x1c84>
...
000000000000432e <reparent>:
{
  ...
  exit(0);
    ...
    4382:	31a50513          	add	a0,a0,794 # 6698 <malloc+0x994>
    ...
    439e:	48650513          	add	a0,a0,1158 # 6820 <malloc+0xb1c>
...
00000000000043de <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    4414:	39050513          	add	a0,a0,912 # 67a0 <malloc+0xa9c>
    ...
    4448:	a6c58593          	add	a1,a1,-1428 # 5eb0 <malloc+0x1ac>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    450c:	49050513          	add	a0,a0,1168 # 7998 <malloc+0x1c94>
    ...
    4528:	17450513          	add	a0,a0,372 # 6698 <malloc+0x994>
    ...
    4574:	44850513          	add	a0,a0,1096 # 79b8 <malloc+0x1cb4>
...
0000000000004594 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4618:	3d450513          	add	a0,a0,980 # 79e8 <malloc+0x1ce4>
...
0000000000004638 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    46da:	34250513          	add	a0,a0,834 # 7a18 <malloc+0x1d14>
    ...
    46f6:	34e50513          	add	a0,a0,846 # 7a40 <malloc+0x1d3c>
  ...
  fd = open("sharedfd", 0);
    ...
    473a:	2d250513          	add	a0,a0,722 # 7a08 <malloc+0x1d04>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    477a:	2ea50513          	add	a0,a0,746 # 7a60 <malloc+0x1d5c>
  ...
  unlink("sharedfd");
    ...
    47b6:	25650513          	add	a0,a0,598 # 7a08 <malloc+0x1d04>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    47dc:	2b050513          	add	a0,a0,688 # 7a88 <malloc+0x1d84>
...
00000000000047fc <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4820:	28478793          	add	a5,a5,644 # 7aa0 <malloc+0x1d9c>
    4824:	f6f43823          	sd	a5,-144(s0)
    4828:	00003797          	auipc	a5,0x3
    482c:	28078793          	add	a5,a5,640 # 7aa8 <malloc+0x1da4>
    4830:	f6f43c23          	sd	a5,-136(s0)
    4834:	00003797          	auipc	a5,0x3
    4838:	27c78793          	add	a5,a5,636 # 7ab0 <malloc+0x1dac>
    483c:	f8f43023          	sd	a5,-128(s0)
    4840:	00003797          	auipc	a5,0x3
    4844:	27878793          	add	a5,a5,632 # 7ab8 <malloc+0x1db4>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    489c:	5e0a0a13          	add	s4,s4,1504 # be78 <buf>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    48b2:	20a50513          	add	a0,a0,522 # 6ab8 <malloc+0xdb4>
    ...
    492c:	19850513          	add	a0,a0,408 # 7ac0 <malloc+0x1dbc>
    ...
    4946:	18e50513          	add	a0,a0,398 # 7ad0 <malloc+0x1dcc>
    ...
    496c:	18050513          	add	a0,a0,384 # 7ae8 <malloc+0x1de4>
    ...
    499c:	4e078793          	add	a5,a5,1248 # be78 <buf>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    49f4:	10850513          	add	a0,a0,264 # 7af8 <malloc+0x1df4>
...
0000000000004a28 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4a56:	0beb8b93          	add	s7,s7,190 # 7b10 <malloc+0x1e0c>
  for(i = 0; i < N; i++){
    ...
    4a98:	08450513          	add	a0,a0,132 # 7b18 <malloc+0x1e14>
    ...
    4ab6:	05e50513          	add	a0,a0,94 # 7b10 <malloc+0x1e0c>
  ...
  fd = open(".", 0);
    ...
    4aee:	a0e50513          	add	a0,a0,-1522 # 64f8 <malloc+0x7f4>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4b66:	fd650513          	add	a0,a0,-42 # 7b38 <malloc+0x1e34>
    ...
    4b86:	fd650513          	add	a0,a0,-42 # 7b58 <malloc+0x1e54>
  ...
  for(i = 0; i < N; i++){
    ...
    4bbe:	fc650513          	add	a0,a0,-58 # 7b80 <malloc+0x1e7c>
    ...
    4bda:	ac250513          	add	a0,a0,-1342 # 6698 <malloc+0x994>
...
0000000000004d84 <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4dc4:	0b890913          	add	s2,s2,184 # be78 <buf>
  for(i = 0; i < N; i++){
    4dc8:	4a51                	li	s4,20
  if(fd < 0){
  ...
  fd = open("bigfile.dat", 0);
    ...
    4e0c:	db050513          	add	a0,a0,-592 # 7bb8 <malloc+0x1eb4>
  ...
  for(i = 0; ; i++){
    ...
    4e22:	05a90913          	add	s2,s2,90 # be78 <buf>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    4e70:	d5c50513          	add	a0,a0,-676 # 7bc8 <malloc+0x1ec4>
    ...
    4e8c:	d6050513          	add	a0,a0,-672 # 7be8 <malloc+0x1ee4>
    ...
    4ea8:	d6450513          	add	a0,a0,-668 # 7c08 <malloc+0x1f04>
    ...
    4ec4:	d6850513          	add	a0,a0,-664 # 7c28 <malloc+0x1f24>
    ...
    4ee0:	d6c50513          	add	a0,a0,-660 # 7c48 <malloc+0x1f44>
    ...
    4efc:	d6850513          	add	a0,a0,-664 # 7c60 <malloc+0x1f5c>
  ...
  unlink("bigfile.dat");
    ...
    4f2a:	c9250513          	add	a0,a0,-878 # 7bb8 <malloc+0x1eb4>
    ...
    4f4e:	d3650513          	add	a0,a0,-714 # 7c80 <malloc+0x1f7c>
...
0000000000004f64 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4f84:	d2050513          	add	a0,a0,-736 # 7ca0 <malloc+0x1f9c>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    4fa4:	d10c8c93          	add	s9,s9,-752 # 7cb0 <malloc+0x1fac>
    name[0] = 'f';
    ...
    5014:	cb050513          	add	a0,a0,-848 # 7cc0 <malloc+0x1fbc>
  ...
  printf("fsfull test finished\n");
    ...
    508a:	c5a50513          	add	a0,a0,-934 # 7ce0 <malloc+0x1fdc>
    ...
    50b8:	dc4a8a93          	add	s5,s5,-572 # be78 <buf>
      if(cc < BSIZE)
    ...
    50e0:	bf450513          	add	a0,a0,-1036 # 7cd0 <malloc+0x1fcc>
...
00000000000050fe <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    5172:	b8a50513          	add	a0,a0,-1142 # 7cf8 <malloc+0x1ff4>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    518a:	d2a58593          	add	a1,a1,-726 # 5eb0 <malloc+0x1ac>
    ...
    51a0:	b7c50513          	add	a0,a0,-1156 # 7d18 <malloc+0x2014>
    ...
    51ba:	b4a50513          	add	a0,a0,-1206 # 7d00 <malloc+0x1ffc>
    ...
    51d4:	b3050513          	add	a0,a0,-1232 # 7d00 <malloc+0x1ffc>
  ...
  unlink("junk");
    ...
    51f8:	b0450513          	add	a0,a0,-1276 # 7cf8 <malloc+0x1ff4>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    524e:	c6698993          	add	s3,s3,-922 # 5eb0 <malloc+0x1ac>
      uint64 a = (uint64) sbrk(4096);
    ...
    5280:	aec50513          	add	a0,a0,-1300 # 7d68 <malloc+0x2064>
    ...
    52a0:	a8c50513          	add	a0,a0,-1396 # 7d28 <malloc+0x2024>
    ...
    52c0:	a8c50513          	add	a0,a0,-1396 # 7d48 <malloc+0x2044>
  ...
  while(1){
    ...
    5314:	a7850513          	add	a0,a0,-1416 # 7d88 <malloc+0x2084>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5360:	a4c50513          	add	a0,a0,-1460 # 7da8 <malloc+0x20a4>
  ...
  if(pid == 0) {
    ...
    5390:	a4450513          	add	a0,a0,-1468 # 7dd0 <malloc+0x20cc>
    ...
    53b4:	a0850513          	add	a0,a0,-1528 # 7db8 <malloc+0x20b4>
    ...
    53dc:	a0050513          	add	a0,a0,-1536 # 7dd8 <malloc+0x20d4>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    5426:	dd678793          	add	a5,a5,-554 # 81f8 <malloc+0x24f4>
    542a:	bd040713          	add	a4,s0,-1072
    542e:	00003317          	auipc	t1,0x3
    5432:	1ba30313          	add	t1,t1,442 # 85e8 <malloc+0x28e4>
  ...
  printf("usertests starting\n");
    ...
    5466:	a3650513          	add	a0,a0,-1482 # 7e98 <malloc+0x2194>
  ...
  if(fail){
    ...
    54a0:	9b450513          	add	a0,a0,-1612 # 7e50 <malloc+0x214c>
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    54d0:	91458593          	add	a1,a1,-1772 # 7de0 <malloc+0x20dc>
    ...
    54e6:	d1678793          	add	a5,a5,-746 # 81f8 <malloc+0x24f4>
    54ea:	bd040713          	add	a4,s0,-1072
    54ee:	00003317          	auipc	t1,0x3
    54f2:	0fa30313          	add	t1,t1,250 # 85e8 <malloc+0x28e4>
    ...
    5526:	98e50513          	add	a0,a0,-1650 # 7eb0 <malloc+0x21ac>
    552a:	00000097          	auipc	ra,0x0
    552e:	722080e7          	jalr	1826(ra) # 5c4c <printf>
        printf("SOME TESTS FAILED\n");
    5532:	00003a97          	auipc	s5,0x3
    5536:	906a8a93          	add	s5,s5,-1786 # 7e38 <malloc+0x2134>
        if(continuous != 2)
    553a:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    553c:	00003b17          	auipc	s6,0x3
    5540:	8dcb0b13          	add	s6,s6,-1828 # 7e18 <malloc+0x2114>
    5544:	a8f5                	j	5640 <main+0x256>
  } else if(argc == 2 && strcmp(argv[1], "-C") == 0){
    5546:	00003597          	auipc	a1,0x3
    554a:	8a258593          	add	a1,a1,-1886 # 7de8 <malloc+0x20e4>
    ...
    5584:	87050513          	add	a0,a0,-1936 # 7df0 <malloc+0x20ec>
  ...
  if(fail){
    ...
    55f6:	84650513          	add	a0,a0,-1978 # 7e38 <malloc+0x2134>
    ...
    5610:	87450513          	add	a0,a0,-1932 # 7e80 <malloc+0x217c>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    59c8:	c7c50513          	add	a0,a0,-900 # 8640 <digits>
    59cc:	883a                	mv	a6,a4
    59ce:	2705                	addw	a4,a4,1
    59d0:	02c5f7bb          	remuw	a5,a1,a2
    59d4:	1782                	sll	a5,a5,0x20
    59d6:	9381                	srl	a5,a5,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  putc(fd, 'x');
    ...
    5b5a:	aeab8b93          	add	s7,s7,-1302 # 8640 <digits>
    5b5e:	03c9d793          	srl	a5,s3,0x3c
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5b72:	0992                	sll	s3,s3,0x4
    5b74:	397d                	addw	s2,s2,-1
    ...
    5bb0:	62490913          	add	s2,s2,1572 # 81d0 <malloc+0x24cc>
        while(*s != 0){
    5bb4:	02800593          	li	a1,40
    5bb8:	bff1                	j	5b94 <vprintf+0x142>
        putc(fd, va_arg(ap, uint));
    5bba:	008b8913          	add	s2,s7,8
...
{
    5c1e:	715d                	add	sp,sp,-80
    5c20:	ec06                	sd	ra,24(sp)
    5c22:	e822                	sd	s0,16(sp)
    5c24:	1000                	add	s0,sp,32
...
{
    5c4c:	711d                	add	sp,sp,-96
    5c4e:	ec06                	sd	ra,24(sp)
    5c50:	e822                	sd	s0,16(sp)
    5c52:	1000                	add	s0,sp,32
...
free(void *ap)
{
    5c82:	1141                	add	sp,sp,-16
    5c84:	e422                	sd	s0,8(sp)
    5c86:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5c88:	ff050693          	add	a3,a0,-16
    ...
    5cb8:	00e6ea63          	bltu	a3,a4,5ccc <free+0x4a>
{
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    5cd2:	02059813          	sll	a6,a1,0x20
    5cd6:	01c85713          	srl	a4,a6,0x1c
  ...
  if(p + p->s.size == bp){
    ...
    5ce6:	02061593          	sll	a1,a2,0x20
    5cea:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
    5d04:	7139                	add	sp,sp,-64
    5d06:	fc06                	sd	ra,56(sp)
    5d08:	f822                	sd	s0,48(sp)
    5d0a:	f426                	sd	s1,40(sp)
    5d0c:	ec4e                	sd	s3,24(sp)
    5d0e:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    5d10:	02051493          	sll	s1,a0,0x20
    5d14:	9081                	srl	s1,s1,0x20
    5d16:	04bd                	add	s1,s1,15
    5d18:	8091                	srl	s1,s1,0x4
    5d1a:	0014899b          	addw	s3,s1,1
    5d1e:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    5d54:	90890913          	add	s2,s2,-1784 # 8658 <freep>
  if(p == (char*)-1)
    5d58:	5afd                	li	s5,-1
    ...
    5d68:	11478793          	add	a5,a5,276 # ee78 <base>
  ...
  if(p == (char*)-1)
    ...
    5dd2:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5dd4:	02071693          	sll	a3,a4,0x20
    5dd8:	01c6d713          	srl	a4,a3,0x1c
