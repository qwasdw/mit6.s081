...
main(int argc, char *argv[])
{
  ...
  32:	83258593          	add	a1,a1,-1998 # 860 <malloc+0x104>
  36:	4509                	li	a0,2
  ...
  a8:	7d458593          	add	a1,a1,2004 # 878 <malloc+0x11c>
  ac:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 420:	4d450513          	add	a0,a0,1236 # 8f0 <digits>
 424:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 526:	37670713          	add	a4,a4,886 # 898 <malloc+0x13c>
 ...
 5b2:	342b8b93          	add	s7,s7,834 # 8f0 <digits>
 ...
 608:	28c90913          	add	s2,s2,652 # 890 <malloc+0x134>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 7ac:	16090913          	add	s2,s2,352 # 908 <freep>
  if(p == (char*)-1)
 7b0:	5afd                	li	s5,-1
 ...
 7c0:	15478793          	add	a5,a5,340 # 910 <base>
