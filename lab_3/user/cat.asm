...
cat(int fd)
{
  ...
  14:	99090913          	add	s2,s2,-1648 # 9a0 <buf>
  ...
  44:	89858593          	add	a1,a1,-1896 # 8d8 <malloc+0x104>
  48:	4509                	li	a0,2
  ...
  72:	88258593          	add	a1,a1,-1918 # 8f0 <malloc+0x11c>
  76:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
 ...
 10a:	80258593          	add	a1,a1,-2046 # 908 <malloc+0x134>
 10e:	4509                	li	a0,2
...
ugetpid(void)
{
 ...
 390:	17f5                	add	a5,a5,-3 # 3fffffd <__global_pointer$+0x3ffee6c>
 392:	07b2                	sll	a5,a5,0xc
}
 394:	4388                	lw	a0,0(a5)
 396:	6422                	ld	s0,8(sp)
...
putc(int fd, char c)
{
 454:	1101                	add	sp,sp,-32
 456:	ec06                	sd	ra,24(sp)
 458:	e822                	sd	s0,16(sp)
 45a:	1000                	add	s0,sp,32
 45c:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
 460:	4605                	li	a2,1
 462:	fef40593          	add	a1,s0,-17
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 498:	4ec50513          	add	a0,a0,1260 # 980 <digits>
 49c:	883a                	mv	a6,a4
 ...
 4e0:	fc040793          	add	a5,s0,-64
 4e4:	00e78933          	add	s2,a5,a4
 4e8:	fff78993          	add	s3,a5,-1
 4ec:	99ba                	add	s3,s3,a4
 4ee:	377d                	addw	a4,a4,-1
 4f0:	1702                	sll	a4,a4,0x20
 4f2:	9301                	srl	a4,a4,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 59e:	38e70713          	add	a4,a4,910 # 928 <malloc+0x154>
 ...
 62a:	35ab8b93          	add	s7,s7,858 # 980 <digits>
 62e:	03c9d793          	srl	a5,s3,0x3c
 ...
 680:	2a490913          	add	s2,s2,676 # 920 <malloc+0x14c>
        while(*s != 0){
 ...
 788:	00e6ea63          	bltu	a3,a4,79c <free+0x4a>
{
 ...
 7a0:	6390                	ld	a2,0(a5)
 7a2:	02059813          	sll	a6,a1,0x20
 7a6:	01c85713          	srl	a4,a6,0x1c
 ...
 7b0:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
 7b4:	4790                	lw	a2,8(a5)
 7b6:	02061593          	sll	a1,a2,0x20
 7ba:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
 ...
 824:	17890913          	add	s2,s2,376 # 998 <freep>
  if(p == (char*)-1)
 828:	5afd                	li	s5,-1
 ...
 838:	36c78793          	add	a5,a5,876 # ba0 <base>
