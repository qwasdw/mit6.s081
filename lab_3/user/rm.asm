...
main(int argc, char *argv[])
{
  ...
  44:	7f058593          	add	a1,a1,2032 # 830 <malloc+0x104>
  48:	4509                	li	a0,2
  ...
  62:	7ea58593          	add	a1,a1,2026 # 848 <malloc+0x11c>
  66:	4509                	li	a0,2
...
ugetpid(void)
{
 ...
 2e8:	17f5                	add	a5,a5,-3 # 3fffffd <__global_pointer$+0x3ffef24>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3f0:	4dc50513          	add	a0,a0,1244 # 8c8 <digits>
 3f4:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4f6:	37e70713          	add	a4,a4,894 # 870 <malloc+0x144>
 ...
 582:	34ab8b93          	add	s7,s7,842 # 8c8 <digits>
 ...
 5d8:	29490913          	add	s2,s2,660 # 868 <malloc+0x13c>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 77c:	16890913          	add	s2,s2,360 # 8e0 <freep>
  if(p == (char*)-1)
 780:	5afd                	li	s5,-1
 ...
 790:	15c78793          	add	a5,a5,348 # 8e8 <base>
