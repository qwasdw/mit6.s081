...
wc(int fd, char *name)
{
  ...
  32:	9e2d8d93          	add	s11,s11,-1566 # a10 <buf>
    for(i=0; i<n; i++){
      c++;
      if(buf[i] == '\n')
  36:	4aa9                	li	s5,10
  ...
  3c:	910a0a13          	add	s4,s4,-1776 # 948 <malloc+0x106>
        inword = 0;
  40:	4b81                	li	s7,0
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  8e:	98648493          	add	s1,s1,-1658 # a10 <buf>
  ...
  aa:	8c250513          	add	a0,a0,-1854 # 968 <malloc+0x126>
  ...
  d8:	88450513          	add	a0,a0,-1916 # 958 <malloc+0x116>
...
main(int argc, char *argv[])
{
 ...
 15a:	7fa58593          	add	a1,a1,2042 # 950 <malloc+0x10e>
 15e:	4501                	li	a0,0
 ...
 17a:	80250513          	add	a0,a0,-2046 # 978 <malloc+0x136>
...
ugetpid(void)
{
 ...
 3fe:	17f5                	add	a5,a5,-3 # 3fffffd <__global_pointer$+0x3ffedfc>
 400:	07b2                	sll	a5,a5,0xc
}
 402:	4388                	lw	a0,0(a5)
 404:	6422                	ld	s0,8(sp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 506:	4ee50513          	add	a0,a0,1262 # 9f0 <digits>
 50a:	883a                	mv	a6,a4
 ...
 54e:	fc040793          	add	a5,s0,-64
 552:	00e78933          	add	s2,a5,a4
 556:	fff78993          	add	s3,a5,-1
 55a:	99ba                	add	s3,s3,a4
 55c:	377d                	addw	a4,a4,-1
 55e:	1702                	sll	a4,a4,0x20
 560:	9301                	srl	a4,a4,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 60c:	39070713          	add	a4,a4,912 # 998 <malloc+0x156>
 ...
 698:	35cb8b93          	add	s7,s7,860 # 9f0 <digits>
 69c:	03c9d793          	srl	a5,s3,0x3c
 ...
 6ee:	2a690913          	add	s2,s2,678 # 990 <malloc+0x14e>
        while(*s != 0){
...
free(void *ap)
{
 7c0:	1141                	add	sp,sp,-16
 7c2:	e422                	sd	s0,8(sp)
 7c4:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
 7c6:	ff050693          	add	a3,a0,-16
 ...
 7f6:	00e6ea63          	bltu	a3,a4,80a <free+0x4a>
{
 ...
 80e:	6390                	ld	a2,0(a5)
 810:	02059813          	sll	a6,a1,0x20
 814:	01c85713          	srl	a4,a6,0x1c
 ...
 81e:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
 822:	4790                	lw	a2,8(a5)
 824:	02061593          	sll	a1,a2,0x20
 828:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
 ...
 84e:	02051493          	sll	s1,a0,0x20
 852:	9081                	srl	s1,s1,0x20
 854:	04bd                	add	s1,s1,15
 856:	8091                	srl	s1,s1,0x4
 858:	0014899b          	addw	s3,s1,1
 85c:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
 ...
 892:	17a90913          	add	s2,s2,378 # a08 <freep>
  if(p == (char*)-1)
 896:	5afd                	li	s5,-1
 ...
 8a6:	36e78793          	add	a5,a5,878 # c10 <base>
 ...
 910:	c798                	sw	a4,8(a5)
        p += p->s.size;
 912:	02071693          	sll	a3,a4,0x20
 916:	01c6d713          	srl	a4,a3,0x1c
