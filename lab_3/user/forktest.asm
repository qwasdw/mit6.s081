...
forktest(void)
{
  ...
  3e:	40e50513          	add	a0,a0,1038 # 448 <pgaccess+0x8>
  ...
  68:	43450513          	add	a0,a0,1076 # 498 <pgaccess+0x58>
  ...
  8a:	3d250513          	add	a0,a0,978 # 458 <pgaccess+0x18>
  ...
  a4:	3d050513          	add	a0,a0,976 # 470 <pgaccess+0x30>
  ...
  e4:	3a850513          	add	a0,a0,936 # 488 <pgaccess+0x48>
...
memset(void *dst, int c, uint n)
{
 ...
 190:	87aa                	mv	a5,a0
 192:	1602                	sll	a2,a2,0x20
 194:	9201                	srl	a2,a2,0x20
...
gets(char *buf, int max)
{
 ...
 1ee:	4b35                	li	s6,13
  for(i=0; i+1 < max; ){
 1f0:	89a6                	mv	s3,s1
 1f2:	2485                	addw	s1,s1,1
 1f4:	0344d863          	bge	s1,s4,224 <gets+0x56>
    cc = read(0, &c, 1);
 1f8:	4605                	li	a2,1
 1fa:	faf40593          	add	a1,s0,-81
 1fe:	4501                	li	a0,0
...
atoi(const char *s)
{
 ...
 2a2:	4501                	li	a0,0
    n = n*10 + *s++ - '0';
 2a4:	0705                	add	a4,a4,1
 2a6:	0025179b          	sllw	a5,a0,0x2
 2aa:	9fa9                	addw	a5,a5,a0
 2ac:	0017979b          	sllw	a5,a5,0x1
 2b0:	9fb5                	addw	a5,a5,a3
 2b2:	fd07851b          	addw	a0,a5,-48
  while('0' <= *s && *s <= '9')
 2b6:	00074683          	lbu	a3,0(a4)
 2ba:	fd06879b          	addw	a5,a3,-48
...
memcmp(const void *s1, const void *s2, uint n)
{
 ...
 330:	fff6069b          	addw	a3,a2,-1
 334:	1682                	sll	a3,a3,0x20
 336:	9281                	srl	a3,a3,0x20
 338:	0685                	add	a3,a3,1
...
ugetpid(void)
{
 ...
 384:	17f5                	add	a5,a5,-3 # 3fffffd <__global_pointer$+0x3fff346>
 386:	07b2                	sll	a5,a5,0xc
}
 388:	4388                	lw	a0,0(a5)
 38a:	6422                	ld	s0,8(sp)
