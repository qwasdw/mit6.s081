...
000000000000011a <grep>:
{
 ...
 140:	9dca8a93          	add	s5,s5,-1572 # b18 <buf>
 ...
 1ba:	96250513          	add	a0,a0,-1694 # b18 <buf>
...
00000000000001ec <main>:
{
 ...
 25e:	80658593          	add	a1,a1,-2042 # a60 <malloc+0x104>
 262:	4509                	li	a0,2
 ...
 294:	7f050513          	add	a0,a0,2032 # a80 <malloc+0x124>
...
ugetpid(void)
{
 ...
 518:	17f5                	add	a5,a5,-3 # 3fffffd <__global_pointer$+0x3ffecf4>
 51a:	07b2                	sll	a5,a5,0xc
}
 51c:	4388                	lw	a0,0(a5)
 51e:	6422                	ld	s0,8(sp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 620:	4dc50513          	add	a0,a0,1244 # af8 <digits>
 624:	883a                	mv	a6,a4
 ...
 668:	fc040793          	add	a5,s0,-64
 66c:	00e78933          	add	s2,a5,a4
 670:	fff78993          	add	s3,a5,-1
 674:	99ba                	add	s3,s3,a4
 676:	377d                	addw	a4,a4,-1
 678:	1702                	sll	a4,a4,0x20
 67a:	9301                	srl	a4,a4,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 726:	37e70713          	add	a4,a4,894 # aa0 <malloc+0x144>
 ...
 7b2:	34ab8b93          	add	s7,s7,842 # af8 <digits>
 7b6:	03c9d793          	srl	a5,s3,0x3c
 ...
 7ca:	0992                	sll	s3,s3,0x4
 7cc:	397d                	addw	s2,s2,-1
 ...
 808:	29490913          	add	s2,s2,660 # a98 <malloc+0x13c>
        while(*s != 0){
...
{
 876:	715d                	add	sp,sp,-80
 878:	ec06                	sd	ra,24(sp)
 87a:	e822                	sd	s0,16(sp)
 87c:	1000                	add	s0,sp,32
 87e:	e010                	sd	a2,0(s0)
 880:	e414                	sd	a3,8(s0)
...
free(void *ap)
{
 8da:	1141                	add	sp,sp,-16
 8dc:	e422                	sd	s0,8(sp)
 8de:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
 8e0:	ff050693          	add	a3,a0,-16
 ...
 910:	00e6ea63          	bltu	a3,a4,924 <free+0x4a>
{
 ...
 928:	6390                	ld	a2,0(a5)
 92a:	02059813          	sll	a6,a1,0x20
 92e:	01c85713          	srl	a4,a6,0x1c
 ...
 938:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
 93c:	4790                	lw	a2,8(a5)
 93e:	02061593          	sll	a1,a2,0x20
 942:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
 95c:	7139                	add	sp,sp,-64
 95e:	fc06                	sd	ra,56(sp)
 960:	f822                	sd	s0,48(sp)
 962:	f426                	sd	s1,40(sp)
 964:	ec4e                	sd	s3,24(sp)
 966:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 968:	02051493          	sll	s1,a0,0x20
 96c:	9081                	srl	s1,s1,0x20
 96e:	04bd                	add	s1,s1,15
 970:	8091                	srl	s1,s1,0x4
 972:	0014899b          	addw	s3,s1,1
 976:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
 ...
 9ac:	16890913          	add	s2,s2,360 # b10 <freep>
  if(p == (char*)-1)
 9b0:	5afd                	li	s5,-1
 ...
 9c0:	55c78793          	add	a5,a5,1372 # f18 <base>
