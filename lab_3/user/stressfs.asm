...
main(int argc, char *argv[])
{
  ...
  1a:	8da78793          	add	a5,a5,-1830 # 8f0 <malloc+0x132>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	89450513          	add	a0,a0,-1900 # 8c0 <malloc+0x102>
  ...
  6c:	87050513          	add	a0,a0,-1936 # 8d8 <malloc+0x11a>
...
//    printf(fd, "%d\n", i);
  ...
  ba:	83250513          	add	a0,a0,-1998 # 8e8 <malloc+0x12a>
...
ugetpid(void)
{
 ...
 37a:	17f5                	add	a5,a5,-3 # 3fffffd <__global_pointer$+0x3ffee8c>
 37c:	07b2                	sll	a5,a5,0xc
}
 37e:	4388                	lw	a0,0(a5)
 380:	6422                	ld	s0,8(sp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 482:	4e250513          	add	a0,a0,1250 # 960 <digits>
 486:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 588:	38470713          	add	a4,a4,900 # 908 <malloc+0x14a>
 ...
 614:	350b8b93          	add	s7,s7,848 # 960 <digits>
 ...
 66a:	29a90913          	add	s2,s2,666 # 900 <malloc+0x142>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 80e:	16e90913          	add	s2,s2,366 # 978 <freep>
  if(p == (char*)-1)
 812:	5afd                	li	s5,-1
 ...
 822:	16278793          	add	a5,a5,354 # 980 <base>
