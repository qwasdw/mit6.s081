...
main(void)
{
  ...
  12:	8a250513          	add	a0,a0,-1886 # 8b0 <malloc+0x106>
  ...
  3a:	88290913          	add	s2,s2,-1918 # 8b8 <malloc+0x10e>
  3e:	854a                	mv	a0,s2
  ...
  6e:	89e50513          	add	a0,a0,-1890 # 908 <malloc+0x15e>
  ...
  8c:	82850513          	add	a0,a0,-2008 # 8b0 <malloc+0x106>
  90:	00000097          	auipc	ra,0x0
  94:	332080e7          	jalr	818(ra) # 3c2 <mknod>
    open("console", O_RDWR);
  98:	4589                	li	a1,2
  9a:	00001517          	auipc	a0,0x1
  9e:	81650513          	add	a0,a0,-2026 # 8b0 <malloc+0x106>
  a2:	00000097          	auipc	ra,0x0
  a6:	318080e7          	jalr	792(ra) # 3ba <open>
  aa:	bfa5                	j	22 <main+0x22>
      printf("init: fork failed\n");
  ac:	00001517          	auipc	a0,0x1
  b0:	82450513          	add	a0,a0,-2012 # 8d0 <malloc+0x126>
  ...
  ca:	8da58593          	add	a1,a1,-1830 # 9a0 <argv>
  ce:	00001517          	auipc	a0,0x1
  d2:	81a50513          	add	a0,a0,-2022 # 8e8 <malloc+0x13e>
  d6:	00000097          	auipc	ra,0x0
  da:	2dc080e7          	jalr	732(ra) # 3b2 <exec>
      printf("init: exec sh failed\n");
  de:	00001517          	auipc	a0,0x1
  e2:	81250513          	add	a0,a0,-2030 # 8f0 <malloc+0x146>
...
ugetpid(void)
{
 ...
 366:	17f5                	add	a5,a5,-3 # 3fffffd <__global_pointer$+0x3ffee5d>
 368:	07b2                	sll	a5,a5,0xc
}
 36a:	4388                	lw	a0,0(a5)
 36c:	6422                	ld	s0,8(sp)
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 574:	3c070713          	add	a4,a4,960 # 930 <malloc+0x186>
 ...
 600:	38cb8b93          	add	s7,s7,908 # 988 <digits>
 ...
 656:	2d690913          	add	s2,s2,726 # 928 <malloc+0x17e>
        while(*s != 0){
 ...
 75e:	00e6ea63          	bltu	a3,a4,772 <free+0x4a>
{
 ...
 776:	6390                	ld	a2,0(a5)
 778:	02059813          	sll	a6,a1,0x20
 77c:	01c85713          	srl	a4,a6,0x1c
 ...
 786:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
 78a:	4790                	lw	a2,8(a5)
 78c:	02061593          	sll	a1,a2,0x20
 790:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
 ...
 7fa:	1ba90913          	add	s2,s2,442 # 9b0 <freep>
  if(p == (char*)-1)
 7fe:	5afd                	li	s5,-1
 ...
 80e:	1ae78793          	add	a5,a5,430 # 9b8 <base>
