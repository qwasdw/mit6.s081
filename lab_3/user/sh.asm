...
getcmd(char *buf, int nbuf)
{
  ...
  fprintf(2, "$ ");
      ...
      14:	31058593          	add	a1,a1,784 # 1320 <malloc+0x106>
      18:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      62:	2d258593          	add	a1,a1,722 # 1330 <malloc+0x116>
      66:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9c:	2a050513          	add	a0,a0,672 # 1338 <malloc+0x11e>
...
00000000000000a8 <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      c8:	37470713          	add	a4,a4,884 # 1438 <malloc+0x21e>
    ...
    panic("runcmd");
      ...
      e4:	26050513          	add	a0,a0,608 # 1340 <malloc+0x126>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     106:	24658593          	add	a1,a1,582 # 1348 <malloc+0x12e>
     10a:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     152:	20a58593          	add	a1,a1,522 # 1358 <malloc+0x13e>
     156:	4509                	li	a0,2
    ...
    break;
     ...
     1e8:	18450513          	add	a0,a0,388 # 1368 <malloc+0x14e>
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     400:	0e498993          	add	s3,s3,228 # 14e0 <whitespace>
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     466:	07e98993          	add	s3,s3,126 # 14e0 <whitespace>
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     4d2:	01298993          	add	s3,s3,18 # 14e0 <whitespace>
     4d6:	00001a97          	auipc	s5,0x1
     4da:	002a8a93          	add	s5,s5,2 # 14d8 <symbols>
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     548:	f9c98993          	add	s3,s3,-100 # 14e0 <whitespace>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5b6:	ddea8a93          	add	s5,s5,-546 # 1390 <malloc+0x176>
  ...
  while(peek(ps, es, "<>")){
     ...
     5c8:	dac50513          	add	a0,a0,-596 # 1370 <malloc+0x156>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a0:	cfc60613          	add	a2,a2,-772 # 1398 <malloc+0x17e>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6dc:	ce0b0b13          	add	s6,s6,-800 # 13b8 <malloc+0x19e>
  ...
  return ret;
     ...
     70a:	c9a50513          	add	a0,a0,-870 # 13a0 <malloc+0x186>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76c:	c4050513          	add	a0,a0,-960 # 13a8 <malloc+0x18e>
...
0000000000000792 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7b2:	c1260613          	add	a2,a2,-1006 # 13c0 <malloc+0x1a6>
     7b6:	85ce                	mv	a1,s3
     7b8:	854a                	mv	a0,s2
...
0000000000000800 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     822:	baaa0a13          	add	s4,s4,-1110 # 13c8 <malloc+0x1ae>
  ...
  if(peek(ps, es, ";")){
     ...
     858:	b7c60613          	add	a2,a2,-1156 # 13d0 <malloc+0x1b6>
     85c:	85ce                	mv	a1,s3
     85e:	854a                	mv	a0,s2
...
00000000000008a8 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8be:	ade60613          	add	a2,a2,-1314 # 1398 <malloc+0x17e>
  ...
  if(!peek(ps, es, ")"))
     ...
     8ee:	afe60613          	add	a2,a2,-1282 # 13e8 <malloc+0x1ce>
     8f2:	85ca                	mv	a1,s2
     8f4:	8526                	mv	a0,s1
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     96c:	ae870713          	add	a4,a4,-1304 # 1450 <malloc+0x236>
...
00000000000009e4 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a18:	91460613          	add	a2,a2,-1772 # 1328 <malloc+0x10e>
     a1c:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a4e:	9be58593          	add	a1,a1,-1602 # 1408 <malloc+0x1ee>
     a52:	4509                	li	a0,2
     a54:	00000097          	auipc	ra,0x0
     a58:	6e0080e7          	jalr	1760(ra) # 1134 <fprintf>
    panic("syntax");
     a5c:	00001517          	auipc	a0,0x1
     a60:	94450513          	add	a0,a0,-1724 # 13a0 <malloc+0x186>
...
0000000000000a6c <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a80:	99c48493          	add	s1,s1,-1636 # 1418 <malloc+0x1fe>
     a84:	4589                	li	a1,2
     a86:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     aa6:	a4e48493          	add	s1,s1,-1458 # 14f0 <buf.0>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     afa:	9faa0a13          	add	s4,s4,-1542 # 14f0 <buf.0>
     afe:	8552                	mv	a0,s4
     ...
     b1a:	9dd50513          	add	a0,a0,-1571 # 14f3 <buf.0+0x3>
     b1e:	00000097          	auipc	ra,0x0
     b22:	33c080e7          	jalr	828(ra) # e5a <chdir>
     b26:	fa0551e3          	bgez	a0,ac8 <main+0x5c>
        fprintf(2, "cannot cd %s\n", buf+3);
     b2a:	00001617          	auipc	a2,0x1
     b2e:	9c960613          	add	a2,a2,-1591 # 14f3 <buf.0+0x3>
     b32:	00001597          	auipc	a1,0x1
     b36:	8ee58593          	add	a1,a1,-1810 # 1420 <malloc+0x206>
     b3a:	4509                	li	a0,2
     ...
     b4a:	9aa50513          	add	a0,a0,-1622 # 14f0 <buf.0>
...
ugetpid(void)
{
     dcc:	1141                	add	sp,sp,-16
     dce:	e422                	sd	s0,8(sp)
     dd0:	0800                	add	s0,sp,16
  struct usyscall *u = (struct usyscall *)USYSCALL;
  return u->pid;
     dd2:	040007b7          	lui	a5,0x4000
     dd6:	17f5                	add	a5,a5,-3 # 3fffffd <__global_pointer$+0x3ffe32c>
     dd8:	07b2                	sll	a5,a5,0xc
}
     dda:	4388                	lw	a0,0(a5)
     ddc:	6422                	ld	s0,8(sp)
     dde:	0141                	add	sp,sp,16
     de0:	8082                	ret
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     ede:	5e650513          	add	a0,a0,1510 # 14c0 <digits>
     ee2:	883a                	mv	a6,a4
  ...
  while(--i >= 0)
     ...
     f26:	fc040793          	add	a5,s0,-64
     f2a:	00e78933          	add	s2,a5,a4
     f2e:	fff78993          	add	s3,a5,-1
     f32:	99ba                	add	s3,s3,a4
     f34:	377d                	addw	a4,a4,-1
     f36:	1702                	sll	a4,a4,0x20
     f38:	9301                	srl	a4,a4,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     fe4:	48870713          	add	a4,a4,1160 # 1468 <malloc+0x24e>
  ...
  putc(fd, 'x');
    ...
    1070:	454b8b93          	add	s7,s7,1108 # 14c0 <digits>
    1074:	03c9d793          	srl	a5,s3,0x3c
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    1088:	0992                	sll	s3,s3,0x4
    108a:	397d                	addw	s2,s2,-1
    ...
    10c6:	36e90913          	add	s2,s2,878 # 1430 <malloc+0x216>
        while(*s != 0){
    10ca:	02800593          	li	a1,40
    10ce:	bff1                	j	10aa <vprintf+0x142>
        putc(fd, va_arg(ap, uint));
    10d0:	008b8913          	add	s2,s7,8
...
{
    1134:	715d                	add	sp,sp,-80
    1136:	ec06                	sd	ra,24(sp)
    1138:	e822                	sd	s0,16(sp)
    113a:	1000                	add	s0,sp,32
...
free(void *ap)
{
    1198:	1141                	add	sp,sp,-16
    119a:	e422                	sd	s0,8(sp)
    119c:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    119e:	ff050693          	add	a3,a0,-16
    ...
    11ce:	00e6ea63          	bltu	a3,a4,11e2 <free+0x4a>
{
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    11e8:	02059813          	sll	a6,a1,0x20
    11ec:	01c85713          	srl	a4,a6,0x1c
  ...
  if(p + p->s.size == bp){
    ...
    11fc:	02061593          	sll	a1,a2,0x20
    1200:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
    121a:	7139                	add	sp,sp,-64
    121c:	fc06                	sd	ra,56(sp)
    121e:	f822                	sd	s0,48(sp)
    1220:	f426                	sd	s1,40(sp)
    1222:	ec4e                	sd	s3,24(sp)
    1224:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    1226:	02051493          	sll	s1,a0,0x20
    122a:	9081                	srl	s1,s1,0x20
    122c:	04bd                	add	s1,s1,15
    122e:	8091                	srl	s1,s1,0x4
    1230:	0014899b          	addw	s3,s1,1
    1234:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    126a:	28290913          	add	s2,s2,642 # 14e8 <freep>
  if(p == (char*)-1)
    126e:	5afd                	li	s5,-1
    ...
    127e:	2de78793          	add	a5,a5,734 # 1558 <base>
  ...
  if(p == (char*)-1)
    ...
    12e8:	c798                	sw	a4,8(a5)
        p += p->s.size;
    12ea:	02071693          	sll	a3,a4,0x20
    12ee:	01c6d713          	srl	a4,a3,0x1c
