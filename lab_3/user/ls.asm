...
fmtname(char *path)
{
  ...
  66:	b1e98993          	add	s3,s3,-1250 # b80 <buf.0>
...
ls(char *path)
{
 ...
 118:	9ac50513          	add	a0,a0,-1620 # ac0 <malloc+0x136>
 ...
 14a:	94a58593          	add	a1,a1,-1718 # a90 <malloc+0x106>
 14e:	4509                	li	a0,2
 ...
 160:	94c58593          	add	a1,a1,-1716 # aa8 <malloc+0x11e>
 164:	4509                	li	a0,2
 ...
 196:	93e50513          	add	a0,a0,-1730 # ad0 <malloc+0x146>
 ...
 1e6:	906a0a13          	add	s4,s4,-1786 # ae8 <malloc+0x15e>
        printf("ls: cannot stat %s\n", buf);
 1ea:	00001a97          	auipc	s5,0x1
 1ee:	8bea8a93          	add	s5,s5,-1858 # aa8 <malloc+0x11e>
...
main(int argc, char *argv[])
{
 ...
 2c2:	83a50513          	add	a0,a0,-1990 # af8 <malloc+0x16e>
...
ugetpid(void)
{
 ...
 546:	17f5                	add	a5,a5,-3 # 3fffffd <__global_pointer$+0x3ffec8c>
 548:	07b2                	sll	a5,a5,0xc
}
 54a:	4388                	lw	a0,0(a5)
 54c:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 9da:	1a290913          	add	s2,s2,418 # b78 <freep>
  if(p == (char*)-1)
 9de:	5afd                	li	s5,-1
 ...
 9ee:	1a678793          	add	a5,a5,422 # b90 <base>
