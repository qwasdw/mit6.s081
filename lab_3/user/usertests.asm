...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	de250513          	add	a0,a0,-542 # 5e20 <malloc+0x106>
...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
      ...
      5c:	72878793          	add	a5,a5,1832 # 9780 <uninit>
      60:	0000c697          	auipc	a3,0xc
      64:	e3068693          	add	a3,a3,-464 # be90 <buf>
    if(uninit[i] != '\0'){
      ...
      74:	8082                	ret
{
      ...
      84:	dc050513          	add	a0,a0,-576 # 5e40 <malloc+0x126>
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	db050513          	add	a0,a0,-592 # 5e58 <malloc+0x13e>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	db250513          	add	a0,a0,-590 # 5e78 <malloc+0x15e>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	d7a50513          	add	a0,a0,-646 # 5e60 <malloc+0x146>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	d8650513          	add	a0,a0,-634 # 5e88 <malloc+0x16e>
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	d8450513          	add	a0,a0,-636 # 5eb0 <malloc+0x196>
     134:	00006097          	auipc	ra,0x6
     138:	806080e7          	jalr	-2042(ra) # 593a <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	d7050513          	add	a0,a0,-656 # 5eb0 <malloc+0x196>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	d6c58593          	add	a1,a1,-660 # 5ec0 <malloc+0x1a6>
     15c:	00005097          	auipc	ra,0x5
     160:	7ae080e7          	jalr	1966(ra) # 590a <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	d4850513          	add	a0,a0,-696 # 5eb0 <malloc+0x196>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	d4c58593          	add	a1,a1,-692 # 5ec8 <malloc+0x1ae>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	d1c50513          	add	a0,a0,-740 # 5eb0 <malloc+0x196>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	d0650513          	add	a0,a0,-762 # 5ed0 <malloc+0x1b6>
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	c7c50513          	add	a0,a0,-900 # 5ef8 <malloc+0x1de>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	c68a8a93          	add	s5,s5,-920 # 5ef8 <malloc+0x1de>
      int cc = write(fd, buf, sz);
     298:	0000ca17          	auipc	s4,0xc
     29c:	bf8a0a13          	add	s4,s4,-1032 # be90 <buf>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     2a0:	6b0d                	lui	s6,0x3
     2a2:	1c9b0b13          	add	s6,s6,457 # 31c9 <dirtest+0x39>
    fd = open("bigwrite", O_CREATE | O_RDWR);
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	bf650513          	add	a0,a0,-1034 # 5f08 <malloc+0x1ee>
     ...
     338:	bf450513          	add	a0,a0,-1036 # 5f28 <malloc+0x20e>
...
000000000000034e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     374:	bd0a0a13          	add	s4,s4,-1072 # 5f40 <malloc+0x226>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     420:	b2c50513          	add	a0,a0,-1236 # 5f48 <malloc+0x22e>
     ...
     43e:	b2650513          	add	a0,a0,-1242 # 5f60 <malloc+0x246>
     ...
     45c:	b3850513          	add	a0,a0,-1224 # 5f90 <malloc+0x276>
     ...
     476:	b4e50513          	add	a0,a0,-1202 # 5fc0 <malloc+0x2a6>
     ...
     494:	b4050513          	add	a0,a0,-1216 # 5fd0 <malloc+0x2b6>
...
00000000000004aa <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4d2:	b32a0a13          	add	s4,s4,-1230 # 6000 <malloc+0x2e6>
    n = write(fds[1], "x", 1);
     4d6:	00006a97          	auipc	s5,0x6
     4da:	9f2a8a93          	add	s5,s5,-1550 # 5ec8 <malloc+0x1ae>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     580:	a8c50513          	add	a0,a0,-1396 # 6008 <malloc+0x2ee>
     ...
     59e:	a8650513          	add	a0,a0,-1402 # 6020 <malloc+0x306>
     ...
     5b8:	a0c50513          	add	a0,a0,-1524 # 5fc0 <malloc+0x2a6>
     ...
     5d2:	a8250513          	add	a0,a0,-1406 # 6050 <malloc+0x336>
     ...
     5f0:	a7c50513          	add	a0,a0,-1412 # 6068 <malloc+0x34e>
...
0000000000000606 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     646:	87e58593          	add	a1,a1,-1922 # 5ec0 <malloc+0x1a6>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     662:	85250513          	add	a0,a0,-1966 # 5eb0 <malloc+0x196>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     68e:	82650513          	add	a0,a0,-2010 # 5eb0 <malloc+0x196>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6a2:	81250513          	add	a0,a0,-2030 # 5eb0 <malloc+0x196>
  ...
  write(fd1, "abcdef", 6);
     ...
     6e0:	a1c58593          	add	a1,a1,-1508 # 60f8 <malloc+0x3de>
     6e4:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     722:	79250513          	add	a0,a0,1938 # 5eb0 <malloc+0x196>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     766:	93650513          	add	a0,a0,-1738 # 6098 <malloc+0x37e>
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     782:	93a50513          	add	a0,a0,-1734 # 60b8 <malloc+0x39e>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     796:	93650513          	add	a0,a0,-1738 # 60c8 <malloc+0x3ae>
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7b2:	93a50513          	add	a0,a0,-1734 # 60e8 <malloc+0x3ce>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     7c6:	90650513          	add	a0,a0,-1786 # 60c8 <malloc+0x3ae>
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     7e4:	92050513          	add	a0,a0,-1760 # 6100 <malloc+0x3e6>
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     802:	92250513          	add	a0,a0,-1758 # 6120 <malloc+0x406>
...
0000000000000818 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     836:	90e50513          	add	a0,a0,-1778 # 6140 <malloc+0x426>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     84e:	91e98993          	add	s3,s3,-1762 # 6168 <malloc+0x44e>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     852:	00006a97          	auipc	s5,0x6
     856:	94ea8a93          	add	s5,s5,-1714 # 61a0 <malloc+0x486>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     89c:	8a850513          	add	a0,a0,-1880 # 6140 <malloc+0x426>
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     8b6:	5de58593          	add	a1,a1,1502 # be90 <buf>
  ...
  if(unlink("small") < 0){
     ...
     8d8:	86c50513          	add	a0,a0,-1940 # 6140 <malloc+0x426>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     902:	84a50513          	add	a0,a0,-1974 # 6148 <malloc+0x42e>
    ...
    exit(1);
     ...
     920:	85c50513          	add	a0,a0,-1956 # 6178 <malloc+0x45e>
     ...
     93e:	87650513          	add	a0,a0,-1930 # 61b0 <malloc+0x496>
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     95a:	88250513          	add	a0,a0,-1918 # 61d8 <malloc+0x4be>
    ...
    printf("%s: read failed\n", s);
     ...
     976:	88650513          	add	a0,a0,-1914 # 61f8 <malloc+0x4de>
    ...
    printf("%s: unlink small failed\n", s);
     ...
     992:	88250513          	add	a0,a0,-1918 # 6210 <malloc+0x4f6>
...
00000000000009a8 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9c4:	87050513          	add	a0,a0,-1936 # 6230 <malloc+0x516>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     ...
     9d8:	4bc90913          	add	s2,s2,1212 # be90 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  fd = open("big", O_RDONLY);
     ...
     a16:	81e50513          	add	a0,a0,-2018 # 6230 <malloc+0x516>
  ...
  n = 0;
    ...
    i = read(fd, buf, BSIZE);
     ...
     a2a:	46a90913          	add	s2,s2,1130 # be90 <buf>
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a5e:	7de50513          	add	a0,a0,2014 # 6238 <malloc+0x51e>
    ...
    exit(1);
     ...
     a7c:	7e050513          	add	a0,a0,2016 # 6258 <malloc+0x53e>
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a98:	7ec50513          	add	a0,a0,2028 # 6280 <malloc+0x566>
  ...
  if(unlink("big") < 0){
     ...
     ac4:	77050513          	add	a0,a0,1904 # 6230 <malloc+0x516>
     ...
     af0:	7b450513          	add	a0,a0,1972 # 62a0 <malloc+0x586>
     ...
     b0e:	7be50513          	add	a0,a0,1982 # 62c8 <malloc+0x5ae>
     ...
     b2c:	7b850513          	add	a0,a0,1976 # 62e0 <malloc+0x5c6>
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b48:	7c450513          	add	a0,a0,1988 # 6308 <malloc+0x5ee>
...
0000000000000b5e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b76:	7ae50513          	add	a0,a0,1966 # 6320 <malloc+0x606>
  ...
  write(fd, "hello", SZ);
     ...
     b8e:	7c658593          	add	a1,a1,1990 # 6350 <malloc+0x636>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     baa:	77a50513          	add	a0,a0,1914 # 6320 <malloc+0x606>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bc0:	76450513          	add	a0,a0,1892 # 6320 <malloc+0x606>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bd6:	74e50513          	add	a0,a0,1870 # 6320 <malloc+0x606>
  ...
  write(fd1, "yyy", 3);
     ...
     bea:	7b258593          	add	a1,a1,1970 # 6398 <malloc+0x67e>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     c06:	28e58593          	add	a1,a1,654 # be90 <buf>
     c0a:	8526                	mv	a0,s1
  ...
  if(write(fd, buf, 10) != 10){
     ...
     c30:	26458593          	add	a1,a1,612 # be90 <buf>
     c34:	8526                	mv	a0,s1
  ...
  unlink("unlinkread");
     ...
     c52:	6d250513          	add	a0,a0,1746 # 6320 <malloc+0x606>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c72:	6c250513          	add	a0,a0,1730 # 6330 <malloc+0x616>
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c8e:	6ce50513          	add	a0,a0,1742 # 6358 <malloc+0x63e>
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     caa:	6d250513          	add	a0,a0,1746 # 6378 <malloc+0x65e>
    ...
    printf("%s: unlinkread read failed", s);
     ...
     cc6:	6de50513          	add	a0,a0,1758 # 63a0 <malloc+0x686>
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ce2:	6e250513          	add	a0,a0,1762 # 63c0 <malloc+0x6a6>
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     cfe:	6e650513          	add	a0,a0,1766 # 63e0 <malloc+0x6c6>
...
0000000000000d14 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d62:	5f258593          	add	a1,a1,1522 # 6350 <malloc+0x636>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d82:	68a58593          	add	a1,a1,1674 # 6408 <malloc+0x6ee>
     d86:	00005517          	auipc	a0,0x5
     d8a:	67a50513          	add	a0,a0,1658 # 6400 <malloc+0x6e6>
  ...
  unlink("lf1");
     ...
     d9e:	66650513          	add	a0,a0,1638 # 6400 <malloc+0x6e6>
     da2:	00005097          	auipc	ra,0x5
     da6:	b98080e7          	jalr	-1128(ra) # 593a <unlink>
  if(open("lf1", 0) >= 0){
     daa:	4581                	li	a1,0
     dac:	00005517          	auipc	a0,0x5
     db0:	65450513          	add	a0,a0,1620 # 6400 <malloc+0x6e6>
  ...
  fd = open("lf2", 0);
     ...
     dc6:	64650513          	add	a0,a0,1606 # 6408 <malloc+0x6ee>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     dde:	0b658593          	add	a1,a1,182 # be90 <buf>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     dfe:	60e58593          	add	a1,a1,1550 # 6408 <malloc+0x6ee>
     e02:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e14:	5f850513          	add	a0,a0,1528 # 6408 <malloc+0x6ee>
     e18:	00005097          	auipc	ra,0x5
     e1c:	b22080e7          	jalr	-1246(ra) # 593a <unlink>
  if(link("lf2", "lf1") >= 0){
     e20:	00005597          	auipc	a1,0x5
     e24:	5e058593          	add	a1,a1,1504 # 6400 <malloc+0x6e6>
     e28:	00005517          	auipc	a0,0x5
     e2c:	5e050513          	add	a0,a0,1504 # 6408 <malloc+0x6ee>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e40:	5c458593          	add	a1,a1,1476 # 6400 <malloc+0x6e6>
     e44:	00005517          	auipc	a0,0x5
     e48:	6cc50513          	add	a0,a0,1740 # 6510 <malloc+0x7f6>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e6a:	5aa50513          	add	a0,a0,1450 # 6410 <malloc+0x6f6>
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     e86:	5a650513          	add	a0,a0,1446 # 6428 <malloc+0x70e>
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     ea2:	5a250513          	add	a0,a0,1442 # 6440 <malloc+0x726>
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     ebe:	5a650513          	add	a0,a0,1446 # 6460 <malloc+0x746>
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     eda:	5ba50513          	add	a0,a0,1466 # 6490 <malloc+0x776>
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     ef6:	5b650513          	add	a0,a0,1462 # 64a8 <malloc+0x78e>
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f12:	5b250513          	add	a0,a0,1458 # 64c0 <malloc+0x7a6>
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     f2e:	5be50513          	add	a0,a0,1470 # 64e8 <malloc+0x7ce>
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f4a:	5d250513          	add	a0,a0,1490 # 6518 <malloc+0x7fe>
...
0000000000000f60 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fb0:	58ca0a13          	add	s4,s4,1420 # 6538 <malloc+0x81e>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1002:	53a50513          	add	a0,a0,1338 # 6538 <malloc+0x81e>
  ...
  for(i = 0; i < N; i++){
    ...
    1072:	4d250513          	add	a0,a0,1234 # 6540 <malloc+0x826>
    ...
    1092:	4d250513          	add	a0,a0,1234 # 6560 <malloc+0x846>
    ...
    10ae:	4d650513          	add	a0,a0,1238 # 6580 <malloc+0x866>
...
00000000000010c4 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10e0:	4c498993          	add	s3,s3,1220 # 65a0 <malloc+0x886>
    10e4:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    111c:	49850513          	add	a0,a0,1176 # 65b0 <malloc+0x896>
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    1144:	b5b48493          	add	s1,s1,-1189 # ffffffffeaeb0b5b <__BSS_END__+0xffffffffeaea1cbb>
...
badarg(char *s)
{
    ...
    1184:	35048493          	add	s1,s1,848 # c350 <buf+0x4c0>
  for(int i = 0; i < 50000; i++){
    ...
    1192:	cca98993          	add	s3,s3,-822 # 5e58 <malloc+0x13e>
    argv[0] = (char*)0xffffffff;
...
00000000000011ba <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    121c:	59078793          	add	a5,a5,1424 # 77a8 <malloc+0x1a8e>
  ...
  if(pid == 0){
    ...
    1252:	52a78793          	add	a5,a5,1322 # 8778 <big.0>
    1256:	00008697          	auipc	a3,0x8
    125a:	52268693          	add	a3,a3,1314 # 9778 <__global_pointer$+0x90f>
      big[i] = 'x';
    ...
    1278:	f7c78793          	add	a5,a5,-132 # 81f0 <malloc+0x24d6>
    ...
    129c:	bc050513          	add	a0,a0,-1088 # 5e58 <malloc+0x13e>
    ...
    12b4:	3a850513          	add	a0,a0,936 # 6658 <malloc+0x93e>
    ...
    12d4:	30050513          	add	a0,a0,768 # 65d0 <malloc+0x8b6>
    ...
    12f4:	30050513          	add	a0,a0,768 # 65f0 <malloc+0x8d6>
    ...
    1316:	2fe50513          	add	a0,a0,766 # 6610 <malloc+0x8f6>
    ...
    1336:	30650513          	add	a0,a0,774 # 6638 <malloc+0x91e>
    ...
    1350:	78450513          	add	a0,a0,1924 # 6ad0 <malloc+0xdb6>
  ...
  if(st != 747){
    ...
    139a:	2ea50513          	add	a0,a0,746 # 6680 <malloc+0x966>
...
00000000000013b0 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13c4:	af050513          	add	a0,a0,-1296 # 5eb0 <malloc+0x196>
  ...
  if(pid == 0){
    ...
    13f6:	abea0a13          	add	s4,s4,-1346 # 5eb0 <malloc+0x196>
      int n = write(fd, "1234567890", 10);
    13fa:	00005a97          	auipc	s5,0x5
    13fe:	2e6a8a93          	add	s5,s5,742 # 66e0 <malloc+0x9c6>
      int fd = open("truncfile", O_WRONLY);
    1402:	4585                	li	a1,1
    1404:	8552                	mv	a0,s4
    ...
    1476:	23e50513          	add	a0,a0,574 # 66b0 <malloc+0x996>
    ...
    1492:	23a50513          	add	a0,a0,570 # 66c8 <malloc+0x9ae>
    ...
    14b0:	24450513          	add	a0,a0,580 # 66f0 <malloc+0x9d6>
    ...
    14d6:	9dea0a13          	add	s4,s4,-1570 # 5eb0 <malloc+0x196>
    int n = write(fd, "xxx", 3);
    14da:	00005a97          	auipc	s5,0x5
    14de:	236a8a93          	add	s5,s5,566 # 6710 <malloc+0x9f6>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1528:	98c50513          	add	a0,a0,-1652 # 5eb0 <malloc+0x196>
  ...
  exit(xstatus);
    ...
    1546:	18650513          	add	a0,a0,390 # 66c8 <malloc+0x9ae>
    ...
    1564:	1b850513          	add	a0,a0,440 # 6718 <malloc+0x9fe>
...
000000000000157a <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    158a:	8d278793          	add	a5,a5,-1838 # 5e58 <malloc+0x13e>
    158e:	fcf43023          	sd	a5,-64(s0)
    1592:	00005797          	auipc	a5,0x5
    1596:	1a678793          	add	a5,a5,422 # 6738 <malloc+0xa1e>
    159a:	fcf43423          	sd	a5,-56(s0)
    159e:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    15a2:	00005517          	auipc	a0,0x5
    15a6:	19e50513          	add	a0,a0,414 # 6740 <malloc+0xa26>
  ...
  if(pid == 0) {
    ...
    15d6:	16e50513          	add	a0,a0,366 # 6740 <malloc+0xa26>
    ...
    15f2:	17250513          	add	a0,a0,370 # 6760 <malloc+0xa46>
    ...
    1610:	0a450513          	add	a0,a0,164 # 66b0 <malloc+0x996>
    ...
    162c:	12050513          	add	a0,a0,288 # 6748 <malloc+0xa2e>
    ...
    164a:	81250513          	add	a0,a0,-2030 # 5e58 <malloc+0x13e>
  ...
  if(xstatus != 0)
    ...
    167e:	0f650513          	add	a0,a0,246 # 6770 <malloc+0xa56>
    ...
    169a:	0f250513          	add	a0,a0,242 # 6788 <malloc+0xa6e>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    16ae:	09650513          	add	a0,a0,150 # 6740 <malloc+0xa26>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16d8:	b2450513          	add	a0,a0,-1244 # 61f8 <malloc+0x4de>
    ...
    16f4:	fd850513          	add	a0,a0,-40 # 66c8 <malloc+0x9ae>
  ...
  unlink("echo-ok");
    ...
    170e:	03650513          	add	a0,a0,54 # 6740 <malloc+0xa26>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    1738:	06c50513          	add	a0,a0,108 # 67a0 <malloc+0xa86>
...
0000000000001758 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    17a0:	6f4a8a93          	add	s5,s5,1780 # be90 <buf>
    17a4:	864a                	mv	a2,s2
    17a6:	85d6                	mv	a1,s5
    ...
    17bc:	6d870713          	add	a4,a4,1752 # be90 <buf>
    ...
    1800:	fbc50513          	add	a0,a0,-68 # 67b8 <malloc+0xa9e>
    ...
    182e:	666b0b13          	add	s6,s6,1638 # be90 <buf>
    ...
    1842:	42da8a93          	add	s5,s5,1069 # 142d <truncate3+0x7d>
{
    ...
    188e:	f4650513          	add	a0,a0,-186 # 67d0 <malloc+0xab6>
    ...
    18aa:	f4250513          	add	a0,a0,-190 # 67e8 <malloc+0xace>
    ...
    18dc:	f2850513          	add	a0,a0,-216 # 6800 <malloc+0xae6>
    ...
    1928:	efc50513          	add	a0,a0,-260 # 6820 <malloc+0xb06>
...
000000000000193e <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    197e:	2905                	addw	s2,s2,1 # 3001 <iputtest+0x2f>
    ...
    199a:	d1a50513          	add	a0,a0,-742 # 66b0 <malloc+0x996>
    ...
    19b6:	e8650513          	add	a0,a0,-378 # 6838 <malloc+0xb1e>
    ...
    19d2:	e8250513          	add	a0,a0,-382 # 6850 <malloc+0xb36>
...
00000000000019f2 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a4a:	c6a50513          	add	a0,a0,-918 # 66b0 <malloc+0x996>
    ...
    1a6e:	c4650513          	add	a0,a0,-954 # 66b0 <malloc+0x996>
...
0000000000001a8c <forkfork>:
{
    ...
    1ae8:	d8c50513          	add	a0,a0,-628 # 6870 <malloc+0xb56>
    ...
    1afa:	df4080e7          	jalr	-524(ra) # 58ea <exit>
{
    ...
    1b40:	d4450513          	add	a0,a0,-700 # 6880 <malloc+0xb66>
...
0000000000001b56 <reparent2>:
{
  ...
  exit(0);
    ...
    1b8e:	f4650513          	add	a0,a0,-186 # 6ad0 <malloc+0xdb6>
...
0000000000001bbe <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1c2c:	ea850513          	add	a0,a0,-344 # 6ad0 <malloc+0xdb6>
    ...
    1c58:	af450513          	add	a0,a0,-1292 # 6748 <malloc+0xa2e>
    ...
    1cca:	bda50513          	add	a0,a0,-1062 # 68a0 <malloc+0xb86>
    ...
    1cfe:	bbe50513          	add	a0,a0,-1090 # 68b8 <malloc+0xb9e>
    ...
    1d60:	b8450513          	add	a0,a0,-1148 # 68e0 <malloc+0xbc6>
...
0000000000001de4 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1e04:	0c850513          	add	a0,a0,200 # 5ec8 <malloc+0x1ae>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1e2e:	e6da0a1b          	addw	s4,s4,-403 # 41c64e6d <__BSS_END__+0x41c55fcd>
    1e32:	698d                	lui	s3,0x3
    1e34:	0399899b          	addw	s3,s3,57 # 3039 <iputtest+0x67>
    if((x % 3) == 0){
    1e38:	4a8d                	li	s5,3
    } else if((x % 3) == 1){
    1e3a:	4b85                	li	s7,1
    ...
    1e40:	08cb0b13          	add	s6,s6,140 # 5ec8 <malloc+0x1ae>
      link("cat", "x");
    1e44:	00005c17          	auipc	s8,0x5
    1e48:	ac4c0c13          	add	s8,s8,-1340 # 6908 <malloc+0xbee>
    1e4c:	a825                	j	1e84 <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1e4e:	85a6                	mv	a1,s1
    1e50:	00005517          	auipc	a0,0x5
    1e54:	86050513          	add	a0,a0,-1952 # 66b0 <malloc+0x996>
...
0000000000001ee8 <manywrites>:
{
  ...
  exit(0);
    ...
    1f4c:	b8850513          	add	a0,a0,-1144 # 6ad0 <malloc+0xdb6>
    ...
    1f8e:	f06b0b13          	add	s6,s6,-250 # be90 <buf>
    ...
    2002:	91250513          	add	a0,a0,-1774 # 6910 <malloc+0xbf6>
    ...
    2022:	f0a50513          	add	a0,a0,-246 # 5f28 <malloc+0x20e>
...
0000000000002040 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    2070:	90450513          	add	a0,a0,-1788 # 6970 <malloc+0xc56>
    ...
    2094:	89850513          	add	a0,a0,-1896 # 6928 <malloc+0xc0e>
    ...
    20b0:	89450513          	add	a0,a0,-1900 # 6940 <malloc+0xc26>
    ...
    20cc:	89050513          	add	a0,a0,-1904 # 6958 <malloc+0xc3e>
...
0000000000002118 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2134:	35098993          	add	s3,s3,848 # c350 <buf+0x4c0>
    2138:	1003d937          	lui	s2,0x1003d
    213c:	090e                	sll	s2,s2,0x3
    213e:	48090913          	add	s2,s2,1152 # 1003d480 <__BSS_END__+0x1002e5e0>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2182:	53250513          	add	a0,a0,1330 # 66b0 <malloc+0x996>
    ...
    21a4:	7f850513          	add	a0,a0,2040 # 6998 <malloc+0xc7e>
...
00000000000021c4 <MAXVAplus>:
{
    ...
    21ca:	1800                	add	s0,sp,48
  volatile uint64 a = MAXVA;
    21cc:	4785                	li	a5,1
    21ce:	179a                	sll	a5,a5,0x26
  ...
  for( ; a != 0; a <<= 1){
    ...
    221c:	6145                	add	sp,sp,48
    221e:	8082                	ret
      printf("%s: fork failed\n", s);
    2220:	85ca                	mv	a1,s2
    2222:	00004517          	auipc	a0,0x4
    2226:	48e50513          	add	a0,a0,1166 # 66b0 <malloc+0x996>
    ...
    2252:	76a50513          	add	a0,a0,1898 # 69b8 <malloc+0xc9e>
...
{
    2272:	7179                	add	sp,sp,-48
    2274:	f406                	sd	ra,40(sp)
    2276:	f022                	sd	s0,32(sp)
    2278:	ec26                	sd	s1,24(sp)
    227a:	1800                	add	s0,sp,48
    227c:	84aa                	mv	s1,a0
  unlink("bigarg-ok");
    227e:	00004517          	auipc	a0,0x4
    2282:	75250513          	add	a0,a0,1874 # 69d0 <malloc+0xcb6>
  ...
  fd = open("bigarg-ok", 0);
    ...
    22b4:	72050513          	add	a0,a0,1824 # 69d0 <malloc+0xcb6>
  ...
  close(fd);
    ...
    233e:	78650513          	add	a0,a0,1926 # 6ac0 <malloc+0xda6>
    ...
    2362:	78250513          	add	a0,a0,1922 # 6ae0 <malloc+0xdc6>
...
r_sp()
{
    ...
    23c0:	74450513          	add	a0,a0,1860 # 6b00 <malloc+0xde6>
    ...
    23dc:	2d850513          	add	a0,a0,728 # 66b0 <malloc+0x996>
...
00000000000023fc <copyinstr3>:
{
  ...
  if(top % PGSIZE){
    242a:	03451793          	sll	a5,a0,0x34
    242e:	e3d9                	bnez	a5,24b4 <copyinstr3+0xb8>
  char *b = (char *) (top - 1);
    2430:	fff50493          	add	s1,a0,-1 # 1fff <manywrites+0x117>
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2476:	33678793          	add	a5,a5,822 # 77a8 <malloc+0x1a8e>
    247a:	fcf43823          	sd	a5,-48(s0)
    247e:	fc043c23          	sd	zero,-40(s0)
  ret = exec(b, args);
    2482:	fd040593          	add	a1,s0,-48
    2486:	8526                	mv	a0,s1
  ...
  if(ret != -1){
    ...
    249c:	6145                	add	sp,sp,48
    249e:	8082                	ret
    sbrk(PGSIZE - (top % PGSIZE));
    24a0:	0347d513          	srl	a0,a5,0x34
    ...
    24b8:	67450513          	add	a0,a0,1652 # 6b28 <malloc+0xe0e>
    ...
    24d6:	0fe50513          	add	a0,a0,254 # 65d0 <malloc+0x8b6>
    ...
    24f4:	10050513          	add	a0,a0,256 # 65f0 <malloc+0x8d6>
    ...
    2514:	10050513          	add	a0,a0,256 # 6610 <malloc+0x8f6>
    ...
    2532:	10a50513          	add	a0,a0,266 # 6638 <malloc+0x91e>
...
{
    2548:	1101                	add	sp,sp,-32
    254a:	ec06                	sd	ra,24(sp)
    254c:	e822                	sd	s0,16(sp)
    254e:	1000                	add	s0,sp,32
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    257e:	5ee50513          	add	a0,a0,1518 # 6b68 <malloc+0xe4e>
  ...
  if(n >= 0){
    ...
    25ae:	5de50513          	add	a0,a0,1502 # 6b88 <malloc+0xe6e>
    ...
    25cc:	56850513          	add	a0,a0,1384 # 6b30 <malloc+0xe16>
    ...
    25e8:	56450513          	add	a0,a0,1380 # 6b48 <malloc+0xe2e>
    ...
    2602:	57250513          	add	a0,a0,1394 # 6b70 <malloc+0xe56>
  ...
  if(n >= 0){
    ...
    2662:	55a50513          	add	a0,a0,1370 # 6bb8 <malloc+0xe9e>
    ...
    267c:	4f850513          	add	a0,a0,1272 # 6b70 <malloc+0xe56>
...
00000000000026a6 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2702:	4e250513          	add	a0,a0,1250 # 6be0 <malloc+0xec6>
  ...
  for(i = 0; i < 5000; i++){
    ...
    2754:	388a0a13          	add	s4,s4,904 # 1388 <copyinstr2+0x1ce>
    ...
    2766:	49e50513          	add	a0,a0,1182 # 6c00 <malloc+0xee6>
    ...
    *b = 1;
    ...
    a = b + 1;
    2792:	00148793          	add	a5,s1,1
  for(i = 0; i < 5000; i++){
    2796:	2905                	addw	s2,s2,1
  ...
  if(c != a + 1){
    ...
    27ec:	43850513          	add	a0,a0,1080 # 6c20 <malloc+0xf06>
    ...
    2808:	43c50513          	add	a0,a0,1084 # 6c40 <malloc+0xf26>
...
0000000000002844 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    2948:	6145                	add	sp,sp,48
    294a:	8082                	ret
    printf("%s: sbrk test failed to grow big address space; enough phys mem?\n", s);
    294c:	85ce                	mv	a1,s3
    294e:	00004517          	auipc	a0,0x4
    2952:	33250513          	add	a0,a0,818 # 6c80 <malloc+0xf66>
    ...
    296e:	35e50513          	add	a0,a0,862 # 6cc8 <malloc+0xfae>
    ...
    298e:	35e50513          	add	a0,a0,862 # 6ce8 <malloc+0xfce>
    ...
    29ae:	37e50513          	add	a0,a0,894 # 6d28 <malloc+0x100e>
    ...
    29ca:	39250513          	add	a0,a0,914 # 6d58 <malloc+0x103e>
    ...
    29ea:	3aa50513          	add	a0,a0,938 # 6d90 <malloc+0x1076>
...
0000000000002a00 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2a24:	39850513          	add	a0,a0,920 # 6db8 <malloc+0x109e>
    2a28:	00003097          	auipc	ra,0x3
    2a2c:	f02080e7          	jalr	-254(ra) # 592a <open>
    2a30:	84aa                	mv	s1,a0
  unlink("sbrk");
    2a32:	00004517          	auipc	a0,0x4
    2a36:	38650513          	add	a0,a0,902 # 6db8 <malloc+0x109e>
  ...
  if(pipe((int *) a) != 0){
    ...
    2a80:	6145                	add	sp,sp,48
    2a82:	8082                	ret
    printf("%s: open sbrk failed\n", s);
    2a84:	85ce                	mv	a1,s3
    2a86:	00004517          	auipc	a0,0x4
    2a8a:	33a50513          	add	a0,a0,826 # 6dc0 <malloc+0x10a6>
    ...
    2aa6:	33650513          	add	a0,a0,822 # 6dd8 <malloc+0x10be>
    ...
    2ac2:	cfa50513          	add	a0,a0,-774 # 67b8 <malloc+0xa9e>
...
0000000000002ad8 <argptest>:
{
  ...
  close(fd);
    ...
    2b2a:	6105                	add	sp,sp,32
    2b2c:	8082                	ret
    printf("%s: open failed\n", s);
    2b2e:	85ca                	mv	a1,s2
    2b30:	00004517          	auipc	a0,0x4
    2b34:	b9850513          	add	a0,a0,-1128 # 66c8 <malloc+0x9ae>
...
{
    2b4a:	1141                	add	sp,sp,-16
    2b4c:	e406                	sd	ra,8(sp)
    2b4e:	e022                	sd	s0,0(sp)
    2b50:	0800                	add	s0,sp,16
  int pid = fork();
  ...
  if(pid == 0){
    ...
    2b82:	f5250513          	add	a0,a0,-174 # 6ad0 <malloc+0xdb6>
  ...
  if(pid == 0){
    ...
    2bba:	dac7879b          	addw	a5,a5,-596 # dac <linktest+0x98>
    ...
    2bd8:	efc50513          	add	a0,a0,-260 # 6ad0 <malloc+0xdb6>
  ...
  if(pid == 0){
    ...
    2c10:	8007879b          	addw	a5,a5,-2048 # a800 <uninit+0x1080>
    ...
    2c38:	e9c50513          	add	a0,a0,-356 # 6ad0 <malloc+0xdb6>
...
0000000000002c62 <sbrklast>:
{
  ...
  top = (uint64) sbrk(0);
    ...
    2caa:	84aa                	mv	s1,a0
  char *p = (char *) (top - 64);
    2cac:	fc050913          	add	s2,a0,-64 # fc0 <bigdir+0x60>
  p[0] = 'x';
  ...
  if(p[0] != 'x')
    ...
    2d12:	6145                	add	sp,sp,48
    2d14:	8082                	ret
    sbrk(4096 - (top % 4096));
    2d16:	0347d513          	srl	a0,a5,0x34
...
{
    2d34:	1141                	add	sp,sp,-16
    2d36:	e406                	sd	ra,8(sp)
    2d38:	e022                	sd	s0,0(sp)
    2d3a:	0800                	add	s0,sp,16
  sbrk(0x80000004);
    2d3c:	80000537          	lui	a0,0x80000
    2d40:	0511                	add	a0,a0,4 # ffffffff80000004 <__BSS_END__+0xffffffff7fff1164>
...
execout(char *s)
{
  ...
  exit(0);
    ...
    2dac:	d2850513          	add	a0,a0,-728 # 6ad0 <malloc+0xdb6>
    ...
    2e00:	05c50513          	add	a0,a0,92 # 5e58 <malloc+0x13e>
    2e04:	faa43c23          	sd	a0,-72(s0)
    2e08:	00003797          	auipc	a5,0x3
    2e0c:	0c078793          	add	a5,a5,192 # 5ec8 <malloc+0x1ae>
    2e10:	fcf43023          	sd	a5,-64(s0)
    2e14:	fc043423          	sd	zero,-56(s0)
      exec("echo", args);
    2e18:	fb840593          	add	a1,s0,-72
...
0000000000002e2e <fourteen>:
{
    ...
    2e36:	1000                	add	s0,sp,32
    2e38:	84aa                	mv	s1,a0
  if(mkdir("12345678901234") != 0){
    2e3a:	00004517          	auipc	a0,0x4
    2e3e:	18e50513          	add	a0,a0,398 # 6fc8 <malloc+0x12ae>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2e50:	fd450513          	add	a0,a0,-44 # 6e20 <malloc+0x1106>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2e66:	01650513          	add	a0,a0,22 # 6e78 <malloc+0x115e>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2e84:	07050513          	add	a0,a0,112 # 6ef0 <malloc+0x11d6>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2ea0:	0c450513          	add	a0,a0,196 # 6f60 <malloc+0x1246>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2eb2:	10a50513          	add	a0,a0,266 # 6fb8 <malloc+0x129e>
  ...
  unlink("12345678901234");
    ...
    2f26:	6105                	add	sp,sp,32
    2f28:	8082                	ret
    printf("%s: mkdir 12345678901234 failed\n", s);
    2f2a:	85a6                	mv	a1,s1
    2f2c:	00004517          	auipc	a0,0x4
    2f30:	ecc50513          	add	a0,a0,-308 # 6df8 <malloc+0x10de>
    ...
    2f4c:	ef850513          	add	a0,a0,-264 # 6e40 <malloc+0x1126>
    ...
    2f68:	f4450513          	add	a0,a0,-188 # 6ea8 <malloc+0x118e>
    ...
    2f84:	fa050513          	add	a0,a0,-96 # 6f20 <malloc+0x1206>
    ...
    2fa0:	fe450513          	add	a0,a0,-28 # 6f80 <malloc+0x1266>
    ...
    2fbc:	02050513          	add	a0,a0,32 # 6fd8 <malloc+0x12be>
...
{
    2fd2:	1101                	add	sp,sp,-32
    2fd4:	ec06                	sd	ra,24(sp)
    2fd6:	e822                	sd	s0,16(sp)
    2fd8:	e426                	sd	s1,8(sp)
    2fda:	1000                	add	s0,sp,32
    2fdc:	84aa                	mv	s1,a0
  if(mkdir("iputdir") < 0){
    2fde:	00004517          	auipc	a0,0x4
    2fe2:	03250513          	add	a0,a0,50 # 7010 <malloc+0x12f6>
  ...
  if(chdir("iputdir") < 0){
    ...
    2ff6:	01e50513          	add	a0,a0,30 # 7010 <malloc+0x12f6>
  ...
  if(unlink("../iputdir") < 0){
    ...
    300a:	04a50513          	add	a0,a0,74 # 7050 <malloc+0x1336>
  ...
  if(chdir("/") < 0){
    ...
    301e:	06650513          	add	a0,a0,102 # 7080 <malloc+0x1366>
    ...
    3034:	6105                	add	sp,sp,32
    3036:	8082                	ret
    printf("%s: mkdir failed\n", s);
    3038:	85a6                	mv	a1,s1
    303a:	00004517          	auipc	a0,0x4
    303e:	fde50513          	add	a0,a0,-34 # 7018 <malloc+0x12fe>
    ...
    305a:	fda50513          	add	a0,a0,-38 # 7030 <malloc+0x1316>
    ...
    3076:	fee50513          	add	a0,a0,-18 # 7060 <malloc+0x1346>
    ...
    3092:	ffa50513          	add	a0,a0,-6 # 7088 <malloc+0x136e>
...
00000000000030a8 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    30c6:	f4e50513          	add	a0,a0,-178 # 7010 <malloc+0x12f6>
    ...
    30da:	f3a50513          	add	a0,a0,-198 # 7010 <malloc+0x12f6>
    ...
    30ee:	f6650513          	add	a0,a0,-154 # 7050 <malloc+0x1336>
    ...
    310e:	5a650513          	add	a0,a0,1446 # 66b0 <malloc+0x996>
    ...
    312a:	ef250513          	add	a0,a0,-270 # 7018 <malloc+0x12fe>
    ...
    3146:	f5e50513          	add	a0,a0,-162 # 70a0 <malloc+0x1386>
    ...
    3162:	f0250513          	add	a0,a0,-254 # 7060 <malloc+0x1346>
...
{
    3190:	1101                	add	sp,sp,-32
    3192:	ec06                	sd	ra,24(sp)
    3194:	e822                	sd	s0,16(sp)
    3196:	e426                	sd	s1,8(sp)
    3198:	1000                	add	s0,sp,32
    319a:	84aa                	mv	s1,a0
  if(mkdir("dir0") < 0){
    319c:	00004517          	auipc	a0,0x4
    31a0:	f1c50513          	add	a0,a0,-228 # 70b8 <malloc+0x139e>
  ...
  if(chdir("dir0") < 0){
    ...
    31b4:	f0850513          	add	a0,a0,-248 # 70b8 <malloc+0x139e>
  ...
  if(chdir("..") < 0){
    ...
    31c8:	f1450513          	add	a0,a0,-236 # 70d8 <malloc+0x13be>
  ...
  if(unlink("dir0") < 0){
    ...
    31dc:	ee050513          	add	a0,a0,-288 # 70b8 <malloc+0x139e>
    ...
    31f2:	6105                	add	sp,sp,32
    31f4:	8082                	ret
    printf("%s: mkdir failed\n", s);
    31f6:	85a6                	mv	a1,s1
    31f8:	00004517          	auipc	a0,0x4
    31fc:	e2050513          	add	a0,a0,-480 # 7018 <malloc+0x12fe>
    ...
    3218:	eac50513          	add	a0,a0,-340 # 70c0 <malloc+0x13a6>
    ...
    3234:	eb050513          	add	a0,a0,-336 # 70e0 <malloc+0x13c6>
    ...
    3250:	eac50513          	add	a0,a0,-340 # 70f8 <malloc+0x13de>
...
0000000000003266 <subdir>:
{
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    32a0:	e9450513          	add	a0,a0,-364 # 7130 <malloc+0x1416>
  ...
  write(fd, "ff", 2);
    ...
    32b8:	f8c58593          	add	a1,a1,-116 # 7240 <malloc+0x1526>
  ...
  if(unlink("dd") >= 0){
    ...
    32d2:	e4250513          	add	a0,a0,-446 # 7110 <malloc+0x13f6>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    32e6:	ea650513          	add	a0,a0,-346 # 7188 <malloc+0x146e>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    32fe:	eb650513          	add	a0,a0,-330 # 71b0 <malloc+0x1496>
  ...
  write(fd, "FF", 2);
    ...
    3316:	ece58593          	add	a1,a1,-306 # 71e0 <malloc+0x14c6>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3332:	eba50513          	add	a0,a0,-326 # 71e8 <malloc+0x14ce>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    334a:	b4a58593          	add	a1,a1,-1206 # be90 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    337a:	ec258593          	add	a1,a1,-318 # 7238 <malloc+0x151e>
    337e:	00004517          	auipc	a0,0x4
    3382:	e3250513          	add	a0,a0,-462 # 71b0 <malloc+0x1496>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3396:	e1e50513          	add	a0,a0,-482 # 71b0 <malloc+0x1496>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    33ac:	e0850513          	add	a0,a0,-504 # 71b0 <malloc+0x1496>
  ...
  if(chdir("dd") != 0){
    ...
    33c0:	d5450513          	add	a0,a0,-684 # 7110 <malloc+0x13f6>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    33d4:	f0050513          	add	a0,a0,-256 # 72d0 <malloc+0x15b6>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    33e8:	f1c50513          	add	a0,a0,-228 # 7300 <malloc+0x15e6>
  ...
  if(chdir("./..") != 0){
    ...
    33fc:	f3850513          	add	a0,a0,-200 # 7330 <malloc+0x1616>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3412:	e2a50513          	add	a0,a0,-470 # 7238 <malloc+0x151e>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    342a:	a6a58593          	add	a1,a1,-1430 # be90 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    344c:	d6850513          	add	a0,a0,-664 # 71b0 <malloc+0x1496>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3464:	f6050513          	add	a0,a0,-160 # 73c0 <malloc+0x16a6>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    347c:	f7850513          	add	a0,a0,-136 # 73f0 <malloc+0x16d6>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    3494:	c8050513          	add	a0,a0,-896 # 7110 <malloc+0x13f6>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    34aa:	c6a50513          	add	a0,a0,-918 # 7110 <malloc+0x13f6>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    34c0:	c5450513          	add	a0,a0,-940 # 7110 <malloc+0x13f6>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    34d4:	fb058593          	add	a1,a1,-80 # 7480 <malloc+0x1766>
    34d8:	00004517          	auipc	a0,0x4
    34dc:	ee850513          	add	a0,a0,-280 # 73c0 <malloc+0x16a6>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    34f0:	f9458593          	add	a1,a1,-108 # 7480 <malloc+0x1766>
    34f4:	00004517          	auipc	a0,0x4
    34f8:	efc50513          	add	a0,a0,-260 # 73f0 <malloc+0x16d6>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    350c:	d3058593          	add	a1,a1,-720 # 7238 <malloc+0x151e>
    3510:	00004517          	auipc	a0,0x4
    3514:	c2050513          	add	a0,a0,-992 # 7130 <malloc+0x1416>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    3528:	e9c50513          	add	a0,a0,-356 # 73c0 <malloc+0x16a6>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    353c:	eb850513          	add	a0,a0,-328 # 73f0 <malloc+0x16d6>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3550:	cec50513          	add	a0,a0,-788 # 7238 <malloc+0x151e>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3564:	e9050513          	add	a0,a0,-368 # 73f0 <malloc+0x16d6>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    3578:	e4c50513          	add	a0,a0,-436 # 73c0 <malloc+0x16a6>
  ...
  if(chdir("dd/ff") == 0){
    ...
    358c:	ba850513          	add	a0,a0,-1112 # 7130 <malloc+0x1416>
  ...
  if(chdir("dd/xx") == 0){
    ...
    35a0:	03450513          	add	a0,a0,52 # 75d0 <malloc+0x18b6>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    35b4:	c8850513          	add	a0,a0,-888 # 7238 <malloc+0x151e>
  ...
  if(unlink("dd/ff") != 0){
    ...
    35c8:	b6c50513          	add	a0,a0,-1172 # 7130 <malloc+0x1416>
  ...
  if(unlink("dd") == 0){
    ...
    35dc:	b3850513          	add	a0,a0,-1224 # 7110 <malloc+0x13f6>
  ...
  if(unlink("dd/dd") < 0){
    ...
    35f0:	05450513          	add	a0,a0,84 # 7640 <malloc+0x1926>
  ...
  if(unlink("dd") < 0){
    ...
    3604:	b1050513          	add	a0,a0,-1264 # 7110 <malloc+0x13f6>
    ...
    361c:	6105                	add	sp,sp,32
    361e:	8082                	ret
    printf("%s: mkdir dd failed\n", s);
    3620:	85ca                	mv	a1,s2
    3622:	00004517          	auipc	a0,0x4
    3626:	af650513          	add	a0,a0,-1290 # 7118 <malloc+0x13fe>
    ...
    3642:	afa50513          	add	a0,a0,-1286 # 7138 <malloc+0x141e>
    ...
    365e:	afe50513          	add	a0,a0,-1282 # 7158 <malloc+0x143e>
    ...
    367a:	b1a50513          	add	a0,a0,-1254 # 7190 <malloc+0x1476>
    ...
    3696:	b2e50513          	add	a0,a0,-1234 # 71c0 <malloc+0x14a6>
    ...
    36b2:	b4a50513          	add	a0,a0,-1206 # 71f8 <malloc+0x14de>
    ...
    36ce:	b4e50513          	add	a0,a0,-1202 # 7218 <malloc+0x14fe>
    ...
    36ea:	b6250513          	add	a0,a0,-1182 # 7248 <malloc+0x152e>
    ...
    3706:	b6e50513          	add	a0,a0,-1170 # 7270 <malloc+0x1556>
    ...
    3722:	b7250513          	add	a0,a0,-1166 # 7290 <malloc+0x1576>
    ...
    373e:	b7e50513          	add	a0,a0,-1154 # 72b8 <malloc+0x159e>
    ...
    375a:	b8a50513          	add	a0,a0,-1142 # 72e0 <malloc+0x15c6>
    ...
    3776:	b9e50513          	add	a0,a0,-1122 # 7310 <malloc+0x15f6>
    ...
    3792:	baa50513          	add	a0,a0,-1110 # 7338 <malloc+0x161e>
    ...
    37ae:	ba650513          	add	a0,a0,-1114 # 7350 <malloc+0x1636>
    ...
    37ca:	baa50513          	add	a0,a0,-1110 # 7370 <malloc+0x1656>
    ...
    37e6:	bae50513          	add	a0,a0,-1106 # 7390 <malloc+0x1676>
    ...
    3802:	bd250513          	add	a0,a0,-1070 # 73d0 <malloc+0x16b6>
    ...
    381e:	be650513          	add	a0,a0,-1050 # 7400 <malloc+0x16e6>
    ...
    383a:	bea50513          	add	a0,a0,-1046 # 7420 <malloc+0x1706>
    ...
    3856:	bee50513          	add	a0,a0,-1042 # 7440 <malloc+0x1726>
    ...
    3872:	bf250513          	add	a0,a0,-1038 # 7460 <malloc+0x1746>
    ...
    388e:	c0650513          	add	a0,a0,-1018 # 7490 <malloc+0x1776>
    ...
    38aa:	c1250513          	add	a0,a0,-1006 # 74b8 <malloc+0x179e>
    ...
    38c6:	c1e50513          	add	a0,a0,-994 # 74e0 <malloc+0x17c6>
    ...
    38e2:	c2a50513          	add	a0,a0,-982 # 7508 <malloc+0x17ee>
    ...
    38fe:	c2e50513          	add	a0,a0,-978 # 7528 <malloc+0x180e>
    ...
    391a:	c3250513          	add	a0,a0,-974 # 7548 <malloc+0x182e>
    ...
    3936:	c3e50513          	add	a0,a0,-962 # 7570 <malloc+0x1856>
    ...
    3952:	c4250513          	add	a0,a0,-958 # 7590 <malloc+0x1876>
    ...
    396e:	c4650513          	add	a0,a0,-954 # 75b0 <malloc+0x1896>
    ...
    398a:	c5250513          	add	a0,a0,-942 # 75d8 <malloc+0x18be>
    ...
    39a6:	8ce50513          	add	a0,a0,-1842 # 7270 <malloc+0x1556>
    ...
    39c2:	c3a50513          	add	a0,a0,-966 # 75f8 <malloc+0x18de>
    ...
    39de:	c3e50513          	add	a0,a0,-962 # 7618 <malloc+0x18fe>
    ...
    39fa:	c5250513          	add	a0,a0,-942 # 7648 <malloc+0x192e>
    ...
    3a16:	c5650513          	add	a0,a0,-938 # 7668 <malloc+0x194e>
...
{
    3a2c:	1101                	add	sp,sp,-32
    3a2e:	ec06                	sd	ra,24(sp)
    3a30:	e822                	sd	s0,16(sp)
    3a32:	e426                	sd	s1,8(sp)
    3a34:	1000                	add	s0,sp,32
    3a36:	84aa                	mv	s1,a0
  if(mkdir("dots") != 0){
    3a38:	00004517          	auipc	a0,0x4
    3a3c:	c4850513          	add	a0,a0,-952 # 7680 <malloc+0x1966>
  ...
  if(chdir("dots") != 0){
    ...
    3a4e:	c3650513          	add	a0,a0,-970 # 7680 <malloc+0x1966>
  ...
  if(unlink(".") == 0){
    ...
    3a60:	ab450513          	add	a0,a0,-1356 # 6510 <malloc+0x7f6>
  ...
  if(unlink("..") == 0){
    ...
    3a72:	66a50513          	add	a0,a0,1642 # 70d8 <malloc+0x13be>
  ...
  if(chdir("/") != 0){
    ...
    3a84:	60050513          	add	a0,a0,1536 # 7080 <malloc+0x1366>
  ...
  if(unlink("dots/.") == 0){
    ...
    3a96:	c5650513          	add	a0,a0,-938 # 76e8 <malloc+0x19ce>
  ...
  if(unlink("dots/..") == 0){
    ...
    3aa8:	c6c50513          	add	a0,a0,-916 # 7710 <malloc+0x19f6>
  ...
  if(unlink("dots") != 0){
    ...
    3aba:	bca50513          	add	a0,a0,-1078 # 7680 <malloc+0x1966>
    ...
    3ace:	6105                	add	sp,sp,32
    3ad0:	8082                	ret
    printf("%s: mkdir dots failed\n", s);
    3ad2:	85a6                	mv	a1,s1
    3ad4:	00004517          	auipc	a0,0x4
    3ad8:	bb450513          	add	a0,a0,-1100 # 7688 <malloc+0x196e>
    ...
    3af4:	bb050513          	add	a0,a0,-1104 # 76a0 <malloc+0x1986>
    ...
    3b10:	bac50513          	add	a0,a0,-1108 # 76b8 <malloc+0x199e>
    ...
    3b2c:	ba850513          	add	a0,a0,-1112 # 76d0 <malloc+0x19b6>
    ...
    3b48:	54450513          	add	a0,a0,1348 # 7088 <malloc+0x136e>
    ...
    3b64:	b9050513          	add	a0,a0,-1136 # 76f0 <malloc+0x19d6>
    ...
    3b80:	b9c50513          	add	a0,a0,-1124 # 7718 <malloc+0x19fe>
    ...
    3b9c:	ba050513          	add	a0,a0,-1120 # 7738 <malloc+0x1a1e>
...
0000000000003bb2 <dirfile>:
{
  ...
  if(chdir("dirfile") == 0){
    ...
    3be4:	b7850513          	add	a0,a0,-1160 # 7758 <malloc+0x1a3e>
  ...
  fd = open("dirfile/xx", 0);
    ...
    3bf8:	bac50513          	add	a0,a0,-1108 # 77a0 <malloc+0x1a86>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3c10:	b9450513          	add	a0,a0,-1132 # 77a0 <malloc+0x1a86>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3c24:	b8050513          	add	a0,a0,-1152 # 77a0 <malloc+0x1a86>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3c38:	b6c50513          	add	a0,a0,-1172 # 77a0 <malloc+0x1a86>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3c4c:	b5858593          	add	a1,a1,-1192 # 77a0 <malloc+0x1a86>
    3c50:	00002517          	auipc	a0,0x2
    3c54:	3b050513          	add	a0,a0,944 # 6000 <malloc+0x2e6>
  ...
  if(unlink("dirfile") != 0){
    ...
    3c68:	af450513          	add	a0,a0,-1292 # 7758 <malloc+0x1a3e>
  ...
  fd = open(".", O_RDWR);
    ...
    3c7e:	89650513          	add	a0,a0,-1898 # 6510 <malloc+0x7f6>
  ...
  fd = open(".", 0);
    ...
    3c94:	88050513          	add	a0,a0,-1920 # 6510 <malloc+0x7f6>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3ca8:	22458593          	add	a1,a1,548 # 5ec8 <malloc+0x1ae>
  ...
  close(fd);
    ...
    3cca:	6105                	add	sp,sp,32
    3ccc:	8082                	ret
    printf("%s: create dirfile failed\n", s);
    3cce:	85ca                	mv	a1,s2
    3cd0:	00004517          	auipc	a0,0x4
    3cd4:	a9050513          	add	a0,a0,-1392 # 7760 <malloc+0x1a46>
    ...
    3cf0:	a9450513          	add	a0,a0,-1388 # 7780 <malloc+0x1a66>
    ...
    3d0c:	aa850513          	add	a0,a0,-1368 # 77b0 <malloc+0x1a96>
    ...
    3d28:	a8c50513          	add	a0,a0,-1396 # 77b0 <malloc+0x1a96>
    ...
    3d44:	a9850513          	add	a0,a0,-1384 # 77d8 <malloc+0x1abe>
    ...
    3d60:	aa450513          	add	a0,a0,-1372 # 7800 <malloc+0x1ae6>
    ...
    3d7c:	ab050513          	add	a0,a0,-1360 # 7828 <malloc+0x1b0e>
    ...
    3d98:	abc50513          	add	a0,a0,-1348 # 7850 <malloc+0x1b36>
    ...
    3db4:	ac050513          	add	a0,a0,-1344 # 7870 <malloc+0x1b56>
    ...
    3dd0:	acc50513          	add	a0,a0,-1332 # 7898 <malloc+0x1b7e>
...
0000000000003de6 <iref>:
{
    ...
    3df8:	0080                	add	s0,sp,64
    3dfa:	8b2a                	mv	s6,a0
    3dfc:	03300913          	li	s2,51
    if(mkdir("irefd") != 0){
    3e00:	00004a17          	auipc	s4,0x4
    3e04:	ab0a0a13          	add	s4,s4,-1360 # 78b0 <malloc+0x1b96>
    mkdir("");
    3e08:	00003497          	auipc	s1,0x3
    3e0c:	5b048493          	add	s1,s1,1456 # 73b8 <malloc+0x169e>
    link("README", "");
    3e10:	00002a97          	auipc	s5,0x2
    3e14:	1f0a8a93          	add	s5,s5,496 # 6000 <malloc+0x2e6>
    fd = open("xx", O_CREATE);
    3e18:	00004997          	auipc	s3,0x4
    3e1c:	99098993          	add	s3,s3,-1648 # 77a8 <malloc+0x1a8e>
    3e20:	a891                	j	3e74 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    3e22:	85da                	mv	a1,s6
    3e24:	00004517          	auipc	a0,0x4
    3e28:	a9450513          	add	a0,a0,-1388 # 78b8 <malloc+0x1b9e>
    ...
    3e44:	a9050513          	add	a0,a0,-1392 # 78d0 <malloc+0x1bb6>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3ed8:	20498993          	add	s3,s3,516 # 70d8 <malloc+0x13be>
    unlink("irefd");
    3edc:	00004917          	auipc	s2,0x4
    3ee0:	9d490913          	add	s2,s2,-1580 # 78b0 <malloc+0x1b96>
    chdir("..");
    3ee4:	854e                	mv	a0,s3
  ...
  for(i = 0; i < NINODE + 1; i++){
    3ef8:	34fd                	addw	s1,s1,-1
    3efa:	f4ed                	bnez	s1,3ee4 <iref+0xfe>
  chdir("/");
    3efc:	00003517          	auipc	a0,0x3
    3f00:	18450513          	add	a0,a0,388 # 7080 <malloc+0x1366>
...
0000000000003f20 <openiputtest>:
{
  ...
  if(pid == 0){
    ...
    3f54:	99850513          	add	a0,a0,-1640 # 78e8 <malloc+0x1bce>
    ...
    3f6a:	9a250513          	add	a0,a0,-1630 # 7908 <malloc+0x1bee>
    ...
    3f86:	96e50513          	add	a0,a0,-1682 # 78f0 <malloc+0x1bd6>
    ...
    3fa2:	71250513          	add	a0,a0,1810 # 66b0 <malloc+0x996>
  ...
  if(unlink("oidir") != 0){
    ...
    3fd0:	91c50513          	add	a0,a0,-1764 # 78e8 <malloc+0x1bce>
    ...
    3fe4:	8c050513          	add	a0,a0,-1856 # 68a0 <malloc+0xb86>
...
{
    4012:	1101                	add	sp,sp,-32
    4014:	ec06                	sd	ra,24(sp)
    4016:	e822                	sd	s0,16(sp)
    4018:	e426                	sd	s1,8(sp)
    401a:	1000                	add	s0,sp,32
    401c:	84aa                	mv	s1,a0
  unlink("stopforking");
    401e:	00004517          	auipc	a0,0x4
    4022:	91250513          	add	a0,a0,-1774 # 7930 <malloc+0x1c16>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    404e:	8e650513          	add	a0,a0,-1818 # 7930 <malloc+0x1c16>
  ...
  sleep(10); // one second
    ...
    407c:	6105                	add	sp,sp,32
    407e:	8082                	ret
    printf("%s: fork failed", s);
    4080:	85a6                	mv	a1,s1
    4082:	00002517          	auipc	a0,0x2
    4086:	7ee50513          	add	a0,a0,2030 # 6870 <malloc+0xb56>
    ...
    40a0:	89448493          	add	s1,s1,-1900 # 7930 <malloc+0x1c16>
    40a4:	4581                	li	a1,0
    40a6:	8526                	mv	a0,s1
    ...
    40c8:	86c50513          	add	a0,a0,-1940 # 7930 <malloc+0x1c16>
...
00000000000040e8 <killstatus>:
{
  ...
  exit(0);
    ...
    414e:	56650513          	add	a0,a0,1382 # 66b0 <malloc+0x996>
    ...
    4174:	7d050513          	add	a0,a0,2000 # 7940 <malloc+0x1c26>
...
000000000000418a <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    41b4:	6c050513          	add	a0,a0,1728 # 6870 <malloc+0xb56>
  ...
  if(pid2 == 0)
    ...
    41e2:	4d250513          	add	a0,a0,1234 # 66b0 <malloc+0x996>
  ...
  if(pid3 == 0){
    ...
    4226:	ca658593          	add	a1,a1,-858 # 5ec8 <malloc+0x1ae>
    ...
    4250:	46450513          	add	a0,a0,1124 # 66b0 <malloc+0x996>
    ...
    426c:	6f850513          	add	a0,a0,1784 # 7960 <malloc+0x1c46>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    428c:	c0858593          	add	a1,a1,-1016 # be90 <buf>
    ...
    42a8:	6d450513          	add	a0,a0,1748 # 7978 <malloc+0x1c5e>
  ...
  printf("kill... ");
    ...
    42d4:	6c050513          	add	a0,a0,1728 # 7990 <malloc+0x1c76>
  ...
  printf("wait... ");
    ...
    4302:	6a250513          	add	a0,a0,1698 # 79a0 <malloc+0x1c86>
...
000000000000432e <reparent>:
{
  ...
  exit(0);
    ...
    4382:	33250513          	add	a0,a0,818 # 66b0 <malloc+0x996>
    ...
    439e:	49e50513          	add	a0,a0,1182 # 6838 <malloc+0xb1e>
...
00000000000043de <sbrkfail>:
{
    ...
    43ee:	0100                	add	s0,sp,128
    43f0:	8aaa                	mv	s5,a0
  if(pipe(fds) != 0){
    43f2:	fb040513          	add	a0,s0,-80
    43f6:	00001097          	auipc	ra,0x1
    43fa:	504080e7          	jalr	1284(ra) # 58fa <pipe>
    43fe:	e901                	bnez	a0,440e <sbrkfail+0x30>
    4400:	f8040493          	add	s1,s0,-128
    4404:	fa840993          	add	s3,s0,-88
    4408:	8926                	mv	s2,s1
    if(pids[i] != -1)
    440a:	5a7d                	li	s4,-1
    ...
    4414:	3a850513          	add	a0,a0,936 # 67b8 <malloc+0xa9e>
    ...
    4448:	a8458593          	add	a1,a1,-1404 # 5ec8 <malloc+0x1ae>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    4502:	6109                	add	sp,sp,128
    4504:	8082                	ret
    printf("%s: failed sbrk leaked memory\n", s);
    4506:	85d6                	mv	a1,s5
    4508:	00003517          	auipc	a0,0x3
    450c:	4a850513          	add	a0,a0,1192 # 79b0 <malloc+0x1c96>
    ...
    4528:	18c50513          	add	a0,a0,396 # 66b0 <malloc+0x996>
    ...
    4574:	46050513          	add	a0,a0,1120 # 79d0 <malloc+0x1cb6>
...
0000000000004594 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    45b0:	71190913          	add	s2,s2,1809 # 2711 <sbrkbasic+0x6b>
  if((pid = fork()) == 0){
    45b4:	c115                	beqz	a0,45d8 <mem+0x44>
    wait(&xstatus);
    45b6:	fcc40513          	add	a0,s0,-52
    ...
    4618:	3ec50513          	add	a0,a0,1004 # 7a00 <malloc+0x1ce6>
...
0000000000004638 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    46da:	35a50513          	add	a0,a0,858 # 7a30 <malloc+0x1d16>
    ...
    46f6:	36650513          	add	a0,a0,870 # 7a58 <malloc+0x1d3e>
  ...
  fd = open("sharedfd", 0);
    ...
    473a:	2ea50513          	add	a0,a0,746 # 7a20 <malloc+0x1d06>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    478c:	162080e7          	jalr	354(ra) # 58ea <exit>
        nc++;
    4790:	2985                	addw	s3,s3,1
    for(i = 0; i < sizeof(buf); i++){
    4792:	0785                	add	a5,a5,1
...
00000000000047fc <fourfiles>:
{
    ...
    4818:	1100                	add	s0,sp,160
    481a:	8caa                	mv	s9,a0
  char *names[] = { "f0", "f1", "f2", "f3" };
    481c:	00003797          	auipc	a5,0x3
    4820:	29c78793          	add	a5,a5,668 # 7ab8 <malloc+0x1d9e>
    4824:	f6f43823          	sd	a5,-144(s0)
    4828:	00003797          	auipc	a5,0x3
    482c:	29878793          	add	a5,a5,664 # 7ac0 <malloc+0x1da6>
    4830:	f6f43c23          	sd	a5,-136(s0)
    4834:	00003797          	auipc	a5,0x3
    4838:	29478793          	add	a5,a5,660 # 7ac8 <malloc+0x1dae>
    483c:	f8f43023          	sd	a5,-128(s0)
    4840:	00003797          	auipc	a5,0x3
    4844:	29078793          	add	a5,a5,656 # 7ad0 <malloc+0x1db6>
    4848:	f8f43423          	sd	a5,-120(s0)
  for(pi = 0; pi < NCHILD; pi++){
    484c:	f7040b93          	add	s7,s0,-144
  char *names[] = { "f0", "f1", "f2", "f3" };
    4850:	895e                	mv	s2,s7
  for(pi = 0; pi < NCHILD; pi++){
    4852:	4481                	li	s1,0
  ...
  for(pi = 0; pi < NCHILD; pi++){
    4872:	2485                	addw	s1,s1,1
    4874:	0921                	add	s2,s2,8
    4876:	ff4490e3          	bne	s1,s4,4856 <fourfiles+0x5a>
    487a:	4491                	li	s1,4
    wait(&xstatus);
    487c:	f6c40513          	add	a0,s0,-148
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    48b2:	22250513          	add	a0,a0,546 # 6ad0 <malloc+0xdb6>
    ...
    492c:	1b050513          	add	a0,a0,432 # 7ad8 <malloc+0x1dbe>
    ...
    4946:	1a650513          	add	a0,a0,422 # 7ae8 <malloc+0x1dce>
    ...
    496c:	19850513          	add	a0,a0,408 # 7b00 <malloc+0x1de6>
  ...
  for(i = 0; i < NCHILD; i++){
    49cc:	0ba1                	add	s7,s7,8
    49ce:	2b05                	addw	s6,s6,1
    ...
    49f4:	12050513          	add	a0,a0,288 # 7b10 <malloc+0x1df6>
    ...
    4a24:	610d                	add	sp,sp,160
    4a26:	8082                	ret

0000000000004a28 <concreate>:
{
    4a28:	7135                	add	sp,sp,-160
  ...
  for(i = 0; i < N; i++){
    ...
    4a56:	0d6b8b93          	add	s7,s7,214 # 7b28 <malloc+0x1e0e>
  for(i = 0; i < N; i++){
    4a5a:	02800a13          	li	s4,40
    4a5e:	acc9                	j	4d30 <concreate+0x308>
      link("C0", file);
    4a60:	fa840593          	add	a1,s0,-88
    4a64:	855e                	mv	a0,s7
    ...
    4aaa:	e44080e7          	jalr	-444(ra) # 58ea <exit>
      link("C0", file);
    4aae:	fa840593          	add	a1,s0,-88
    4ab2:	00003517          	auipc	a0,0x3
    4ab6:	07650513          	add	a0,a0,118 # 7b28 <malloc+0x1e0e>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4b7c:	f7240613          	add	a2,s0,-142
    4b80:	85ce                	mv	a1,s3
    4b82:	00003517          	auipc	a0,0x3
    4b86:	fee50513          	add	a0,a0,-18 # 7b70 <malloc+0x1e56>
  ...
  for(i = 0; i < N; i++){
    ...
    4bbe:	fde50513          	add	a0,a0,-34 # 7b98 <malloc+0x1e7e>
    ...
    4bda:	ada50513          	add	a0,a0,-1318 # 66b0 <malloc+0x996>
  ...
  for(i = 0; i < N; i++){
    4c82:	2485                	addw	s1,s1,1
    4c84:	0f448563          	beq	s1,s4,4d6e <concreate+0x346>
    file[1] = '0' + i;
    4c88:	0304879b          	addw	a5,s1,48
  ...
  for(i = 0; i < N; i++){
    4d2a:	2905                	addw	s2,s2,1
    4d2c:	db4905e3          	beq	s2,s4,4ad6 <concreate+0xae>
    file[1] = '0' + i;
    4d30:	0309079b          	addw	a5,s2,48
    4d34:	faf404a3          	sb	a5,-87(s0)
    unlink(file);
    4d38:	fa840513          	add	a0,s0,-88
    ...
    4d80:	610d                	add	sp,sp,160
    4d82:	8082                	ret

0000000000004d84 <bigfile>:
{
    4d84:	7139                	add	sp,sp,-64
  ...
  for(i = 0; i < N; i++){
    ...
    4dc4:	0d090913          	add	s2,s2,208 # be90 <buf>
  for(i = 0; i < N; i++){
    4dc8:	4a51                	li	s4,20
  if(fd < 0){
  ...
  fd = open("bigfile.dat", 0);
    ...
    4e0c:	dc850513          	add	a0,a0,-568 # 7bd0 <malloc+0x1eb6>
  ...
  for(i = 0; ; i++){
    ...
    4e22:	07290913          	add	s2,s2,114 # be90 <buf>
  if(fd < 0){
    ...
    4e48:	01f4d79b          	srlw	a5,s1,0x1f
    4e4c:	9fa5                	addw	a5,a5,s1
    4e4e:	4017d79b          	sraw	a5,a5,0x1
    ...
    total += cc;
    4e62:	12c9899b          	addw	s3,s3,300
  for(i = 0; ; i++){
    4e66:	2485                	addw	s1,s1,1
    cc = read(fd, buf, SZ/2);
    4e68:	b7c9                	j	4e2a <bigfile+0xa6>
    printf("%s: cannot create bigfile", s);
    4e6a:	85d6                	mv	a1,s5
    4e6c:	00003517          	auipc	a0,0x3
    4e70:	d7450513          	add	a0,a0,-652 # 7be0 <malloc+0x1ec6>
    ...
    4e8c:	d7850513          	add	a0,a0,-648 # 7c00 <malloc+0x1ee6>
    ...
    4ea8:	d7c50513          	add	a0,a0,-644 # 7c20 <malloc+0x1f06>
    ...
    4ec4:	d8050513          	add	a0,a0,-640 # 7c40 <malloc+0x1f26>
    ...
    4ee0:	d8450513          	add	a0,a0,-636 # 7c60 <malloc+0x1f46>
    ...
    4efc:	d8050513          	add	a0,a0,-640 # 7c78 <malloc+0x1f5e>
  ...
  if(total != N*SZ){
    ...
    4f1e:	ee078793          	add	a5,a5,-288 # 2ee0 <fourteen+0xb2>
    4f22:	02f99363          	bne	s3,a5,4f48 <bigfile+0x1c4>
  unlink("bigfile.dat");
    4f26:	00003517          	auipc	a0,0x3
    4f2a:	caa50513          	add	a0,a0,-854 # 7bd0 <malloc+0x1eb6>
    ...
    4f44:	6121                	add	sp,sp,64
    4f46:	8082                	ret
    printf("%s: read bigfile wrong total\n", s);
    4f48:	85d6                	mv	a1,s5
    4f4a:	00003517          	auipc	a0,0x3
    4f4e:	d4e50513          	add	a0,a0,-690 # 7c98 <malloc+0x1f7e>
...
0000000000004f64 <fsfull>:
{
    ...
    4f7e:	1100                	add	s0,sp,160
  printf("fsfull test\n");
    4f80:	00003517          	auipc	a0,0x3
    4f84:	d3850513          	add	a0,a0,-712 # 7cb8 <malloc+0x1f9e>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    500c:	f6040593          	add	a1,s0,-160
    5010:	00003517          	auipc	a0,0x3
    5014:	cc850513          	add	a0,a0,-824 # 7cd8 <malloc+0x1fbe>
  ...
  printf("fsfull test finished\n");
    ...
    50ae:	610d                	add	sp,sp,160
    50b0:	8082                	ret
    int total = 0;
    50b2:	4981                	li	s3,0
      int cc = write(fd, buf, BSIZE);
    50b4:	00007a97          	auipc	s5,0x7
    50b8:	ddca8a93          	add	s5,s5,-548 # be90 <buf>
      if(cc < BSIZE)
    ...
    50e0:	c0c50513          	add	a0,a0,-1012 # 7ce8 <malloc+0x1fce>
...
00000000000050fe <badwrite>:
{
  ...
  if(write(fd, "x", 1) != 1){
    ...
    518a:	d4258593          	add	a1,a1,-702 # 5ec8 <malloc+0x1ae>
    ...
    51a0:	b9450513          	add	a0,a0,-1132 # 7d30 <malloc+0x2016>
    ...
    51ba:	b6250513          	add	a0,a0,-1182 # 7d18 <malloc+0x1ffe>
    ...
    51d4:	b4850513          	add	a0,a0,-1208 # 7d18 <malloc+0x1ffe>
  ...
  unlink("junk");
    ...
    51f8:	b1c50513          	add	a0,a0,-1252 # 7d10 <malloc+0x1ff6>
...
countfree()
{
    520e:	7139                	add	sp,sp,-64
    5210:	fc06                	sd	ra,56(sp)
    5212:	f822                	sd	s0,48(sp)
    5214:	0080                	add	s0,sp,64
  int fds[2];

  if(pipe(fds) < 0){
    5216:	fc840513          	add	a0,s0,-56
  ...
  if(pid == 0){
    ...
    524e:	c7e98993          	add	s3,s3,-898 # 5ec8 <malloc+0x1ae>
      uint64 a = (uint64) sbrk(4096);
    ...
    5280:	b0450513          	add	a0,a0,-1276 # 7d80 <malloc+0x2066>
    ...
    52a0:	aa450513          	add	a0,a0,-1372 # 7d40 <malloc+0x2026>
    ...
    52c0:	aa450513          	add	a0,a0,-1372 # 7d60 <malloc+0x2046>
  ...
  while(1){
    ...
    5314:	a9050513          	add	a0,a0,-1392 # 7da0 <malloc+0x2086>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5360:	a6450513          	add	a0,a0,-1436 # 7dc0 <malloc+0x20a6>
  ...
  if(pid == 0) {
    ...
    5390:	a5c50513          	add	a0,a0,-1444 # 7de8 <malloc+0x20ce>
    ...
    53ac:	6145                	add	sp,sp,48
    53ae:	8082                	ret
    printf("runtest: fork error\n");
    53b0:	00003517          	auipc	a0,0x3
    53b4:	a2050513          	add	a0,a0,-1504 # 7dd0 <malloc+0x20b6>
    ...
    53dc:	a1850513          	add	a0,a0,-1512 # 7df0 <malloc+0x20d6>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    5426:	dee78793          	add	a5,a5,-530 # 8210 <malloc+0x24f6>
    542a:	bd040713          	add	a4,s0,-1072
    542e:	00003317          	auipc	t1,0x3
    5432:	1d230313          	add	t1,t1,466 # 8600 <malloc+0x28e6>
    ...
    5456:	03078793          	add	a5,a5,48
    545a:	03070713          	add	a4,a4,48
  ...
  printf("usertests starting\n");
    ...
    5466:	a4e50513          	add	a0,a0,-1458 # 7eb0 <malloc+0x2196>
  ...
  if(fail){
    ...
    54a0:	9cc50513          	add	a0,a0,-1588 # 7e68 <malloc+0x214e>
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    54d0:	92c58593          	add	a1,a1,-1748 # 7df8 <malloc+0x20de>
    ...
    54e6:	d2e78793          	add	a5,a5,-722 # 8210 <malloc+0x24f6>
    54ea:	bd040713          	add	a4,s0,-1072
    54ee:	00003317          	auipc	t1,0x3
    54f2:	11230313          	add	t1,t1,274 # 8600 <malloc+0x28e6>
    ...
    5584:	88850513          	add	a0,a0,-1912 # 7e08 <malloc+0x20ee>
  ...
  if(fail){
    ...
    55f6:	85e50513          	add	a0,a0,-1954 # 7e50 <malloc+0x2136>
    ...
    5610:	88c50513          	add	a0,a0,-1908 # 7e98 <malloc+0x217e>
...
{
    5668:	1141                	add	sp,sp,-16
    566a:	e422                	sd	s0,8(sp)
    566c:	0800                	add	s0,sp,16
  char *os;

  os = s;
  while((*s++ = *t++) != 0)
    566e:	87aa                	mv	a5,a0
    5670:	0585                	add	a1,a1,1
    5672:	0785                	add	a5,a5,1
...
{
    5684:	1141                	add	sp,sp,-16
    5686:	e422                	sd	s0,8(sp)
    5688:	0800                	add	s0,sp,16
  while(*p && *p == *q)
    ...
    p++, q++;
    5698:	0505                	add	a0,a0,1
    569a:	0585                	add	a1,a1,1
  while(*p && *p == *q)
...
{
    56fc:	1141                	add	sp,sp,-16
    56fe:	e422                	sd	s0,8(sp)
    5700:	0800                	add	s0,sp,16
  for(; *s; s++)
...
gets(char *buf, int max)
{
  ...
  for(i=0; i+1 < max; ){
    5742:	89a6                	mv	s3,s1
    5744:	2485                	addw	s1,s1,1
    5746:	0344d863          	bge	s1,s4,5776 <gets+0x56>
    cc = read(0, &c, 1);
    574a:	4605                	li	a2,1
    574c:	faf40593          	add	a1,s0,-81
    5750:	4501                	li	a0,0
...
atoi(const char *s)
{
    57da:	1141                	add	sp,sp,-16
    57dc:	e422                	sd	s0,8(sp)
    57de:	0800                	add	s0,sp,16
  int n;

  n = 0;
  while('0' <= *s && *s <= '9')
    57e0:	00054683          	lbu	a3,0(a0)
    57e4:	fd06879b          	addw	a5,a3,-48
...
{
    5822:	1141                	add	sp,sp,-16
    5824:	e422                	sd	s0,8(sp)
    5826:	0800                	add	s0,sp,16
  char *dst;
  const char *src;
  ...
  if (src > dst) {
    ...
    5830:	1602                	sll	a2,a2,0x20
    5832:	9201                	srl	a2,a2,0x20
    5834:	00c507b3          	add	a5,a0,a2
  dst = vdst;
    5838:	872a                	mv	a4,a0
      *dst++ = *src++;
    583a:	0585                	add	a1,a1,1
    583c:	0705                	add	a4,a4,1
  ...
  return vdst;
    ...
    585a:	fff6079b          	addw	a5,a2,-1 # 2fff <iputtest+0x2d>
    585e:	1782                	sll	a5,a5,0x20
    5860:	9381                	srl	a5,a5,0x20
    5862:	fff7c793          	not	a5,a5
    5866:	97ba                	add	a5,a5,a4
      *--dst = *--src;
    5868:	15fd                	add	a1,a1,-1
    586a:	177d                	add	a4,a4,-1
...
{
    587a:	1141                	add	sp,sp,-16
    587c:	e422                	sd	s0,8(sp)
    587e:	0800                	add	s0,sp,16
  const char *p1 = s1, *p2 = s2;
  while (n-- > 0) {
    5880:	ca05                	beqz	a2,58b0 <memcmp+0x36>
    5882:	fff6069b          	addw	a3,a2,-1
    5886:	1682                	sll	a3,a3,0x20
    5888:	9281                	srl	a3,a3,0x20
    588a:	0685                	add	a3,a3,1
    ...
    p1++;
    589a:	0505                	add	a0,a0,1
    p2++;
    589c:	0585                	add	a1,a1,1
  while (n-- > 0) {
...
{
    58b4:	1141                	add	sp,sp,-16
    58b6:	e406                	sd	ra,8(sp)
    58b8:	e022                	sd	s0,0(sp)
    58ba:	0800                	add	s0,sp,16
...
ugetpid(void)
{
    58cc:	1141                	add	sp,sp,-16
    58ce:	e422                	sd	s0,8(sp)
    58d0:	0800                	add	s0,sp,16
  struct usyscall *u = (struct usyscall *)USYSCALL;
  return u->pid;
    58d2:	040007b7          	lui	a5,0x4000
    58d6:	17f5                	add	a5,a5,-3 # 3fffffd <__BSS_END__+0x3ff115d>
    58d8:	07b2                	sll	a5,a5,0xc
}
    58da:	4388                	lw	a0,0(a5)
    58dc:	6422                	ld	s0,8(sp)
    58de:	0141                	add	sp,sp,16
    58e0:	8082                	ret
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    59de:	c7e50513          	add	a0,a0,-898 # 8658 <digits>
    59e2:	883a                	mv	a6,a4
    59e4:	2705                	addw	a4,a4,1
    59e6:	02c5f7bb          	remuw	a5,a1,a2
    59ea:	1782                	sll	a5,a5,0x20
    59ec:	9381                	srl	a5,a5,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  putc(fd, 'x');
    ...
    5b70:	aecb8b93          	add	s7,s7,-1300 # 8658 <digits>
    5b74:	03c9d793          	srl	a5,s3,0x3c
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5b88:	0992                	sll	s3,s3,0x4
    5b8a:	397d                	addw	s2,s2,-1
    ...
    5bc6:	62690913          	add	s2,s2,1574 # 81e8 <malloc+0x24ce>
        while(*s != 0){
    5bca:	02800593          	li	a1,40
    5bce:	bff1                	j	5baa <vprintf+0x142>
        putc(fd, va_arg(ap, uint));
    5bd0:	008b8913          	add	s2,s7,8
...
{
    5c34:	715d                	add	sp,sp,-80
    5c36:	ec06                	sd	ra,24(sp)
    5c38:	e822                	sd	s0,16(sp)
    5c3a:	1000                	add	s0,sp,32
...
{
    5c62:	711d                	add	sp,sp,-96
    5c64:	ec06                	sd	ra,24(sp)
    5c66:	e822                	sd	s0,16(sp)
    5c68:	1000                	add	s0,sp,32
...
free(void *ap)
{
    5c98:	1141                	add	sp,sp,-16
    5c9a:	e422                	sd	s0,8(sp)
    5c9c:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5c9e:	ff050693          	add	a3,a0,-16
    ...
    5cce:	00e6ea63          	bltu	a3,a4,5ce2 <free+0x4a>
{
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    5ce8:	02059813          	sll	a6,a1,0x20
    5cec:	01c85713          	srl	a4,a6,0x1c
  ...
  if(p + p->s.size == bp){
    ...
    5cfc:	02061593          	sll	a1,a2,0x20
    5d00:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
    5d1a:	7139                	add	sp,sp,-64
    5d1c:	fc06                	sd	ra,56(sp)
    5d1e:	f822                	sd	s0,48(sp)
    5d20:	f426                	sd	s1,40(sp)
    5d22:	ec4e                	sd	s3,24(sp)
    5d24:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    5d26:	02051493          	sll	s1,a0,0x20
    5d2a:	9081                	srl	s1,s1,0x20
    5d2c:	04bd                	add	s1,s1,15
    5d2e:	8091                	srl	s1,s1,0x4
    5d30:	0014899b          	addw	s3,s1,1
    5d34:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    5d6a:	90a90913          	add	s2,s2,-1782 # 8670 <freep>
  if(p == (char*)-1)
    5d6e:	5afd                	li	s5,-1
    ...
    5d7e:	11678793          	add	a5,a5,278 # ee90 <base>
  ...
  if(p == (char*)-1)
    ...
    5de8:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5dea:	02071693          	sll	a3,a4,0x20
    5dee:	01c6d713          	srl	a4,a3,0x1c
