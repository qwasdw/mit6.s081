 ...
 */
    ...
    lo = x % 127773;
      16:	66fd                	lui	a3,0x1f
      18:	31d68693          	add	a3,a3,797 # 1f31d <__global_pointer$+0x1d3f4>
      1c:	02d7e733          	rem	a4,a5,a3
    x = 16807 * lo - 2836 * hi;
      20:	6611                	lui	a2,0x4
      22:	1a760613          	add	a2,a2,423 # 41a7 <__global_pointer$+0x227e>
      26:	02c70733          	mul	a4,a4,a2
    hi = x / 127773;
      2a:	02d7c7b3          	div	a5,a5,a3
    x = 16807 * lo - 2836 * hi;
      2e:	76fd                	lui	a3,0xfffff
      30:	4ec68693          	add	a3,a3,1260 # fffffffffffff4ec <__global_pointer$+0xffffffffffffd5c3>
...
rand(void)
{
    ...
    return (do_rand(&rand_next));
      ...
      64:	6d050513          	add	a0,a0,1744 # 1730 <rand_next>
...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      96:	2be50513          	add	a0,a0,702 # 1350 <malloc+0x100>
      9a:	00001097          	auipc	ra,0x1
      9e:	dee080e7          	jalr	-530(ra) # e88 <mkdir>
  if(chdir("grindir") != 0){
      a2:	00001517          	auipc	a0,0x1
      a6:	2ae50513          	add	a0,a0,686 # 1350 <malloc+0x100>
    ...
    printf("grind: chdir grindir failed\n");
      ...
      c0:	29c50513          	add	a0,a0,668 # 1358 <malloc+0x108>
  ...
  chdir("/");
      ...
      e2:	2a250513          	add	a0,a0,674 # 1380 <malloc+0x130>
      e6:	00001097          	auipc	ra,0x1
      ea:	daa080e7          	jalr	-598(ra) # e90 <chdir>
      ee:	00001997          	auipc	s3,0x1
      f2:	2a298993          	add	s3,s3,674 # 1390 <malloc+0x140>
      f6:	c489                	beqz	s1,100 <go+0x88>
      f8:	00001997          	auipc	s3,0x1
      fc:	29098993          	add	s3,s3,656 # 1388 <malloc+0x138>
  uint64 iters = 0;
     100:	4481                	li	s1,0
  int fd = -1;
     102:	5a7d                	li	s4,-1
     104:	00001917          	auipc	s2,0x1
     108:	55c90913          	add	s2,s2,1372 # 1660 <malloc+0x410>
    ...
    if(what == 1){
     ...
     116:	28650513          	add	a0,a0,646 # 1398 <malloc+0x148>
    ...
    int what = rand() % 23;
     ...
     174:	23850513          	add	a0,a0,568 # 13a8 <malloc+0x158>
     ...
     18e:	20e50513          	add	a0,a0,526 # 1398 <malloc+0x148>
     ...
     1a0:	1b450513          	add	a0,a0,436 # 1350 <malloc+0x100>
     ...
     1fc:	1d050513          	add	a0,a0,464 # 13c8 <malloc+0x178>
     ...
     21e:	1be50513          	add	a0,a0,446 # 13d8 <malloc+0x188>
     ...
     236:	50e58593          	add	a1,a1,1294 # 1740 <buf.0>
     23a:	8552                	mv	a0,s4
     ...
     24e:	4f658593          	add	a1,a1,1270 # 1740 <buf.0>
     252:	8552                	mv	a0,s4
     ...
     28e:	17650513          	add	a0,a0,374 # 1400 <malloc+0x1b0>
     ...
     2cc:	15850513          	add	a0,a0,344 # 1420 <malloc+0x1d0>
     ...
     2de:	14e50513          	add	a0,a0,334 # 1428 <malloc+0x1d8>
     2e2:	00001097          	auipc	ra,0x1
     2e6:	b8e080e7          	jalr	-1138(ra) # e70 <unlink>
      link("../grindir/./../a", "../b");
     2ea:	00001597          	auipc	a1,0x1
     2ee:	0d658593          	add	a1,a1,214 # 13c0 <malloc+0x170>
     2f2:	00001517          	auipc	a0,0x1
     2f6:	13e50513          	add	a0,a0,318 # 1430 <malloc+0x1e0>
     ...
     308:	14450513          	add	a0,a0,324 # 1448 <malloc+0x1f8>
     30c:	00001097          	auipc	ra,0x1
     310:	b64080e7          	jalr	-1180(ra) # e70 <unlink>
      link(".././b", "/grindir/../a");
     314:	00001597          	auipc	a1,0x1
     318:	0b458593          	add	a1,a1,180 # 13c8 <malloc+0x178>
     31c:	00001517          	auipc	a0,0x1
     320:	13c50513          	add	a0,a0,316 # 1458 <malloc+0x208>
     ...
     354:	11050513          	add	a0,a0,272 # 1460 <malloc+0x210>
     ...
     3a2:	0c250513          	add	a0,a0,194 # 1460 <malloc+0x210>
     ...
     3b4:	a70080e7          	jalr	-1424(ra) # e20 <exit>
      ...
      sbrk(6011);
     3b8:	6505                	lui	a0,0x1
     3ba:	77b50513          	add	a0,a0,1915 # 177b <buf.0+0x3b>
     ...
     402:	08250513          	add	a0,a0,130 # 1480 <malloc+0x230>
     ...
     42e:	04e50513          	add	a0,a0,78 # 1478 <malloc+0x228>
     ...
     450:	01450513          	add	a0,a0,20 # 1460 <malloc+0x210>
     ...
     46a:	02a50513          	add	a0,a0,42 # 1490 <malloc+0x240>
     ...
     4b8:	fac50513          	add	a0,a0,-84 # 1460 <malloc+0x210>
     ...
     514:	f9850513          	add	a0,a0,-104 # 14a8 <malloc+0x258>
     ...
     540:	f8458593          	add	a1,a1,-124 # 14c0 <malloc+0x270>
     ...
     642:	e2250513          	add	a0,a0,-478 # 1460 <malloc+0x210>
     ...
     65c:	eb850513          	add	a0,a0,-328 # 1510 <malloc+0x2c0>
     ...
     670:	ea450513          	add	a0,a0,-348 # 1510 <malloc+0x2c0>
     ...
     688:	e3c58593          	add	a1,a1,-452 # 14c0 <malloc+0x270>
     ...
     6ce:	e4650513          	add	a0,a0,-442 # 1510 <malloc+0x2c0>
     6d2:	00000097          	auipc	ra,0x0
     6d6:	79e080e7          	jalr	1950(ra) # e70 <unlink>
     6da:	bc81                	j	12a <go+0xb2>
        printf("grind: create c failed\n");
     6dc:	00001517          	auipc	a0,0x1
     6e0:	e3c50513          	add	a0,a0,-452 # 1518 <malloc+0x2c8>
     ...
     6fa:	e3a50513          	add	a0,a0,-454 # 1530 <malloc+0x2e0>
     ...
     714:	e3850513          	add	a0,a0,-456 # 1548 <malloc+0x2f8>
     ...
     730:	e3450513          	add	a0,a0,-460 # 1560 <malloc+0x310>
     ...
     74a:	e4250513          	add	a0,a0,-446 # 1588 <malloc+0x338>
     ...
     832:	dfa58593          	add	a1,a1,-518 # 1628 <malloc+0x3d8>
     ...
     856:	dde50513          	add	a0,a0,-546 # 1630 <malloc+0x3e0>
     ...
     870:	c3c58593          	add	a1,a1,-964 # 14a8 <malloc+0x258>
     874:	4509                	li	a0,2
     ...
     88c:	c2058593          	add	a1,a1,-992 # 14a8 <malloc+0x258>
     890:	4509                	li	a0,2
     ...
     8e8:	ccc58593          	add	a1,a1,-820 # 15b0 <malloc+0x360>
     8ec:	4509                	li	a0,2
     ...
     95c:	b0858593          	add	a1,a1,-1272 # 1460 <malloc+0x210>
     960:	4509                	li	a0,2
     ...
     9a8:	c0c58593          	add	a1,a1,-1012 # 15b0 <malloc+0x360>
     9ac:	4509                	li	a0,2
     ...
     9ec:	bc858593          	add	a1,a1,-1080 # 15b0 <malloc+0x360>
     9f0:	4509                	li	a0,2
     ...
     a54:	a1058593          	add	a1,a1,-1520 # 1460 <malloc+0x210>
     a58:	4509                	li	a0,2
...
iter()
{
  ...
  unlink("a");
     ...
     a78:	a0450513          	add	a0,a0,-1532 # 1478 <malloc+0x228>
     a7c:	00000097          	auipc	ra,0x0
     a80:	3f4080e7          	jalr	1012(ra) # e70 <unlink>
  unlink("b");
     a84:	00001517          	auipc	a0,0x1
     a88:	9a450513          	add	a0,a0,-1628 # 1428 <malloc+0x1d8>
  ...
  if(pid1 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     ac4:	9a050513          	add	a0,a0,-1632 # 1460 <malloc+0x210>
  ...
  if(pid2 == 0){
    ...
    rand_next = 7177;
     aec:	6789                	lui	a5,0x2
     aee:	c0978793          	add	a5,a5,-1015 # 1c09 <__BSS_END__+0xd1>
    ...
    printf("grind: fork failed\n");
     ...
     b08:	95c50513          	add	a0,a0,-1700 # 1460 <malloc+0x210>
...
ugetpid(void)
{
     e02:	1141                	add	sp,sp,-16
     e04:	e422                	sd	s0,8(sp)
     e06:	0800                	add	s0,sp,16
  struct usyscall *u = (struct usyscall *)USYSCALL;
  return u->pid;
     e08:	040007b7          	lui	a5,0x4000
     e0c:	17f5                	add	a5,a5,-3 # 3fffffd <__global_pointer$+0x3ffe0d4>
     e0e:	07b2                	sll	a5,a5,0xc
}
     e10:	4388                	lw	a0,0(a5)
     e12:	6422                	ld	s0,8(sp)
     e14:	0141                	add	sp,sp,16
     e16:	8082                	ret
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f14:	80850513          	add	a0,a0,-2040 # 1718 <digits>
     f18:	883a                	mv	a6,a4
     f1a:	2705                	addw	a4,a4,1
     f1c:	02c5f7bb          	remuw	a5,a1,a2
     f20:	1782                	sll	a5,a5,0x20
     f22:	9381                	srl	a5,a5,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    101a:	6aa70713          	add	a4,a4,1706 # 16c0 <malloc+0x470>
  ...
  putc(fd, 'x');
    ...
    10a6:	676b8b93          	add	s7,s7,1654 # 1718 <digits>
    10aa:	03c9d793          	srl	a5,s3,0x3c
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    10be:	0992                	sll	s3,s3,0x4
    10c0:	397d                	addw	s2,s2,-1
    ...
    10fc:	56090913          	add	s2,s2,1376 # 1658 <malloc+0x408>
        while(*s != 0){
    1100:	02800593          	li	a1,40
    1104:	bff1                	j	10e0 <vprintf+0x142>
        putc(fd, va_arg(ap, uint));
    1106:	008b8913          	add	s2,s7,8
...
free(void *ap)
{
    11ce:	1141                	add	sp,sp,-16
    11d0:	e422                	sd	s0,8(sp)
    11d2:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    11d4:	ff050693          	add	a3,a0,-16
    ...
    1204:	00e6ea63          	bltu	a3,a4,1218 <free+0x4a>
{
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    121e:	02059813          	sll	a6,a1,0x20
    1222:	01c85713          	srl	a4,a6,0x1c
  ...
  if(p + p->s.size == bp){
    ...
    1232:	02061593          	sll	a1,a2,0x20
    1236:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
    1250:	7139                	add	sp,sp,-64
    1252:	fc06                	sd	ra,56(sp)
    1254:	f822                	sd	s0,48(sp)
    1256:	f426                	sd	s1,40(sp)
    1258:	ec4e                	sd	s3,24(sp)
    125a:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    125c:	02051493          	sll	s1,a0,0x20
    1260:	9081                	srl	s1,s1,0x20
    1262:	04bd                	add	s1,s1,15
    1264:	8091                	srl	s1,s1,0x4
    1266:	0014899b          	addw	s3,s1,1
    126a:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12a0:	49c90913          	add	s2,s2,1180 # 1738 <freep>
  if(p == (char*)-1)
    12a4:	5afd                	li	s5,-1
    ...
    12b4:	87878793          	add	a5,a5,-1928 # 1b28 <base>
  ...
  if(p == (char*)-1)
    ...
    131e:	c798                	sw	a4,8(a5)
        p += p->s.size;
    1320:	02071693          	sll	a3,a4,0x20
    1324:	01c6d713          	srl	a4,a3,0x1c
