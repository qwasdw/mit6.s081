...
main(int argc, char *argv[])
{
  ...
  14:	80858593          	add	a1,a1,-2040 # 818 <malloc+0x104>
  18:	4509                	li	a0,2
  ...
  52:	7e258593          	add	a1,a1,2018 # 830 <malloc+0x11c>
  56:	4509                	li	a0,2
...
ugetpid(void)
{
 ...
 2d0:	17f5                	add	a5,a5,-3 # 3fffffd <__global_pointer$+0x3ffef44>
 2d2:	07b2                	sll	a5,a5,0xc
}
 2d4:	4388                	lw	a0,0(a5)
 2d6:	6422                	ld	s0,8(sp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d8:	4d450513          	add	a0,a0,1236 # 8a8 <digits>
 3dc:	883a                	mv	a6,a4
 3de:	2705                	addw	a4,a4,1
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4de:	37670713          	add	a4,a4,886 # 850 <malloc+0x13c>
 ...
 56a:	342b8b93          	add	s7,s7,834 # 8a8 <digits>
 ...
 5c0:	28c90913          	add	s2,s2,652 # 848 <malloc+0x134>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 720:	02051493          	sll	s1,a0,0x20
 724:	9081                	srl	s1,s1,0x20
 726:	04bd                	add	s1,s1,15
 728:	8091                	srl	s1,s1,0x4
 72a:	0014899b          	addw	s3,s1,1
 72e:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
 ...
 764:	16090913          	add	s2,s2,352 # 8c0 <freep>
  if(p == (char*)-1)
 768:	5afd                	li	s5,-1
 ...
 778:	15478793          	add	a5,a5,340 # 8c8 <base>
 ...
 7e2:	c798                	sw	a4,8(a5)
        p += p->s.size;
 7e4:	02071693          	sll	a3,a4,0x20
 7e8:	01c6d713          	srl	a4,a3,0x1c
