...
main(int argc, char *argv[])
{
  ...
  34:	810a8a93          	add	s5,s5,-2032 # 840 <malloc+0x100>
  ...
  76:	7d658593          	add	a1,a1,2006 # 848 <malloc+0x108>
  7a:	4505                	li	a0,1
...
ugetpid(void)
{
 ...
 2fc:	17f5                	add	a5,a5,-3 # 3fffffd <__global_pointer$+0x3ffef3c>
 2fe:	07b2                	sll	a5,a5,0xc
}
 300:	4388                	lw	a0,0(a5)
 302:	6422                	ld	s0,8(sp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 404:	4b050513          	add	a0,a0,1200 # 8b0 <digits>
 408:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 50a:	35270713          	add	a4,a4,850 # 858 <malloc+0x118>
 ...
 596:	31eb8b93          	add	s7,s7,798 # 8b0 <digits>
 ...
 5ec:	26890913          	add	s2,s2,616 # 850 <malloc+0x110>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 790:	13c90913          	add	s2,s2,316 # 8c8 <freep>
  if(p == (char*)-1)
 794:	5afd                	li	s5,-1
 ...
 7a4:	13078793          	add	a5,a5,304 # 8d0 <base>
