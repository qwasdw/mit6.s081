...
main(int argc, char **argv)
{
  ...
  50:	7d458593          	add	a1,a1,2004 # 820 <malloc+0x106>
  54:	4509                	li	a0,2
...
ugetpid(void)
{
 ...
 2d6:	17f5                	add	a5,a5,-3 # 3fffffd <__global_pointer$+0x3ffef54>
 2d8:	07b2                	sll	a5,a5,0xc
}
 2da:	4388                	lw	a0,0(a5)
 2dc:	6422                	ld	s0,8(sp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3de:	4be50513          	add	a0,a0,1214 # 898 <digits>
 3e2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4e4:	36070713          	add	a4,a4,864 # 840 <malloc+0x126>
 ...
 570:	32cb8b93          	add	s7,s7,812 # 898 <digits>
 ...
 5c6:	27690913          	add	s2,s2,630 # 838 <malloc+0x11e>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 76a:	14a90913          	add	s2,s2,330 # 8b0 <freep>
  if(p == (char*)-1)
 76e:	5afd                	li	s5,-1
 ...
 77e:	13e78793          	add	a5,a5,318 # 8b8 <base>
