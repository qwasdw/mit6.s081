...
ugetpid(void)
{
 ...
 298:	17f5                	add	a5,a5,-3 # 3fffffd <__global_pointer$+0x3ffefac>
 29a:	07b2                	sll	a5,a5,0xc
}
 29c:	4388                	lw	a0,0(a5)
 29e:	6422                	ld	s0,8(sp)
...
putc(int fd, char c)
{
 35c:	1101                	add	sp,sp,-32
 35e:	ec06                	sd	ra,24(sp)
 360:	e822                	sd	s0,16(sp)
 362:	1000                	add	s0,sp,32
 364:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
 368:	4605                	li	a2,1
 36a:	fef40593          	add	a1,s0,-17
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3a0:	4a450513          	add	a0,a0,1188 # 840 <digits>
 3a4:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 49e:	00271793          	sll	a5,a4,0x2
 4a2:	00000717          	auipc	a4,0x0
 4a6:	34670713          	add	a4,a4,838 # 7e8 <malloc+0x10c>
 ...
 532:	312b8b93          	add	s7,s7,786 # 840 <digits>
 536:	03c9d793          	srl	a5,s3,0x3c
 ...
 54a:	0992                	sll	s3,s3,0x4
 54c:	397d                	addw	s2,s2,-1
 ...
 588:	25c90913          	add	s2,s2,604 # 7e0 <malloc+0x104>
        while(*s != 0){
 ...
 690:	00e6ea63          	bltu	a3,a4,6a4 <free+0x4a>
{
 ...
 6a8:	6390                	ld	a2,0(a5)
 6aa:	02059813          	sll	a6,a1,0x20
 6ae:	01c85713          	srl	a4,a6,0x1c
 ...
 6b8:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
 6bc:	4790                	lw	a2,8(a5)
 6be:	02061593          	sll	a1,a2,0x20
 6c2:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
 6dc:	7139                	add	sp,sp,-64
 6de:	fc06                	sd	ra,56(sp)
 6e0:	f822                	sd	s0,48(sp)
 6e2:	f426                	sd	s1,40(sp)
 6e4:	ec4e                	sd	s3,24(sp)
 6e6:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 6e8:	02051493          	sll	s1,a0,0x20
 6ec:	9081                	srl	s1,s1,0x20
 6ee:	04bd                	add	s1,s1,15
 6f0:	8091                	srl	s1,s1,0x4
 6f2:	0014899b          	addw	s3,s1,1
 6f6:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
 ...
 72c:	13090913          	add	s2,s2,304 # 858 <freep>
  if(p == (char*)-1)
 730:	5afd                	li	s5,-1
 ...
 740:	12478793          	add	a5,a5,292 # 860 <base>
