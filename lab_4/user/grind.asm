 ...
 */
    ...
    lo = x % 127773;
      16:	66fd                	lui	a3,0x1f
      18:	31d68693          	add	a3,a3,797 # 1f31d <__global_pointer$+0x1d404>
      1c:	02d7e733          	rem	a4,a5,a3
    x = 16807 * lo - 2836 * hi;
      20:	6611                	lui	a2,0x4
      22:	1a760613          	add	a2,a2,423 # 41a7 <__global_pointer$+0x228e>
      26:	02c70733          	mul	a4,a4,a2
    hi = x / 127773;
      2a:	02d7c7b3          	div	a5,a5,a3
    x = 16807 * lo - 2836 * hi;
      2e:	76fd                	lui	a3,0xfffff
      30:	4ec68693          	add	a3,a3,1260 # fffffffffffff4ec <__global_pointer$+0xffffffffffffd5d3>
...
rand(void)
{
    ...
    return (do_rand(&rand_next));
      ...
      64:	6c050513          	add	a0,a0,1728 # 1720 <rand_next>
...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      96:	2ae50513          	add	a0,a0,686 # 1340 <malloc+0x106>
      9a:	00001097          	auipc	ra,0x1
      9e:	dd8080e7          	jalr	-552(ra) # e72 <mkdir>
  if(chdir("grindir") != 0){
      a2:	00001517          	auipc	a0,0x1
      a6:	29e50513          	add	a0,a0,670 # 1340 <malloc+0x106>
    ...
    printf("grind: chdir grindir failed\n");
      ...
      c0:	28c50513          	add	a0,a0,652 # 1348 <malloc+0x10e>
  ...
  chdir("/");
      ...
      e2:	29250513          	add	a0,a0,658 # 1370 <malloc+0x136>
      e6:	00001097          	auipc	ra,0x1
      ea:	d94080e7          	jalr	-620(ra) # e7a <chdir>
      ee:	00001997          	auipc	s3,0x1
      f2:	29298993          	add	s3,s3,658 # 1380 <malloc+0x146>
      f6:	c489                	beqz	s1,100 <go+0x88>
      f8:	00001997          	auipc	s3,0x1
      fc:	28098993          	add	s3,s3,640 # 1378 <malloc+0x13e>
  uint64 iters = 0;
     100:	4481                	li	s1,0
  int fd = -1;
     102:	5a7d                	li	s4,-1
     104:	00001917          	auipc	s2,0x1
     108:	54c90913          	add	s2,s2,1356 # 1650 <malloc+0x416>
    ...
    if(what == 1){
     ...
     116:	27650513          	add	a0,a0,630 # 1388 <malloc+0x14e>
    ...
    int what = rand() % 23;
     ...
     174:	22850513          	add	a0,a0,552 # 1398 <malloc+0x15e>
     ...
     18e:	1fe50513          	add	a0,a0,510 # 1388 <malloc+0x14e>
     ...
     1a0:	1a450513          	add	a0,a0,420 # 1340 <malloc+0x106>
     ...
     1fc:	1c050513          	add	a0,a0,448 # 13b8 <malloc+0x17e>
     ...
     21e:	1ae50513          	add	a0,a0,430 # 13c8 <malloc+0x18e>
     ...
     236:	4fe58593          	add	a1,a1,1278 # 1730 <buf.0>
     23a:	8552                	mv	a0,s4
     ...
     24e:	4e658593          	add	a1,a1,1254 # 1730 <buf.0>
     252:	8552                	mv	a0,s4
     ...
     28e:	16650513          	add	a0,a0,358 # 13f0 <malloc+0x1b6>
     ...
     2cc:	14850513          	add	a0,a0,328 # 1410 <malloc+0x1d6>
     ...
     2de:	13e50513          	add	a0,a0,318 # 1418 <malloc+0x1de>
     2e2:	00001097          	auipc	ra,0x1
     2e6:	b78080e7          	jalr	-1160(ra) # e5a <unlink>
      link("../grindir/./../a", "../b");
     2ea:	00001597          	auipc	a1,0x1
     2ee:	0c658593          	add	a1,a1,198 # 13b0 <malloc+0x176>
     2f2:	00001517          	auipc	a0,0x1
     2f6:	12e50513          	add	a0,a0,302 # 1420 <malloc+0x1e6>
     ...
     308:	13450513          	add	a0,a0,308 # 1438 <malloc+0x1fe>
     30c:	00001097          	auipc	ra,0x1
     310:	b4e080e7          	jalr	-1202(ra) # e5a <unlink>
      link(".././b", "/grindir/../a");
     314:	00001597          	auipc	a1,0x1
     318:	0a458593          	add	a1,a1,164 # 13b8 <malloc+0x17e>
     31c:	00001517          	auipc	a0,0x1
     320:	12c50513          	add	a0,a0,300 # 1448 <malloc+0x20e>
     ...
     354:	10050513          	add	a0,a0,256 # 1450 <malloc+0x216>
     ...
     3a2:	0b250513          	add	a0,a0,178 # 1450 <malloc+0x216>
     ...
     3b4:	a5a080e7          	jalr	-1446(ra) # e0a <exit>
      ...
      sbrk(6011);
     3b8:	6505                	lui	a0,0x1
     3ba:	77b50513          	add	a0,a0,1915 # 177b <buf.0+0x4b>
     ...
     402:	07250513          	add	a0,a0,114 # 1470 <malloc+0x236>
     ...
     42e:	03e50513          	add	a0,a0,62 # 1468 <malloc+0x22e>
     ...
     450:	00450513          	add	a0,a0,4 # 1450 <malloc+0x216>
     ...
     46a:	01a50513          	add	a0,a0,26 # 1480 <malloc+0x246>
     ...
     4b8:	f9c50513          	add	a0,a0,-100 # 1450 <malloc+0x216>
     ...
     514:	f8850513          	add	a0,a0,-120 # 1498 <malloc+0x25e>
     ...
     540:	f7458593          	add	a1,a1,-140 # 14b0 <malloc+0x276>
     ...
     642:	e1250513          	add	a0,a0,-494 # 1450 <malloc+0x216>
     ...
     65c:	ea850513          	add	a0,a0,-344 # 1500 <malloc+0x2c6>
     ...
     670:	e9450513          	add	a0,a0,-364 # 1500 <malloc+0x2c6>
     ...
     688:	e2c58593          	add	a1,a1,-468 # 14b0 <malloc+0x276>
     ...
     6ce:	e3650513          	add	a0,a0,-458 # 1500 <malloc+0x2c6>
     6d2:	00000097          	auipc	ra,0x0
     6d6:	788080e7          	jalr	1928(ra) # e5a <unlink>
     6da:	bc81                	j	12a <go+0xb2>
        printf("grind: create c failed\n");
     6dc:	00001517          	auipc	a0,0x1
     6e0:	e2c50513          	add	a0,a0,-468 # 1508 <malloc+0x2ce>
     ...
     6fa:	e2a50513          	add	a0,a0,-470 # 1520 <malloc+0x2e6>
     ...
     714:	e2850513          	add	a0,a0,-472 # 1538 <malloc+0x2fe>
     ...
     730:	e2450513          	add	a0,a0,-476 # 1550 <malloc+0x316>
     ...
     74a:	e3250513          	add	a0,a0,-462 # 1578 <malloc+0x33e>
     ...
     832:	dea58593          	add	a1,a1,-534 # 1618 <malloc+0x3de>
     ...
     856:	dce50513          	add	a0,a0,-562 # 1620 <malloc+0x3e6>
     ...
     870:	c2c58593          	add	a1,a1,-980 # 1498 <malloc+0x25e>
     874:	4509                	li	a0,2
     ...
     88c:	c1058593          	add	a1,a1,-1008 # 1498 <malloc+0x25e>
     890:	4509                	li	a0,2
     ...
     8e8:	cbc58593          	add	a1,a1,-836 # 15a0 <malloc+0x366>
     8ec:	4509                	li	a0,2
     ...
     95c:	af858593          	add	a1,a1,-1288 # 1450 <malloc+0x216>
     960:	4509                	li	a0,2
     ...
     9a8:	bfc58593          	add	a1,a1,-1028 # 15a0 <malloc+0x366>
     9ac:	4509                	li	a0,2
     ...
     9ec:	bb858593          	add	a1,a1,-1096 # 15a0 <malloc+0x366>
     9f0:	4509                	li	a0,2
     ...
     a54:	a0058593          	add	a1,a1,-1536 # 1450 <malloc+0x216>
     a58:	4509                	li	a0,2
...
iter()
{
  ...
  unlink("a");
     ...
     a78:	9f450513          	add	a0,a0,-1548 # 1468 <malloc+0x22e>
     a7c:	00000097          	auipc	ra,0x0
     a80:	3de080e7          	jalr	990(ra) # e5a <unlink>
  unlink("b");
     a84:	00001517          	auipc	a0,0x1
     a88:	99450513          	add	a0,a0,-1644 # 1418 <malloc+0x1de>
  ...
  if(pid1 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     ac4:	99050513          	add	a0,a0,-1648 # 1450 <malloc+0x216>
  ...
  if(pid2 == 0){
    ...
    rand_next = 7177;
     aec:	6789                	lui	a5,0x2
     aee:	c0978793          	add	a5,a5,-1015 # 1c09 <__BSS_END__+0xe1>
    ...
    printf("grind: fork failed\n");
     ...
     b08:	94c50513          	add	a0,a0,-1716 # 1450 <malloc+0x216>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     efe:	80e50513          	add	a0,a0,-2034 # 1708 <digits>
     f02:	883a                	mv	a6,a4
  ...
  while(--i >= 0)
     ...
     f4e:	fff78993          	add	s3,a5,-1
     f52:	99ba                	add	s3,s3,a4
     f54:	377d                	addw	a4,a4,-1
     f56:	1702                	sll	a4,a4,0x20
     f58:	9301                	srl	a4,a4,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  putc(fd, 'x');
    ...
    1090:	67cb8b93          	add	s7,s7,1660 # 1708 <digits>
    1094:	03c9d793          	srl	a5,s3,0x3c
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    10a8:	0992                	sll	s3,s3,0x4
    10aa:	397d                	addw	s2,s2,-1
    ...
    10e6:	56690913          	add	s2,s2,1382 # 1648 <malloc+0x40e>
        while(*s != 0){
...
{
    1154:	715d                	add	sp,sp,-80
    1156:	ec06                	sd	ra,24(sp)
    1158:	e822                	sd	s0,16(sp)
    115a:	1000                	add	s0,sp,32
...
free(void *ap)
{
    11b8:	1141                	add	sp,sp,-16
    11ba:	e422                	sd	s0,8(sp)
    11bc:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    11be:	ff050693          	add	a3,a0,-16
    ...
    11ee:	00e6ea63          	bltu	a3,a4,1202 <free+0x4a>
{
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    1208:	02059813          	sll	a6,a1,0x20
    120c:	01c85713          	srl	a4,a6,0x1c
  ...
  if(p + p->s.size == bp){
    ...
    121c:	02061593          	sll	a1,a2,0x20
    1220:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
    123a:	7139                	add	sp,sp,-64
    123c:	fc06                	sd	ra,56(sp)
    123e:	f822                	sd	s0,48(sp)
    1240:	f426                	sd	s1,40(sp)
    1242:	ec4e                	sd	s3,24(sp)
    1244:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    1246:	02051493          	sll	s1,a0,0x20
    124a:	9081                	srl	s1,s1,0x20
    124c:	04bd                	add	s1,s1,15
    124e:	8091                	srl	s1,s1,0x4
    1250:	0014899b          	addw	s3,s1,1
    1254:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    128a:	4a290913          	add	s2,s2,1186 # 1728 <freep>
  if(p == (char*)-1)
    128e:	5afd                	li	s5,-1
    ...
    129e:	87e78793          	add	a5,a5,-1922 # 1b18 <base>
  ...
  if(p == (char*)-1)
    ...
    1308:	c798                	sw	a4,8(a5)
        p += p->s.size;
    130a:	02071693          	sll	a3,a4,0x20
    130e:	01c6d713          	srl	a4,a3,0x1c
