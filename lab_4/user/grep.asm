...
000000000000011a <grep>:
{
 ...
 140:	9c4a8a93          	add	s5,s5,-1596 # b00 <buf>
 ...
 1ba:	94a50513          	add	a0,a0,-1718 # b00 <buf>
...
00000000000001ec <main>:
{
 ...
 25e:	7ee58593          	add	a1,a1,2030 # a48 <malloc+0x102>
 262:	4509                	li	a0,2
 ...
 294:	7d850513          	add	a0,a0,2008 # a68 <malloc+0x122>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 60a:	4da50513          	add	a0,a0,1242 # ae0 <digits>
 60e:	883a                	mv	a6,a4
 610:	2705                	addw	a4,a4,1
 612:	02c5f7bb          	remuw	a5,a1,a2
 616:	1782                	sll	a5,a5,0x20
 618:	9381                	srl	a5,a5,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 708:	00271793          	sll	a5,a4,0x2
 70c:	00000717          	auipc	a4,0x0
 710:	37c70713          	add	a4,a4,892 # a88 <malloc+0x142>
 ...
 79c:	348b8b93          	add	s7,s7,840 # ae0 <digits>
 ...
 7f2:	29290913          	add	s2,s2,658 # a80 <malloc+0x13a>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 996:	16690913          	add	s2,s2,358 # af8 <freep>
  if(p == (char*)-1)
 99a:	5afd                	li	s5,-1
 ...
 9aa:	55a78793          	add	a5,a5,1370 # f00 <base>
 ...
 a14:	c798                	sw	a4,8(a5)
        p += p->s.size;
 a16:	02071693          	sll	a3,a4,0x20
 a1a:	01c6d713          	srl	a4,a3,0x1c
