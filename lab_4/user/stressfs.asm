...
main(int argc, char *argv[])
{
  ...
  1a:	8c278793          	add	a5,a5,-1854 # 8d8 <malloc+0x130>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	87c50513          	add	a0,a0,-1924 # 8a8 <malloc+0x100>
  ...
  6c:	85850513          	add	a0,a0,-1960 # 8c0 <malloc+0x118>
...
//    printf(fd, "%d\n", i);
  ...
  ba:	81a50513          	add	a0,a0,-2022 # 8d0 <malloc+0x128>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 46c:	4e050513          	add	a0,a0,1248 # 948 <digits>
 470:	883a                	mv	a6,a4
 472:	2705                	addw	a4,a4,1
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 572:	38270713          	add	a4,a4,898 # 8f0 <malloc+0x148>
 ...
 5fe:	34eb8b93          	add	s7,s7,846 # 948 <digits>
 ...
 654:	29890913          	add	s2,s2,664 # 8e8 <malloc+0x140>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 7f8:	16c90913          	add	s2,s2,364 # 960 <freep>
  if(p == (char*)-1)
 7fc:	5afd                	li	s5,-1
 ...
 80c:	16078793          	add	a5,a5,352 # 968 <base>
 ...
 876:	c798                	sw	a4,8(a5)
        p += p->s.size;
 878:	02071693          	sll	a3,a4,0x20
 87c:	01c6d713          	srl	a4,a3,0x1c
