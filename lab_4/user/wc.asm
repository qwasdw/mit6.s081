...
wc(int fd, char *name)
{
  ...
  32:	9cad8d93          	add	s11,s11,-1590 # 9f8 <buf>
    for(i=0; i<n; i++){
      c++;
      if(buf[i] == '\n')
  36:	4aa9                	li	s5,10
  ...
  3c:	8f8a0a13          	add	s4,s4,-1800 # 930 <malloc+0x104>
        inword = 0;
  40:	4b81                	li	s7,0
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  8e:	96e48493          	add	s1,s1,-1682 # 9f8 <buf>
  ...
  aa:	8aa50513          	add	a0,a0,-1878 # 950 <malloc+0x124>
  ...
  d8:	86c50513          	add	a0,a0,-1940 # 940 <malloc+0x114>
...
main(int argc, char *argv[])
{
 ...
 15a:	7e258593          	add	a1,a1,2018 # 938 <malloc+0x10c>
 15e:	4501                	li	a0,0
 ...
 17a:	7ea50513          	add	a0,a0,2026 # 960 <malloc+0x134>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4f0:	4ec50513          	add	a0,a0,1260 # 9d8 <digits>
 4f4:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5f6:	38e70713          	add	a4,a4,910 # 980 <malloc+0x154>
 ...
 682:	35ab8b93          	add	s7,s7,858 # 9d8 <digits>
 ...
 6d8:	2a490913          	add	s2,s2,676 # 978 <malloc+0x14c>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 87c:	17890913          	add	s2,s2,376 # 9f0 <freep>
  if(p == (char*)-1)
 880:	5afd                	li	s5,-1
 ...
 890:	36c78793          	add	a5,a5,876 # bf8 <base>
