...
main(int argc, char *argv[])
{
  ...
  44:	7d858593          	add	a1,a1,2008 # 818 <malloc+0x102>
  48:	4509                	li	a0,2
  ...
  62:	7d258593          	add	a1,a1,2002 # 830 <malloc+0x11a>
  66:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3da:	4da50513          	add	a0,a0,1242 # 8b0 <digits>
 3de:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4e0:	37c70713          	add	a4,a4,892 # 858 <malloc+0x142>
 ...
 56c:	348b8b93          	add	s7,s7,840 # 8b0 <digits>
 ...
 5c2:	29290913          	add	s2,s2,658 # 850 <malloc+0x13a>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 766:	16690913          	add	s2,s2,358 # 8c8 <freep>
  if(p == (char*)-1)
 76a:	5afd                	li	s5,-1
 ...
 77a:	15a78793          	add	a5,a5,346 # 8d0 <base>
