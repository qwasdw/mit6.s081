...
getcmd(char *buf, int nbuf)
{
  ...
  fprintf(2, "$ ");
      ...
      14:	2f858593          	add	a1,a1,760 # 1308 <malloc+0x104>
      18:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      62:	2ba58593          	add	a1,a1,698 # 1318 <malloc+0x114>
      66:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9c:	28850513          	add	a0,a0,648 # 1320 <malloc+0x11c>
...
00000000000000a8 <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      c8:	35c70713          	add	a4,a4,860 # 1420 <malloc+0x21c>
    ...
    panic("runcmd");
      ...
      e4:	24850513          	add	a0,a0,584 # 1328 <malloc+0x124>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     106:	22e58593          	add	a1,a1,558 # 1330 <malloc+0x12c>
     10a:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     152:	1f258593          	add	a1,a1,498 # 1340 <malloc+0x13c>
     156:	4509                	li	a0,2
    ...
    break;
     ...
     1e8:	16c50513          	add	a0,a0,364 # 1350 <malloc+0x14c>
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     400:	0cc98993          	add	s3,s3,204 # 14c8 <whitespace>
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     466:	06698993          	add	s3,s3,102 # 14c8 <whitespace>
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     4d2:	ffa98993          	add	s3,s3,-6 # 14c8 <whitespace>
     4d6:	00001a97          	auipc	s5,0x1
     4da:	feaa8a93          	add	s5,s5,-22 # 14c0 <symbols>
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     548:	f8498993          	add	s3,s3,-124 # 14c8 <whitespace>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5b6:	dc6a8a93          	add	s5,s5,-570 # 1378 <malloc+0x174>
  ...
  while(peek(ps, es, "<>")){
     ...
     5c8:	d9450513          	add	a0,a0,-620 # 1358 <malloc+0x154>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a0:	ce460613          	add	a2,a2,-796 # 1380 <malloc+0x17c>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6dc:	cc8b0b13          	add	s6,s6,-824 # 13a0 <malloc+0x19c>
  ...
  return ret;
     ...
     70a:	c8250513          	add	a0,a0,-894 # 1388 <malloc+0x184>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76c:	c2850513          	add	a0,a0,-984 # 1390 <malloc+0x18c>
...
0000000000000792 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7b2:	bfa60613          	add	a2,a2,-1030 # 13a8 <malloc+0x1a4>
     7b6:	85ce                	mv	a1,s3
     7b8:	854a                	mv	a0,s2
...
0000000000000800 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     822:	b92a0a13          	add	s4,s4,-1134 # 13b0 <malloc+0x1ac>
  ...
  if(peek(ps, es, ";")){
     ...
     858:	b6460613          	add	a2,a2,-1180 # 13b8 <malloc+0x1b4>
     85c:	85ce                	mv	a1,s3
     85e:	854a                	mv	a0,s2
...
00000000000008a8 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8be:	ac660613          	add	a2,a2,-1338 # 1380 <malloc+0x17c>
  ...
  if(!peek(ps, es, ")"))
     ...
     8ee:	ae660613          	add	a2,a2,-1306 # 13d0 <malloc+0x1cc>
     8f2:	85ca                	mv	a1,s2
     8f4:	8526                	mv	a0,s1
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     96c:	ad070713          	add	a4,a4,-1328 # 1438 <malloc+0x234>
...
00000000000009e4 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a18:	8fc60613          	add	a2,a2,-1796 # 1310 <malloc+0x10c>
     a1c:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a4e:	9a658593          	add	a1,a1,-1626 # 13f0 <malloc+0x1ec>
     a52:	4509                	li	a0,2
     a54:	00000097          	auipc	ra,0x0
     a58:	6ca080e7          	jalr	1738(ra) # 111e <fprintf>
    panic("syntax");
     a5c:	00001517          	auipc	a0,0x1
     a60:	92c50513          	add	a0,a0,-1748 # 1388 <malloc+0x184>
...
0000000000000a6c <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a80:	98448493          	add	s1,s1,-1660 # 1400 <malloc+0x1fc>
     a84:	4589                	li	a1,2
     a86:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     aa6:	a3648493          	add	s1,s1,-1482 # 14d8 <buf.0>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     afa:	9e2a0a13          	add	s4,s4,-1566 # 14d8 <buf.0>
     afe:	8552                	mv	a0,s4
     ...
     b1a:	9c550513          	add	a0,a0,-1595 # 14db <buf.0+0x3>
     b1e:	00000097          	auipc	ra,0x0
     b22:	326080e7          	jalr	806(ra) # e44 <chdir>
     b26:	fa0551e3          	bgez	a0,ac8 <main+0x5c>
        fprintf(2, "cannot cd %s\n", buf+3);
     b2a:	00001617          	auipc	a2,0x1
     b2e:	9b160613          	add	a2,a2,-1615 # 14db <buf.0+0x3>
     b32:	00001597          	auipc	a1,0x1
     b36:	8d658593          	add	a1,a1,-1834 # 1408 <malloc+0x204>
     b3a:	4509                	li	a0,2
     ...
     b4a:	99250513          	add	a0,a0,-1646 # 14d8 <buf.0>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     ec8:	5e450513          	add	a0,a0,1508 # 14a8 <digits>
     ecc:	883a                	mv	a6,a4
     ece:	2705                	addw	a4,a4,1
     ed0:	02c5f7bb          	remuw	a5,a1,a2
     ed4:	1782                	sll	a5,a5,0x20
     ed6:	9381                	srl	a5,a5,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     fce:	48670713          	add	a4,a4,1158 # 1450 <malloc+0x24c>
  ...
  putc(fd, 'x');
    ...
    105a:	452b8b93          	add	s7,s7,1106 # 14a8 <digits>
    105e:	03c9d793          	srl	a5,s3,0x3c
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    1072:	0992                	sll	s3,s3,0x4
    1074:	397d                	addw	s2,s2,-1
    ...
    10b0:	36c90913          	add	s2,s2,876 # 1418 <malloc+0x214>
        while(*s != 0){
...
{
    111e:	715d                	add	sp,sp,-80
    1120:	ec06                	sd	ra,24(sp)
    1122:	e822                	sd	s0,16(sp)
    1124:	1000                	add	s0,sp,32
...
free(void *ap)
{
    1182:	1141                	add	sp,sp,-16
    1184:	e422                	sd	s0,8(sp)
    1186:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    1188:	ff050693          	add	a3,a0,-16
    ...
    11b8:	00e6ea63          	bltu	a3,a4,11cc <free+0x4a>
{
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    11d2:	02059813          	sll	a6,a1,0x20
    11d6:	01c85713          	srl	a4,a6,0x1c
  ...
  if(p + p->s.size == bp){
    ...
    11e6:	02061593          	sll	a1,a2,0x20
    11ea:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
    1204:	7139                	add	sp,sp,-64
    1206:	fc06                	sd	ra,56(sp)
    1208:	f822                	sd	s0,48(sp)
    120a:	f426                	sd	s1,40(sp)
    120c:	ec4e                	sd	s3,24(sp)
    120e:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    1210:	02051493          	sll	s1,a0,0x20
    1214:	9081                	srl	s1,s1,0x20
    1216:	04bd                	add	s1,s1,15
    1218:	8091                	srl	s1,s1,0x4
    121a:	0014899b          	addw	s3,s1,1
    121e:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1254:	28090913          	add	s2,s2,640 # 14d0 <freep>
  if(p == (char*)-1)
    1258:	5afd                	li	s5,-1
    ...
    1268:	2dc78793          	add	a5,a5,732 # 1540 <base>
  ...
  if(p == (char*)-1)
    ...
    12d2:	c798                	sw	a4,8(a5)
        p += p->s.size;
    12d4:	02071693          	sll	a3,a4,0x20
    12d8:	01c6d713          	srl	a4,a3,0x1c
